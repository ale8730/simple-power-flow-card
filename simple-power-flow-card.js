              ...
              ${t.badge_enabled??Boolean(t.switch_entity)?q`
                ...
                <div class="form-row">
                  ...
                  <select .value=${t.badge_tap_behavior||"auto"} @change=${e=>this._updateDevice(i,"badge_tap_behavior","auto"===e.target.value?void 0:e.target.value)}>
                    <option value="auto">🤖 Automatico (in base al tipo di entità)</option>
                    <option value="toggle">⚡ Toggle ON/OFF Diretto</option>
                    <option value="more-info">📱 Apri Card Gestione Completa</option>
                  </select>
                </div>
              `:""}
            </div>
