...
`;function ze(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const i=t.replace(",",".").replace(/[^0-9.-]/g,""),o=parseFloat(i);return Number.isFinite(o)?o:null}function Pe(e,t){if(!(e&&t&&e.states&&e.states[t]))return{value:0,rawState:"",unit:"",isUnavailable:!0,isUnknown:!1,isValid:!1};const i=e.states[t],o=i.state,a=i.attributes?.unit_of_measurement||"W";if("unavailable"===o)return{value:0,rawState:o,unit:a,isUnavailable:!0,isUnknown:!1,isValid:!1};if("unknown"===o)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};const r=ze(o);if(null===r)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};return{value:function(e,t){switch(t.trim()){case"kW":case"kVA":case"kvar":return 1e3*e;case"MW":case"MVA":return 1e6*e;case"W":case"VA":case"var":case"A":default:return e;case"mW":case"mA":return.001*e}}(r,a),rawState:o,unit:a,isUnavailable:!1,isUnknown:!1,isValid:!0}}function Ie(e,t,i="solar"){if(!t)return{power:0,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};const o=t.entity_import||("grid"===i?t.entity_in:void 0),a=t.entity_export||("grid"===i?t.entity_out:void 0),r=t.entity_charge||("battery"===i?t.entity_in:void 0),s=t.entity_discharge||("battery"===i?t.entity_out:void 0),n=Boolean(o||a),l=Boolean(r||s);let c;const d=t.state_of_charge||(t.secondary_info?.entity&&t.secondary_info.entity.includes("soc")?t.secondary_info.entity:void 0);if(d&&e?.states?.[d]){const t=ze(e.states[d].state);null!==t&&(c=`${Math.round(t)}%`)}if("grid"===i&&n){const t=Pe(e,o),i=Pe(e,a),r=t.isValid?Math.max(0,t.value):0,s=i.isValid?Math.max(0,i.value):0;return{power:r-s,inPower:r,outPower:s,isDual:!0,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}if("battery"===i&&l){const t=Pe(e,r),i=Pe(e,s),o=t.isValid?Math.max(0,t.value):0,a=i.isValid?Math.max(0,i.value):0;return{power:o-a,inPower:o,outPower:a,isDual:!0,soc:c,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}const h=Pe(e,t.entity);let p,u=h.value;if(t.invert&&(u=-u),t.entity_amperage){const i=Pe(e,t.entity_amperage);i.isValid&&(p=i.value)}return{power:u,inPower:u>=0?u:0,outPower:u<0?Math.abs(u):0,isDual:!1,soc:c,amperage:p,isUnavailable:h.isUnavailable,isUnknown:h.isUnknown,isValid:h.isValid,rawUnit:h.unit||"W"}}function Fe(e,t="sqrt"){const i=Math.max(0,Math.min(1,e));switch(t){case"linear":return i;case"sqrt":default:return Math.sqrt(i);case"log":return Math.log(1+9*i)/Math.LN10}}function Te(e,t={}){const i=t.display_zero_tolerance??0,o=t.stroke_mode??"watt",a=t.speed_mode??"absolute",r=t.scale_curve??"sqrt",s=t.min_stroke??2,n=t.max_stroke??7,l=t.scale_min??50,c=t.scale_max??6e3,d=t.min_duration??.8,h=t.max_duration??5.5,p=t.residual_handling??"clamp",u=t.residual_absorb_target??"grid",_=Math.max(0,e.solar||0),v=Math.max(0,e.grid||0),g=Math.max(0,-(e.grid||0)),f=Math.max(0,e.battery||0),m=Math.max(0,-(e.battery||0));let y;y=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,_+v+m-g-f);let b=Math.min(_,y),x=_-b,$=y-b,w=Math.min(x,f),C=x-w,k=f-w,A=Math.min(C,g),E=Math.min(m,$),M=$-E,S=m-E,z=Math.min(S,Math.max(0,g-A)),P=Math.min(v,M),I=Math.min(Math.max(0,v-P),k),F=0;const T=y-(b+E+P);Math.abs(T)>i&&("clamp"===p?v>0||P>0?P=Math.max(0,P+T):E>0?E=Math.max(0,E+T):b=Math.max(0,b+T):"absorb"===p?"battery"===u&&(m>0||E>0)?E=Math.max(0,E+T):P=Math.max(0,P+T):F=Math.abs(T));let D=0;e.devices.forEach(e=>{!1!==e.include_in_home&&(D+=Math.max(0,e.power||0))});const U=Math.max(0,y-D),O=[{id:"solar-home",from:"solar",to:"home",value:b,color:me,targetColor:we,gradientId:"glow-solar"},{id:"solar-battery",from:"solar",to:"battery",value:w,color:me,targetColor:xe,gradientId:"glow-solar"},{id:"solar-grid",from:"solar",to:"grid",value:A,color:be,targetColor:be,gradientId:"glow-grid-export"},{id:"battery-home",from:"battery",to:"home",value:E,color:$e,targetColor:we,gradientId:"glow-battery-discharge"},{id:"battery-grid",from:"battery",to:"grid",value:z,color:$e,targetColor:be,gradientId:"glow-battery-discharge"},{id:"grid-home",from:"grid",to:"home",value:P,color:ye,targetColor:we,gradientId:"glow-grid-import"},{id:"grid-battery",from:"grid",to:"battery",value:I,color:ye,targetColor:xe,gradientId:"glow-grid-import"}];e.devices.forEach(e=>{const t=e.color||"var(--energy-device-color, #00bcd4)";O.push({id:`home-${e.id}`,from:"home",to:e.id,value:Math.max(0,e.power||0),color:t,targetColor:t,gradientId:"glow-device",ampere:e.ampere,isDevice:!0})});const L=O.reduce((e,t)=>e+(t.value>i?t.value:0),0),R=O.map(e=>{const t=e.value>i,p=function(e,t="watt",i="sqrt",o=2,a=7,r=50,s=6e3,n,l=5){if(e<=l)return 1.5;if("fixed"===t)return(o+a)/2;if("ampere"===t){if(null==n)return o;const e=.5;return o+Fe((n-e)/(25-e),i)*(a-o)}return o+Fe((e-r)/(s-r),i)*(a-o)}(e.value,o,r,s,n,l,c,e.ampere,i),u=function(e,t="absolute",i="sqrt",o=.8,a=5.5,r=50,s=5e3,n=0,l=5){if(e<=l)return a;let c=0;return c="relative"===t&&n>0?e/n:(e-r)/(s-r),a-Fe(c,i)*(a-o)}(e.value,a,r,d,h,l,c,L,i);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,strokeWidth:p,duration:u,isActive:t}});return{arcs:R,homeConsumption:y,untrackedDevicesPower:U,unbalancedPower:F,totalActivePower:L}}function De(e,t,i){return{x:e.x+Math.cos(i)*t,y:e.y+Math.sin(i)*t}}function Ue(e,t,i=2){if(!Number.isFinite(e))return"0";if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{minimumFractionDigits:0,maximumFractionDigits:i}).format(e)}catch{}return e.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:i})}function Oe(e,t=2,i=1e3,o){const a=Math.abs(e);if(a>=1e6){const i=Ue(e/1e6,o,t);return{value:i,unit:"MW",full:`${i} MW`}}if(a>=i){const i=Ue(e/1e3,o,t);return{value:i,unit:"kW",full:`${i} kW`}}const r=Ue(Math.round(e),o,0);return{value:r,unit:"W",full:`${r} W`}}const Le={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:Ce,defaultColor:me},grid:{x:65,y:200,radius:36,defaultIcon:ke,defaultColor:ye},battery:{x:175,y:335,radius:36,defaultIcon:Ae,defaultColor:xe},home:{x:285,y:200,radius:38,defaultIcon:Ee,defaultColor:we}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410}},Re={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:Ce,defaultColor:me},grid:{x:85,y:175,radius:36,defaultIcon:ke,defaultColor:ye},battery:{x:355,y:175,radius:36,defaultIcon:Ae,defaultColor:xe},home:{x:220,y:290,radius:38,defaultIcon:Ee,defaultColor:we}},devicesVertical:{colLeftX:95,colRightX:345,startY:420}};var Ne={title:"Power Flow",solar:"Solar",grid:"Grid",battery:"Battery",home:"Home",production:"Production",consumption:"Consumption",import:"Import",export:"Export",charge:"Charge",discharge:"Discharge",inactive:"Inactive",active:"Active",unbalanced:"Unbalanced",not_tracked:"Other Consumption"},We={title:"Card Title",solar:"Solar Node",grid:"Grid Node",battery:"Battery Node",home:"Home Node",devices:"Individual Devices",add_device:"Add Device",remove_device:"Remove Device",device_name:"Device Name",device_icon:"Icon",device_color:"Color",entity:"Power Entity",entity_import:"Import Entity",entity_export:"Export Entity",entity_charge:"Charge Entity",entity_discharge:"Discharge Entity",entity_amperage:"Current Entity (Amperes)",invert:"Invert Sign Convention",include_in_home:"Include in Home Total",display_zero:"Display Zero Flow",display_zero_tolerance:"Zero Tolerance (W)",stroke_mode:"Line Thickness Mode",stroke_mode_fixed:"Fixed",stroke_mode_watt:"Dynamic (Watts)",stroke_mode_ampere:"Dynamic (Amperes)",speed_mode:"Particle Speed Mode",speed_mode_absolute:"Absolute (Watts)",speed_mode_relative:"Relative (% of total)",layout_mode:"Layout Mode",layout_auto:"Auto Responsive",layout_horizontal:"Horizontal",layout_vertical:"Vertical (2-Column)",min_duration:"Min Particle Duration (s)",max_duration:"Max Particle Duration (s)",min_stroke:"Min Stroke Width (px)",max_stroke:"Max Stroke Width (px)",scale_min:"Scale Minimum",scale_max:"Scale Maximum",scale_curve:"Scale Curve",smoothing_factor:"Smoothing Factor (EMA)",max_total_particles:"Max Total Particles",residual_handling:"Residual Handling",residual_absorb_target:"Residual Absorb Target"},Ve={missing_entity:"At least one valid power entity is required.",invalid_range:"Invalid range: minimum must be strictly less than maximum."},He={card:Ne,editor:We,errors:Ve},Be={title:"Flusso Energetico",solar:"Solare",grid:"Rete",battery:"Batteria",home:"Casa",production:"Produzione",consumption:"Consumo",import:"Prelevata",export:"Immessa",charge:"Carica",discharge:"Scarica",inactive:"Inattivo",active:"Attivo",unbalanced:"Sbilanciamento",not_tracked:"Altri Consumi"},je={title:"Titolo Card",solar:"Nodo Solare",grid:"Nodo Rete",battery:"Nodo Batteria",home:"Nodo Casa",devices:"Carichi Individuali",add_device:"Aggiungi Dispositivo",remove_device:"Rimuovi Dispositivo",device_name:"Nome Dispositivo",device_icon:"Icona",device_color:"Colore",entity:"Entità Potenza",entity_import:"Entità Prelievo (Import)",entity_export:"Entità Immissione (Export)",entity_charge:"Entità Carica",entity_discharge:"Entità Scarica",entity_amperage:"Entità Corrente (Ampere)",invert:"Inverti Convenzione Segno",include_in_home:"Includi nel Totale Casa",display_zero:"Mostra Linea a Flusso Zero",display_zero_tolerance:"Tolleranza Zero (W)",stroke_mode:"Modalità Spessore Linea",stroke_mode_fixed:"Fisso",stroke_mode_watt:"Dinamico (Watt)",stroke_mode_ampere:"Dinamico (Ampere)",speed_mode:"Modalità Velocità Particelle",speed_mode_absolute:"Assoluta (Watt)",speed_mode_relative:"Relativa (% sul totale)",layout_mode:"Modalità Layout",layout_auto:"Auto Responsive",layout_horizontal:"Orizzontale",layout_vertical:"Verticale (2 Colonne)",min_duration:"Durata Minima Particelle (s)",max_duration:"Durata Massima Particelle (s)",min_stroke:"Spessore Minimo Linea (px)",max_stroke:"Spessore Massimo Linea (px)",scale_min:"Valore Minimo Scala",scale_max:"Valore Massimo Scala",scale_curve:"Curva di Scala",smoothing_factor:"Fattore di Smoothing (EMA)",max_total_particles:"Max Particelle Totali",residual_handling:"Gestione Residuo Bilancio",residual_absorb_target:"Target Assorbimento Residuo"},Ge={missing_entity:"È richiesta almeno un'entità di potenza valida.",invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo."},qe={card:Be,editor:je,errors:Ge};const Ze={en:He||Object.freeze({__proto__:null,card:Ne,default:He,editor:We,errors:Ve}),it:qe||Object.freeze({__proto__:null,card:Be,default:qe,editor:je,errors:Ge})};function Xe(e,t="en"){const i=t.replace(/['"]+/g,"").replace("-","_").split("_")[0],o=Ze[i]||Ze.en,a=e.split(".");let r=o;for(const t of a){if(!r||"object"!=typeof r||!(t in r)){let t=Ze.en;for(const i of a){if(!t||"object"!=typeof t||!(i in t))return e;t=t[i]}return"string"==typeof t?t:e}r=r[t]}return"string"==typeof r?r:e}let Ye=class extends ce{constructor(){super(...arguments),this._watchedEntities=new Set,this._phaseTracker={},this._actualLayout="horizontal"}static async getConfigElement(){return await Promise.resolve().then(function(){return Qe}),document.createElement("simple-power-flow-card-editor")}static getStubConfig(e,t){const i=t||(e?.states?Object.keys(e.states):[]),o=t=>i.find(i=>{const o=i.toLowerCase(),a=e?.states?.[i],r="power"===a?.attributes?.device_class||"W"===a?.attributes?.unit_of_measurement||"kW"===a?.attributes?.unit_of_measurement;return t.some(e=>o.includes(e))&&(r||!e)});return{type:"custom:simple-power-flow-card",card_version:1,title:"Power Flow",solar:{entity:o(["solar","pv","fotovoltaico"])||"sensor.solar_power"},grid:{entity:o(["grid","rete","power_meter","import"])||"sensor.grid_power"},battery:{entity:o(["battery_power","accumulo","batteria"])||"sensor.battery_power"},home:{entity:o(["home_power","house_power","consumo_casa"])||"sensor.home_power"},stroke_mode:"watt",speed_mode:"absolute",layout_mode:"auto",scale_curve:"sqrt",styles:ge}}static{this.styles=Se}setConfig(e){if(!e)throw new Error(Xe("errors.missing_entity"));const t={...fe,...e,styles:{...ge,...e.styles||{}}};if((!t.card_version||t.card_version<1)&&(t.card_version=1),void 0!==t.scale_min&&void 0!==t.scale_max&&t.scale_min>=t.scale_max)throw new Error(Xe("errors.invalid_range")+" (scale_min < scale_max)");if(void 0!==t.min_duration&&void 0!==t.max_duration&&t.min_duration>=t.max_duration)throw new Error(Xe("errors.invalid_range")+" (min_duration < max_duration)");if(void 0!==t.min_stroke&&void 0!==t.max_stroke&&t.min_stroke>=t.max_stroke)throw new Error(Xe("errors.invalid_range")+" (min_stroke < max_stroke)");this._config=t,this._watchedEntities.clear();const i=e=>{e&&this._watchedEntities.add(e)};[this._config.solar,this._config.grid,this._config.battery,this._config.home].forEach(e=>{e&&(i(e.entity),i(e.entity_in),i(e.entity_out),i(e.entity_import),i(e.entity_export),i(e.entity_charge),i(e.entity_discharge),i(e.state_of_charge),i(e.entity_amperage),i(e.secondary_info?.entity))}),Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{i(e.entity),i(e.entity_amperage),i(e.secondary_info?.entity)}),this._checkInitialDimensions()}set hass(e){const t=this._hass;if(this._hass=e,!t||!e||!this._config)return void this.requestUpdate("hass",t);let i=!1;for(const o of this._watchedEntities)if(t.states?.[o]!==e.states?.[o]){i=!0;break}i&&this.requestUpdate("hass",t)}getCardSize(){return"vertical"===this._actualLayout?6:4}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}getLayoutOptions(){return{grid_columns:12,grid_rows:"auto",grid_min_columns:6,grid_min_rows:3}}connectedCallback(){super.connectedCallback(),this._setupObservers(),this._checkInitialDimensions()}firstUpdated(){this._checkInitialDimensions()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupObservers()}_checkInitialDimensions(){const e=this.getBoundingClientRect(),t=e.width>0?e.width:window.innerWidth;this._updateLayoutFromWidth(t)}_updateLayoutFromWidth(e){if("horizontal"===this._config?.layout_mode)return void("horizontal"!==this._actualLayout&&(this._actualLayout="horizontal"));if("vertical"===this._config?.layout_mode)return void("vertical"!==this._actualLayout&&(this._actualLayout="vertical"));const t=this._config?.auto_layout_breakpoint??520,i=e<=t||window.innerWidth<=t;i&&"vertical"!==this._actualLayout?(this._actualLayout="vertical",this.requestUpdate()):!i&&e>t+20&&"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this.requestUpdate())}_setupObservers(){this._resizeObserver||(this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e<=0||this._updateLayoutFromWidth(e)}}),this._resizeObserver.observe(this)),window.addEventListener("resize",()=>{this._checkInitialDimensions()}),this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver(e=>{const t=this.shadowRoot?.querySelector("svg.flow-svg");if(t)for(const i of e)i.isIntersecting?t.unpauseAnimations&&t.unpauseAnimations():t.pauseAnimations&&t.pauseAnimations()}),this._intersectionObserver.observe(this))}_cleanupObservers(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=void 0),this._intersectionObserver&&(this._intersectionObserver.disconnect(),this._intersectionObserver=void 0)}_handleNodeClick(e){if(!this._hass||!e.entityId)return;const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e.entityId}});this.dispatchEvent(t)}render(){if(!this._config)return B``;const e=this._hass?.language||"en",t=this._config.decimals??2,i=this._config.w_to_kw_threshold??1e3,o={...ge,...this._config.styles||{}},a=Ie(this._hass,this._config.solar,"solar"),r=Ie(this._hass,this._config.grid,"grid"),s=Ie(this._hass,this._config.battery,"battery"),n=Ie(this._hass,this._config.home,"home"),l=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Ie(this._hass,e,"device");l.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const c=[];this._watchedEntities.forEach(e=>{this._hass?.states&&!(e in this._hass.states)&&c.push(e)});const d=Te({solar:a.power,grid:r.power,battery:s.power,home:n.isValid?n.power:void 0,devices:l},this._config),h=this._actualLayout,p="horizontal"===h?Le:Re,u=o.node_radius_primary,_=o.node_radius_secondary,v=o.spacing_horizontal,g=o.spacing_vertical,f={};Object.keys(p.nodes).forEach(e=>{f[e]={...p.nodes[e],radius:u}});let m=`0 0 ${p.viewBox.width} ${p.viewBox.height}`;if("horizontal"===h){const e=Le;if(l.forEach((t,i)=>{const o=Math.floor(i/2),a=i%2,r=e.devicesHorizontal.startX+o*v,s=0===a?e.devicesHorizontal.rowTopY:e.devicesHorizontal.rowBottomY;f[t.id]={x:r,y:s,radius:_}}),l.length>2){const t=Math.ceil(l.length/2),i=e.devicesHorizontal.startX+t*v+35;m=`0 0 ${Math.max(620,i)} 410`}}else{const e=Re;if(l.forEach((t,i)=>{const o=i%2,a=Math.floor(i/2),r=0===o?e.devicesVertical.colLeftX:e.devicesVertical.colRightX,s=e.devicesVertical.startY+a*g;f[t.id]={x:r,y:s,radius:_}}),l.length>2){const t=Math.ceil(l.length/2),i=e.devicesVertical.startY+t*g+45;m=`0 0 440 ${Math.max(560,i)}`}}const y=d.arcs.find(e=>"solar-home"===e.id),b=d.arcs.find(e=>"battery-home"===e.id),x=d.arcs.find(e=>"grid-home"===e.id),$=y?.value||0,w=b?.value||0,C=x?.value||0,k=$+w+C,A=[];k>0&&($>0&&A.push({id:"solar",color:this._config.solar?.color||me,percentage:$/k,value:$}),w>0&&A.push({id:"battery",color:this._config.battery?.color||$e,percentage:w/k,value:w}),C>0&&A.push({id:"grid",color:this._config.grid?.color||ye,percentage:C/k,value:C}));let E,M=this._config.home?.color||we;if("predominant"===o.home_glow_mode&&A.length>0){const e=[...A].sort((e,t)=>t.value-e.value);e[0]&&e[0].value>0&&(M=e[0].color)}const S=this._config.grid?.color||ye,z=be;if(r.isDual)E=[{text:`← ${Oe(r.inPower||0,t,i,this._hass).full}`,color:S},{text:`→ ${Oe(r.outPower||0,t,i,this._hass).full}`,color:z}];else{const e=r.power;E=[{text:`${e>=0?"←":"→"} ${Oe(Math.abs(e),t,i,this._hass).full}`,color:e>=0?S:z}]}let P;const I=this._config.battery?.color||xe,F=$e;if(s.isDual)P=[{text:`↓ ${Oe(s.inPower||0,t,i,this._hass).full}`,color:I},{text:`↑ ${Oe(s.outPower||0,t,i,this._hass).full}`,color:F}];else{const e=s.power;P=[{text:`${e>=0?"↓":"↑"} ${Oe(Math.abs(e),t,i,this._hass).full}`,color:e>=0?I:F}]}const T=this._config.display_zero_tolerance??0,D=[{id:"solar",label:this._config.solar?.name||Xe("card.solar",e),icon:this._config.solar?.icon||Ce,color:this._config.solar?.color||me,value:Oe(a.power,t,i,this._hass).value,unit:Oe(a.power,t,i,this._hass).unit,amperage:a.amperage,topInfo:void 0!==a.amperage?`${a.amperage} A`:void 0,isActive:a.power>T,isUnavailable:a.isUnavailable,x:f.solar.x,y:f.solar.y,radius:f.solar.radius,entityId:this._config.solar?.entity,styles:o},{id:"grid",label:this._config.grid?.name||Xe("card.grid",e),icon:this._config.grid?.icon||ke,color:this._config.grid?.color||(r.power>=0?ye:be),value:Oe(Math.abs(r.power),t,i,this._hass).value,unit:Oe(Math.abs(r.power),t,i,this._hass).unit,extraValues:E,amperage:r.amperage,topInfo:void 0!==r.amperage?`${r.amperage} A`:void 0,isActive:Math.abs(r.power)>T,isUnavailable:r.isUnavailable,x:f.grid.x,y:f.grid.y,radius:f.grid.radius,entityId:this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export,styles:o},{id:"battery",label:this._config.battery?.name||Xe("card.battery",e),icon:this._config.battery?.icon||Ae,color:this._config.battery?.color||(s.power>=0?xe:$e),value:Oe(Math.abs(s.power),t,i,this._hass).value,unit:Oe(Math.abs(s.power),t,i,this._hass).unit,extraValues:P,topInfo:s.soc||(void 0!==s.amperage?`${s.amperage} A`:void 0),amperage:s.amperage,isActive:Math.abs(s.power)>T,isUnavailable:s.isUnavailable,x:f.battery.x,y:f.battery.y,radius:f.battery.radius,entityId:this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge,styles:o},{id:"home",label:this._config.home?.name||Xe("card.home",e),icon:this._config.home?.icon||Ee,color:M,value:Oe(d.homeConsumption,t,i,this._hass).value,unit:Oe(d.homeConsumption,t,i,this._hass).unit,secondaryText:d.untrackedDevicesPower>T?`${Xe("card.not_tracked",e)}: ${Oe(d.untrackedDevicesPower,0,i,this._hass).full}`:void 0,isActive:d.homeConsumption>T,isUnavailable:n.isUnavailable&&!a.isValid&&!r.isValid,x:f.home.x,y:f.home.y,radius:f.home.radius,entityId:this._config.home?.entity,mixSegments:A,styles:o}];l.forEach(e=>{const a=f[e.id];a&&D.push({id:e.id,label:e.name||e.id,icon:e.icon||Me,color:e.color||"var(--energy-device-color, #00bcd4)",value:Oe(e.power,t,i,this._hass).value,unit:Oe(e.power,t,i,this._hass).unit,topInfo:void 0!==e.ampere?`${e.ampere} A`:void 0,isActive:e.power>T,isUnavailable:!1,x:a.x,y:a.y,radius:a.radius,entityId:e.entityId,styles:o})});const U=this.shadowRoot?.querySelector("svg.flow-svg"),O=U?.getCurrentTime?U.getCurrentTime():0,L=d.arcs.filter(e=>e.isActive),R=this._config.max_total_particles??30;let N=o.particles_per_arc;return L.length*N>R&&(N=Math.max(1,Math.floor(R/L.length))),B`
  ...
  `}(d.arcs)}
            ...
            <!-- Layer 1: Wires -->
            <g class="wires-layer">
              ${d.arcs.map(e=>{const t=f[e.from],i=f[e.to];if(!t||!i)return j``;const a=function(e,t,i,o){const a=t.x-e.x,r=t.y-e.y,s=Math.atan2(r,a),n=De({x:e.x,y:e.y},e.radius,s),l=De({x:t.x,y:t.y},t.radius,s+Math.PI);if("horizontal"===i){if("solar-home"===o){const i=De({x:e.x,y:e.y},e.radius,.1),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("battery-home"===o){const i=De({x:e.x,y:e.y},e.radius,-.1),o=De({x:t.x,y:t.y},t.radius,Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("solar-battery"===o){const i=De({x:e.x,y:e.y},e.radius,Math.PI/2),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=De({x:e.x,y:e.y},e.radius,0),o=De({x:t.x,y:t.y},t.radius,Math.PI),a=Math.max(40,o.x-i.x),r=i.x+.45*a,s=i.y,n=i.x+.55*a,l=o.y;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${r.toFixed(1)} ${s.toFixed(1)}, ${n.toFixed(1)} ${l.toFixed(1)}, ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}return`M ${n.x.toFixed(1)} ${n.y.toFixed(1)} L ${l.x.toFixed(1)} ${l.y.toFixed(1)}`}if("solar-home"===o){const i=De({x:e.x,y:e.y},e.radius,Math.PI/2),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("grid-battery"===o){const i=De({x:e.x,y:e.y},e.radius,0),o=De({x:t.x,y:t.y},t.radius,Math.PI);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=De({x:e.x,y:e.y},e.radius,Math.PI/2),o=t.x<e.x,a=o?0:Math.PI,r=De({x:t.x,y:t.y},t.radius,a),s=Math.max(40,r.y-i.y),n=i.x,l=i.y+.45*s,c=r.x+(o?20:-20),d=i.y+.65*s;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${n.toFixed(1)} ${l.toFixed(1)}, ${c.toFixed(1)} ${d.toFixed(1)}, ${r.x.toFixed(1)} ${r.y.toFixed(1)}`}return`M ${n.x.toFixed(1)} ${n.y.toFixed(1)} L ${l.x.toFixed(1)} ${l.y.toFixed(1)}`}(t,i,h,e.id);return function(e,t,i){const o=e.isActive?e.color:e.targetColor||e.color,a=e.isActive?1:i?.inactive_wire_opacity??.35,r=!e.isActive&&"solid"!==i?.inactive_wire_style;return j`
    <path id="path-${e.id}"
  ...
  `}(e,a,o)})}
    ...
    `)}return r}(e,N,a,o)})}
            ...
            <!-- Layer 3: Nodes -->
            <g class="nodes-layer">
              ${D.map(e=>function(e,t,i){const o=i||e.styles||{},a=`${e.label}: ${e.value} ${e.unit}${e.secondaryText?` (${e.secondaryText})`:""}`,r=2*Math.PI*e.radius;let s=[];const n=!1!==o.show_home_mix_ring;if(n&&e.mixSegments&&e.mixSegments.length>0&&0!==Number(e.value)){let t=0;s=e.mixSegments.map(i=>{const a=i.percentage*r,s=-t;return t+=a,j`
      ...
      `})}const l=e.radius<34,c=Boolean(e.extraValues&&e.extraValues.length>0),d=Boolean(c&&(e.extraValues?.length||0)>=2),h=Boolean(e.topInfo),p=o.icon_size_primary??18,u=o.icon_size_secondary??16,_=o.spacing_text_above_icon??4,v=o.spacing_text_below_icon??4;let g=l?u:p,f=e.x-g/2,m=e.y-g/2,y=e.y+g/2+v+7,b=e.y-g/2-_-4,x=e.y+g/2+v+7,$=e.y+g/2+v+18;l?h?(g=Math.max(10,.85*u),f=e.x-g/2,m=e.y-g/2-1,b=m-_-4,y=m+g+v+7):(g=u,f=e.x-g/2,m=e.y-g-1,y=m+g+v+8):h&&d?(g=Math.max(12,.8*p),f=e.x-g/2,m=e.y-7,b=m-_-4,x=m+g+v+7,$=x+11):h&&!d?(g=Math.max(14,.9*p),f=e.x-g/2,m=e.y-4,b=m-_-4,y=m+g+v+8,x=y):!h&&d?(g=p,f=e.x-g/2,m=e.y-g-4,x=m+g+v+7,$=x+11):(g=p,f=e.x-g/2,m=e.y-g-2,y=m+g+v+8);const w=e.y+e.radius+14,C=e.y+e.radius+26;let k=j`<tspan x="${e.x}">${e.label}</tspan>`;if(e.label.length>11)if(e.label.includes("/")){const t=e.label.split("/");k=j`
        <tspan x="${e.x}" dy="0">${t[0]}/</tspan>
        <tspan x="${e.x}" dy="11">${t.slice(1).join("/")}</tspan>
      `}else if(e.label.includes(" ")){const t=e.label.split(" "),i=Math.ceil(t.length/2),o=t.slice(0,i).join(" "),a=t.slice(i).join(" ");k=j`
    ...
    <g class="node-group"
      ...
      <!-- Center Icon -->
      <foreignObject x="${f.toFixed(1)}" y="${m.toFixed(1)}" width="${g.toFixed(1)}" height="${g.toFixed(1)}" style="overflow: visible;">
      ...
      ${c?j`
        ${e.extraValues.map((t,i)=>{const o=0===i?x:$;return j`
      ...
      <!-- Outside Label -->
      <text class="node-label-outside" x="${e.x}" y="${w}">
        ${k}
      </text>

      <!-- Optional Secondary Text -->
      ${e.secondaryText&&!c?j`
        <text class="node-sub-outside" x="${e.x}" y="${C}">
          ${e.secondaryText}
        </text>
      `:""}
    </g>
    ...
    `}render(){if(!this._config)return B``;const e=this.hass?.language||"en",t=this._config.styles||ge;return B`
      <div class="card-config">
        ...
        ${"styles"===this._activeTab?B`
          ...
          <div class="form-row">
            <label>Dimensione Icone Nodi Primari</label>
            <div class="slider-row">
              <input type="range" min="12" max="28" step="1" .value=${t.icon_size_primary??18} @input=${e=>this._styleChanged("icon_size_primary",parseFloat(e.target.value))} />
              <span class="slider-val">${t.icon_size_primary??18} px</span>
            </div>
          </div>

          <div class="form-row">
            <label>Dimensione Icone Carichi / Dispositivi</label>
            <div class="slider-row">
              <input type="range" min="10" max="24" step="1" .value=${t.icon_size_secondary??16} @input=${e=>this._styleChanged("icon_size_secondary",parseFloat(e.target.value))} />
              <span class="slider-val">${t.icon_size_secondary??16} px</span>
            </div>
          </div>

          <div class="section-title">🔤 Tipografia & Spaziature Testi</div>
          <div class="form-row">
            <label>Spazio Testo Sopra Icona (SoC % / Ampere)</label>
            <div class="slider-row">
              <input type="range" min="0" max="15" step="1" .value=${t.spacing_text_above_icon??4} @input=${e=>this._styleChanged("spacing_text_above_icon",parseFloat(e.target.value))} />
              <span class="slider-val">${t.spacing_text_above_icon??4} px</span>
            </div>
          </div>

          <div class="form-row">
            <label>Spazio Testo Sotto Icona (Watt / Frecce)</label>
            <div class="slider-row">
              <input type="range" min="0" max="15" step="1" .value=${t.spacing_text_below_icon??4} @input=${e=>this._styleChanged("spacing_text_below_icon",parseFloat(e.target.value))} />
              <span class="slider-val">${t.spacing_text_below_icon??4} px</span>
            </div>
          </div>
