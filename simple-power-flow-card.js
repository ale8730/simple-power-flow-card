...
`,Pe=["switch","light","fan","input_boolean","climate","water_heater","media_player","vacuum","cover","lock","humidifier"];function De(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const o=t.replace(",",".").replace(/[^0-9.-]/g,""),i=parseFloat(o);return Number.isFinite(i)?i:null}function Te(e,t){if(!t||"string"!=typeof t||""===t.trim())return{value:0,rawState:"",unit:"",isConfigured:!1,isUnavailable:!1,isUnknown:!1,isValid:!1};if(!e||!e.states||!e.states[t])return{value:0,rawState:"",unit:"",isConfigured:!0,isUnavailable:!0,isUnknown:!1,isValid:!1};const o=e.states[t],i=o.state,a=o.attributes?.unit_of_measurement||"W",n=o.attributes?.device_class,r=function(e,t){const o=e.trim().toLowerCase(),i=(t||"").trim().toLowerCase();return["kwh","wh","mwh","gwh"].includes(o)||"energy"===i?{isValid:!1,reason:`Sensore in unità di energia (${e}) invece che potenza (W/kW). I flussi in tempo reale richiedono sensori di potenza (W/kW).`}:"%"===o&&"battery"!==i?{isValid:!1,reason:"Sensore in percentuale (%) utilizzato come fonte di potenza. Richiesto sensore in W o kW."}:["v","mv","kv","°c","°f","c","f","hz","bar","psi","ppm","lux"].includes(o)?{isValid:!1,reason:`Sensore con unità '${e}' incompatibile con un flusso di potenza (W/kW/A).`}:{isValid:!0}}(a,n);if("unavailable"===i)return{value:0,rawState:i,unit:a,isConfigured:!0,isUnavailable:!0,isUnknown:!1,isValid:!1,hasInvalidUnit:!r.isValid,invalidUnitReason:r.reason};if("unknown"===i)return{value:0,rawState:i,unit:a,isConfigured:!0,isUnavailable:!1,isUnknown:!0,isValid:!1,hasInvalidUnit:!r.isValid,invalidUnitReason:r.reason};const s=De(i);if(null===s)return{value:0,rawState:i,unit:a,isConfigured:!0,isUnavailable:!1,isUnknown:!0,isValid:!1,hasInvalidUnit:!r.isValid,invalidUnitReason:r.reason};return{value:function(e,t){const o=t.trim(),i=o.toLowerCase();if("mW"===o)return.001*e;switch(i){case"kw":case"kva":case"kvar":return 1e3*e;case"mw":case"mva":return 1e6*e;case"gw":case"gva":case"gvar":return 1e9*e;case"w":case"va":case"var":case"a":default:return e;case"ma":return.001*e}}(s,a),rawState:i,unit:a,isConfigured:!0,isUnavailable:!1,isUnknown:!1,isValid:!0,hasInvalidUnit:!r.isValid,invalidUnitReason:r.reason}}function Le(e,t,o="solar"){if(!t)return{power:0,isConfigured:!1,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};let i,a,n;if(t.entity_amperage){const o=Te(e,t.entity_amperage);o.isValid&&(i=o.value)}let r=t.state_of_charge;if(!r&&t.secondary_info?.entity){const o=e?.states?.[t.secondary_info.entity];"battery"===o?.attributes?.device_class&&(r=t.secondary_info.entity)}if(r&&e?.states?.[r]){const t=e.states[r],o=De(t.state);if(null!==o){const e=t.attributes?.unit_of_measurement,i=t.attributes?.device_class;n=!e&&"battery"===i&&o<=1&&o>=0?Math.max(0,Math.min(100,100*o)):Math.max(0,Math.min(100,o)),a=`${Math.round(n)}%`}}const s=t.entity_import||("grid"===o?t.entity_in:void 0),l=t.entity_export||("grid"===o?t.entity_out:void 0),d=t.entity_charge||("battery"===o?t.entity_in:void 0),c=t.entity_discharge||("battery"===o?t.entity_out:void 0),_=Boolean(s||l),p=Boolean(d||c);if("grid"===o&&_){const t=Te(e,s),o=Te(e,l),a=t.isValid?Math.max(0,t.value):0,n=o.isValid?Math.max(0,o.value):0;return{power:a-n,inPower:a,outPower:n,isDual:!0,isConfigured:!0,amperage:i,isUnavailable:!!s&&t.isUnavailable&&!!l&&o.isUnavailable,isUnknown:t.isUnknown||o.isUnknown,isValid:t.isValid||o.isValid,rawUnit:t.unit||o.unit||"W",hasInvalidUnit:t.hasInvalidUnit||o.hasInvalidUnit,invalidUnitReason:t.invalidUnitReason||o.invalidUnitReason}}if("battery"===o&&p){const t=Te(e,d),o=Te(e,c),r=t.isValid?Math.max(0,t.value):0,s=o.isValid?Math.max(0,o.value):0;return{power:r-s,inPower:r,outPower:s,isDual:!0,isConfigured:!0,soc:a,socPercent:n,amperage:i,isUnavailable:!!d&&t.isUnavailable&&!!c&&o.isUnavailable,isUnknown:t.isUnknown||o.isUnknown,isValid:t.isValid||o.isValid,rawUnit:t.unit||o.unit||"W",hasInvalidUnit:t.hasInvalidUnit||o.hasInvalidUnit,invalidUnitReason:t.invalidUnitReason||o.invalidUnitReason}}const u=Te(e,t.entity);let h=u.value;return t.invert&&(h=-h),{power:h,inPower:h>=0?h:0,outPower:h<0?Math.abs(h):0,isDual:!1,isConfigured:u.isConfigured,soc:a,socPercent:n,amperage:i,isUnavailable:u.isUnavailable,isUnknown:u.isUnknown,isValid:u.isValid,rawUnit:u.unit||"W",hasInvalidUnit:u.hasInvalidUnit,invalidUnitReason:u.invalidUnitReason}}const Oe={red:[244,67,54],pink:[233,30,99],purple:[156,39,176],"deep-purple":[103,58,183],indigo:[63,81,181],blue:[33,150,243],"light-blue":[3,169,244],cyan:[0,188,212],teal:[0,150,136],green:[76,175,80],"light-green":[139,195,74],lime:[205,220,57],yellow:[255,235,59],amber:[255,193,7],orange:[255,152,0],"deep-orange":[255,87,34],brown:[121,85,72],grey:[158,158,158],gray:[158,158,158],"blue-grey":[96,125,139],"blue-gray":[96,125,139],black:[0,0,0],white:[255,255,255]},Ne={primary:"--rgb-primary-color",accent:"--rgb-accent-color",disabled:"--rgb-disabled-color",state:"--rgb-state-default-color"},Ue={primary:[3,169,244],accent:[255,152,0],disabled:[189,189,189],state:[68,115,158]},Re={gray:"grey","blue-gray":"blue-grey"};function We(e){return Math.max(0,Math.min(255,Math.round(e)))}function Be(e,t){if(null==e)return t;if(Array.isArray(e))return e.length>=3?`rgb(${We(e[0])}, ${We(e[1])}, ${We(e[2])})`:t;if("string"!=typeof e)return t;let o=e.trim();if(""===o)return t;if(o.startsWith("#")||o.startsWith("rgb(")||o.startsWith("rgba(")||o.startsWith("hsl(")||o.startsWith("hsla(")||o.startsWith("var("))return o;if(o in Re&&(o=Re[o]),o in Ne){const e=Ue[o]||[128,128,128];return`rgb(var(${Ne[o]}, ${e[0]}, ${e[1]}, ${e[2]}))`}if(o in Oe){const[e,t,i]=Oe[o];return`rgb(var(--rgb-${o}, ${e}, ${t}, ${i}))`}return o}function Ge(e,t,o){if(null==e)return t;if(Array.isArray(e))return e.length>=3?[We(e[0]),We(e[1]),We(e[2])]:t;if("string"!=typeof e)return t;const i=e.trim();if(""===i)return t;if(i.startsWith("#")){const e=i.slice(1);if(3===e.length||4===e.length){const t=parseInt(e[0]+e[0],16),o=parseInt(e[1]+e[1],16),i=parseInt(e[2]+e[2],16);if(!isNaN(t)&&!isNaN(o)&&!isNaN(i))return[t,o,i]}else if(e.length>=6){const t=parseInt(e.substring(0,2),16),o=parseInt(e.substring(2,4),16),i=parseInt(e.substring(4,6),16);if(!isNaN(t)&&!isNaN(o)&&!isNaN(i))return[t,o,i]}return t}if(i.startsWith("rgb(")||i.startsWith("rgba(")){const e=i.match(/rgba?\(\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)/);if(e)return[We(parseFloat(e[1])),We(parseFloat(e[2])),We(parseFloat(e[3]))];const t=i.match(/rgba?\(\s*(\d+(?:\.\d+)?)\s+(\d+(?:\.\d+)?)\s+(\d+(?:\.\d+)?)/);if(t)return[We(parseFloat(t[1])),We(parseFloat(t[2])),We(parseFloat(t[3]))]}const a=Re[i]||i,n=a in Ne,r=a in Oe;if(n||r){if(r)return Oe[i];if(n)return Ue[i]||t}if(i.startsWith("var(")){const e=i.indexOf(",");if(-1!==e&&i.endsWith(")")){return Ge(i.slice(e+1,-1).trim(),t)}}return t}function qe(e,t="sqrt"){const o=Math.max(0,Math.min(1,e));switch(t){case"linear":return o;case"sqrt":default:return Math.sqrt(o);case"log":return Math.log(1+9*o)/Math.LN10}}function Ve(e,t={}){const o=t.display_zero_tolerance??1,i=t.stroke_mode??"watt",a=t.speed_mode??"absolute",n=t.scale_curve??"sqrt",r=t.min_stroke??2,s=t.max_stroke??7,l=t.scale_min??50,d=t.scale_max??6e3,c=t.min_duration??.8,_=t.max_duration??5.5,p=t.residual_handling??"clamp",u=t.residual_absorb_target??"grid",h=Math.max(0,e.solar||0),m=Math.max(0,e.grid||0),f=Math.max(0,-(e.grid||0)),g=Math.max(0,e.battery||0),b=Math.max(0,-(e.battery||0));let y;y=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,h+m+b-f-g);let x=0,v=0,w=0,$=h;x=Math.min($,y),$-=x,v=Math.min($,g),$-=v,w=Math.min($,f),$-=w;let S=0,z=0,F=b;const C=Math.max(0,y-x);S=Math.min(F,C),F-=S;const A=Math.max(0,f-w);z=Math.min(F,A),F-=z;let k=0,M=0,E=m;const I=Math.max(0,C-S);k=Math.min(E,I),E-=k;const P=Math.max(0,g-v);M=Math.min(E,P),E-=M;let D=0;const T=y-(x+S+k);Math.abs(T)>o&&("clamp"===p||("absorb"===p?"battery"===u&&b>0?S=Math.max(0,S+T):k=Math.max(0,k+T):D=Math.abs(T)));const{parentPowers:L,devicesSumInHome:O}=function(e){let t=0;const o=new Map;for(const i of e){const e=i.sub_devices||[];let a=0;for(const t of e){const e=Math.max(0,t.power||0);!1!==t.include_in_parent&&(a+=e)}let n=0;n=!0===i.hasOwnEntity||void 0===i.hasOwnEntity&&0===e.length?Math.max(0,i.power||0):!1===i.hasOwnEntity?a:i.power&&i.power>0?i.power:a,o.set(i.id,n),!1!==i.include_in_home&&(t+=n);for(const o of e){const e=Math.max(0,o.power||0);!1===o.include_in_parent&&!1!==o.include_in_home&&(t+=e)}}return{parentPowers:o,devicesSumInHome:t}}(e.devices),N=Math.max(0,y-O),U=O>y&&y>0,R=U?O-y:0,W=Be(t.solar?.color,ve),B=Be(t.grid?.color,we),G=$e,q=Be(t.battery?.color_charge||t.battery?.color,Se),V=Be(t.battery?.color_discharge,ze),H=Be(t.home?.color,Fe),j=!1!==t.solar?.display_zero,Y=!1!==t.battery?.display_zero,K=!1!==t.grid?.display_zero,X=[];(j||x>o)&&X.push({id:"solar-home",from:"solar",to:"home",value:x,color:W,targetColor:H,gradientId:"glow-solar"}),(j||v>o)&&X.push({id:"solar-battery",from:"solar",to:"battery",value:v,color:W,targetColor:q,gradientId:"glow-solar"}),(j||w>o)&&X.push({id:"solar-grid",from:"solar",to:"grid",value:w,color:G,targetColor:G,gradientId:"glow-grid-export"}),(Y||S>o)&&X.push({id:"battery-home",from:"battery",to:"home",value:S,color:V,targetColor:H,gradientId:"glow-battery-discharge"}),(Y||z>o)&&X.push({id:"battery-grid",from:"battery",to:"grid",value:z,color:V,targetColor:G,gradientId:"glow-battery-discharge"});const Z=X.some(e=>"home"===e.to);(K||k>o||!Z)&&X.push({id:"grid-home",from:"grid",to:"home",value:k,color:B,targetColor:H,gradientId:"glow-grid-import"}),(K||M>o)&&X.push({id:"grid-battery",from:"grid",to:"battery",value:M,color:B,targetColor:q,gradientId:"glow-grid-import"}),e.devices.forEach(e=>{const t=L.get(e.id)??Math.max(0,e.power||0),i=!1!==e.display_zero||t>o,a=Be(e.color,"var(--energy-device-color, #00bcd4)");i&&X.push({id:`home-${e.id}`,from:"home",to:e.id,value:t,color:a,targetColor:a,gradientId:"glow-device",ampere:e.ampere,isDevice:!0,isSubDevice:!1}),Array.isArray(e.sub_devices)&&e.sub_devices.forEach(t=>{const i=Math.max(0,t.power||0);if(!1===t.display_zero&&i<=o)return;const n=Be(t.color,a);X.push({id:`${e.id}-${t.id}`,from:e.id,to:t.id,value:i,color:n,targetColor:n,gradientId:"glow-device",ampere:t.ampere,isDevice:!0,isSubDevice:!0})})});const Q=X.reduce((e,t)=>e+(t.value>o?t.value:0),0),J=X.map(e=>{const t=e.value>o,p=function(e,t="watt",o="sqrt",i=2,a=7,n=50,r=6e3,s,l=1){if(e<=l)return 1.5;if("fixed"===t)return(i+a)/2;if("ampere"===t){if(null==s)return i;const e=.5;return i+qe((s-e)/(25-e),o)*(a-i)}return i+qe((e-n)/(r-n),o)*(a-i)}(e.value,i,n,r,s,l,d,e.ampere,o),u=function(e,t="absolute",o="sqrt",i=.8,a=5.5,n=50,r=5e3,s=0,l=1){if(e<=l)return a;let d=0;return d="relative"===t&&s>0?e/s:(e-n)/(r-n),a-qe(d,o)*(a-i)}(e.value,a,n,c,_,l,d,Q,o);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,isSubDevice:e.isSubDevice,strokeWidth:p,duration:u,isActive:t}});return{arcs:J,homeConsumption:y,untrackedDevicesPower:N,unbalancedPower:D,totalActivePower:Q,devicesSumInHome:O,isHomeOverloaded:U,excessDevicesPower:R}}function He(e,t,o){return{x:e.x+Math.cos(o)*t,y:e.y+Math.sin(o)*t}}function je(e,t,o,i,a=0,n=1,r,s=!1){const l=r?.line_routing_mode||"bezier_curved",d=r?.bus_lane_spacing??8,c=r?.bus_corner_radius??20;if(s)return function(e,t,o="bezier_curved",i=15){const a=e.radius,n=t.radius,r=t.x-e.x,s=t.y-e.y;if(Math.abs(s)>=Math.abs(r)){if(s>=0){const r={x:e.x,y:e.y+a},s={x:t.x,y:t.y-n},l=Math.abs(s.x-r.x),d=Math.max(0,s.y-r.y),c=s.x>=r.x?1:-1;if(l<2||d<6)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;if("orthogonal_bus"===o){const e=r.y+.5*d,t=Math.max(0,Math.min(i,.45*l,.45*d));if(t<1)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${r.x.toFixed(1)} ${e.toFixed(1)} L ${s.x.toFixed(1)} ${e.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;const o=e-t,a=r.x+c*t,n=s.x-c*t,_=e+t;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${r.x.toFixed(1)} ${o.toFixed(1)} C ${r.x.toFixed(1)} ${(o+.55*t).toFixed(1)}, ${(r.x+c*t*.45).toFixed(1)} ${e.toFixed(1)}, ${a.toFixed(1)} ${e.toFixed(1)} L ${n.toFixed(1)} ${e.toFixed(1)} C ${(n+c*t*.55).toFixed(1)} ${e.toFixed(1)}, ${s.x.toFixed(1)} ${(e+.45*t).toFixed(1)}, ${s.x.toFixed(1)} ${_.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}{const e=r.x,t=r.y+.45*d,o=s.x,i=r.y+.55*d;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} C ${e.toFixed(1)} ${t.toFixed(1)}, ${o.toFixed(1)} ${i.toFixed(1)}, ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}}{const r={x:e.x,y:e.y-a},s={x:t.x,y:t.y+n},l=Math.abs(s.x-r.x),d=Math.max(0,r.y-s.y),c=s.x>=r.x?1:-1;if(l<2||d<6)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;if("orthogonal_bus"===o){const e=r.y-.5*d,t=Math.max(0,Math.min(i,.45*l,.45*d));if(t<1)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${r.x.toFixed(1)} ${e.toFixed(1)} L ${s.x.toFixed(1)} ${e.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;const o=e+t,a=r.x+c*t,n=s.x-c*t,_=e-t;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${r.x.toFixed(1)} ${o.toFixed(1)} C ${r.x.toFixed(1)} ${(o-.55*t).toFixed(1)}, ${(r.x+c*t*.45).toFixed(1)} ${e.toFixed(1)}, ${a.toFixed(1)} ${e.toFixed(1)} L ${n.toFixed(1)} ${e.toFixed(1)} C ${(n+c*t*.55).toFixed(1)} ${e.toFixed(1)}, ${s.x.toFixed(1)} ${(e-.45*t).toFixed(1)}, ${s.x.toFixed(1)} ${_.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}{const e=r.x,t=r.y-.45*d,o=s.x,i=r.y-.55*d;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} C ${e.toFixed(1)} ${t.toFixed(1)}, ${o.toFixed(1)} ${i.toFixed(1)}, ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}}}if(r>=0){const r={x:e.x+a,y:e.y},s={x:t.x-n,y:t.y},l=Math.max(0,s.x-r.x),d=Math.abs(s.y-r.y),c=s.y>=r.y?1:-1;if(d<2||l<6)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;if("orthogonal_bus"===o){const e=r.x+.5*l,t=Math.max(0,Math.min(i,.45*l,.45*d));if(t<1)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${e.toFixed(1)} ${r.y.toFixed(1)} L ${e.toFixed(1)} ${s.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;const o=e-t,a=r.y+c*t,n=s.y-c*t,_=e+t;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${o.toFixed(1)} ${r.y.toFixed(1)} C ${(o+.55*t).toFixed(1)} ${r.y.toFixed(1)}, ${e.toFixed(1)} ${(r.y+c*t*.45).toFixed(1)}, ${e.toFixed(1)} ${a.toFixed(1)} L ${e.toFixed(1)} ${n.toFixed(1)} C ${e.toFixed(1)} ${(n+c*t*.55).toFixed(1)}, ${(e+.45*t).toFixed(1)} ${s.y.toFixed(1)}, ${_.toFixed(1)} ${s.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}{const e=r.x+.45*l,t=r.y,o=r.x+.55*l,i=s.y;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} C ${e.toFixed(1)} ${t.toFixed(1)}, ${o.toFixed(1)} ${i.toFixed(1)}, ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}}{const r={x:e.x-a,y:e.y},s={x:t.x+n,y:t.y},l=Math.max(0,r.x-s.x),d=Math.abs(s.y-r.y),c=s.y>=r.y?1:-1;if(d<2||l<6)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;if("orthogonal_bus"===o){const e=r.x-.5*l,t=Math.max(0,Math.min(i,.45*l,.45*d));if(t<1)return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${e.toFixed(1)} ${r.y.toFixed(1)} L ${e.toFixed(1)} ${s.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`;const o=e+t,a=r.y+c*t,n=s.y-c*t,_=e-t;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} L ${o.toFixed(1)} ${r.y.toFixed(1)} C ${(o-.55*t).toFixed(1)} ${r.y.toFixed(1)}, ${e.toFixed(1)} ${(r.y+c*t*.45).toFixed(1)}, ${e.toFixed(1)} ${a.toFixed(1)} L ${e.toFixed(1)} ${n.toFixed(1)} C ${e.toFixed(1)} ${(n+c*t*.55).toFixed(1)}, ${(e-.45*t).toFixed(1)} ${s.y.toFixed(1)}, ${_.toFixed(1)} ${s.y.toFixed(1)} L ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}{const e=r.x-.45*l,t=r.y,o=r.x-.55*l,i=s.y;return`M ${r.x.toFixed(1)} ${r.y.toFixed(1)} C ${e.toFixed(1)} ${t.toFixed(1)}, ${o.toFixed(1)} ${i.toFixed(1)}, ${s.x.toFixed(1)} ${s.y.toFixed(1)}`}}}(e,t,l,c);const _=e.radius,p=t.radius,u=t.x-e.x,h=t.y-e.y,m=Math.atan2(h,u),f=He({x:e.x,y:e.y},_,m),g=He({x:t.x,y:t.y},p,m+Math.PI);if("horizontal"===o){if("solar-home"===i){const o=He({x:e.x,y:e.y},_,.1),i=He({x:t.x,y:t.y},p,-Math.PI/2);return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}if("battery-home"===i){const o=He({x:e.x,y:e.y},_,-.1),i=He({x:t.x,y:t.y},p,Math.PI/2);return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}if("solar-battery"===i){const o=He({x:e.x,y:e.y},_,Math.PI/2),i=He({x:t.x,y:t.y},p,-Math.PI/2);return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} L ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}if(i&&i.startsWith("home-")){const o=t.y<e.y;if("orthogonal_bus"===l){const i=Math.floor(a/2),s=Math.max(0,Math.ceil(n/2)-1),l=((r?.invert_bus_lane_order?s-i:i)+.5)*d,u=o?e.y-l:e.y+l,h=Math.asin(Math.max(-.9,Math.min(.9,(u-e.y)/_))),m=e.x+Math.cos(h)*_,f=t.x,g=o?t.y+p:t.y-p,b=Math.min(c,.45*Math.abs(f-m),.45*Math.abs(g-u)),y=Math.max(6,b);if(o){const e=f-y,t=u-y;return`M ${m.toFixed(1)} ${u.toFixed(1)} L ${e.toFixed(1)} ${u.toFixed(1)} C ${(e+.55*y).toFixed(1)} ${u.toFixed(1)}, ${f.toFixed(1)} ${(u-.45*y).toFixed(1)}, ${f.toFixed(1)} ${t.toFixed(1)} L ${f.toFixed(1)} ${g.toFixed(1)}`}{const e=f-y,t=u+y;return`M ${m.toFixed(1)} ${u.toFixed(1)} L ${e.toFixed(1)} ${u.toFixed(1)} C ${(e+.55*y).toFixed(1)} ${u.toFixed(1)}, ${f.toFixed(1)} ${(u+.45*y).toFixed(1)}, ${f.toFixed(1)} ${t.toFixed(1)} L ${f.toFixed(1)} ${g.toFixed(1)}`}}{const o=He({x:e.x,y:e.y},_,0),i=He({x:t.x,y:t.y},p,Math.PI),a=Math.max(40,i.x-o.x),n=o.x+.45*a,r=o.y,s=o.x+.55*a,l=i.y;return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} C ${n.toFixed(1)} ${r.toFixed(1)}, ${s.toFixed(1)} ${l.toFixed(1)}, ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${g.x.toFixed(1)} ${g.y.toFixed(1)}`}if("solar-home"===i){const o=He({x:e.x,y:e.y},_,Math.PI/2),i=He({x:t.x,y:t.y},p,-Math.PI/2);return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} L ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}if("grid-battery"===i){const o=He({x:e.x,y:e.y},_,0),i=He({x:t.x,y:t.y},p,Math.PI);return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} L ${i.x.toFixed(1)} ${i.y.toFixed(1)}`}if(i&&i.startsWith("home-")){const o=t.x<e.x;if("orthogonal_bus"===l){const i=Math.floor(a/2),s=Math.max(0,Math.ceil(n/2)-1),l=((r?.invert_bus_lane_order?s-i:i)+.5)*d,u=o?e.x-l:e.x+l,h=Math.max(-.9,Math.min(.9,(u-e.x)/_)),m=Math.PI/2+Math.asin(h),f=e.y+Math.sin(m)*_,g=o?t.x+p:t.x-p,b=t.y,y=Math.min(c,.45*Math.abs(g-u),.45*Math.abs(b-f)),x=Math.max(6,y);if(o){const e=b-x,t=u-x;return`M ${u.toFixed(1)} ${f.toFixed(1)} L ${u.toFixed(1)} ${e.toFixed(1)} C ${u.toFixed(1)} ${(e+.55*x).toFixed(1)}, ${(u-.45*x).toFixed(1)} ${b.toFixed(1)}, ${t.toFixed(1)} ${b.toFixed(1)} L ${g.toFixed(1)} ${b.toFixed(1)}`}{const e=b-x,t=u+x;return`M ${u.toFixed(1)} ${f.toFixed(1)} L ${u.toFixed(1)} ${e.toFixed(1)} C ${u.toFixed(1)} ${(e+.55*x).toFixed(1)}, ${(u+.45*x).toFixed(1)} ${b.toFixed(1)}, ${t.toFixed(1)} ${b.toFixed(1)} L ${g.toFixed(1)} ${b.toFixed(1)}`}}{const i=He({x:e.x,y:e.y},_,Math.PI/2),a=o?0:Math.PI,n=He({x:t.x,y:t.y},p,a),r=Math.max(40,n.y-i.y),s=i.x,l=i.y+.45*r,d=n.x+(o?20:-20),c=i.y+.65*r;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${s.toFixed(1)} ${l.toFixed(1)}, ${d.toFixed(1)} ${c.toFixed(1)}, ${n.x.toFixed(1)} ${n.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${g.x.toFixed(1)} ${g.y.toFixed(1)}`}function Ye(e,t,o=2){if(!Number.isFinite(e))return"0";const i=Number.isFinite(o)?Math.max(0,Math.min(20,Math.floor(o))):2;if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{minimumFractionDigits:0,maximumFractionDigits:i}).format(e)}catch{}try{return e.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:i})}catch{return e.toFixed(i)}}function Ke(e,t=2,o=1e3,i){if(!Number.isFinite(e))return{value:"0",unit:"W",full:"0 W"};const a=Math.abs(e),n=Number.isFinite(t)?Math.max(0,Math.min(20,Math.floor(t))):2,r=Number.isFinite(o)&&o>0?o:1e3;if(a>=1e6){const t=Ye(e/1e6,i,n);return{value:t,unit:"MW",full:`${t} MW`}}if(a>=r){const t=Ye(e/1e3,i,n);return{value:t,unit:"kW",full:`${t} kW`}}const s=Ye(Math.round(e),i,0);return{value:s,unit:"W",full:`${s} W`}}function Xe(e,t=1,o){if(!Number.isFinite(e))return{value:"0",unit:"A",full:"0 A"};const i=Ye(e,o,Number.isFinite(t)?Math.max(0,Math.min(20,Math.floor(t))):1);return{value:i,unit:"A",full:`${i} A`}}const Ze={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:Ce,defaultColor:ve},grid:{x:65,y:200,radius:36,defaultIcon:Ae,defaultColor:we},battery:{x:175,y:335,radius:36,defaultIcon:ke,defaultColor:Se},home:{x:285,y:200,radius:38,defaultIcon:Me,defaultColor:Fe}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410,spacingX:120,radius:28}},Qe={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:Ce,defaultColor:ve},grid:{x:85,y:175,radius:36,defaultIcon:Ae,defaultColor:we},battery:{x:355,y:175,radius:36,defaultIcon:ke,defaultColor:Se},home:{x:220,y:290,radius:38,defaultIcon:Me,defaultColor:Fe}},devicesVertical:{colLeftX:95,colRightX:345,startY:420,spacingY:85,radius:28}};function Je(e,t=1,o){const[i,a,n]=Ge(e,[255,255,255]),r=Math.max(0,Math.min(1,t)),s=function(){if("undefined"==typeof window)return!0;if("undefined"!=typeof document){const e=document.documentElement?.getAttribute("theme")||document.body?.getAttribute("theme");if(e&&(e.includes("dark")||e.includes("black")))return!0;if(e&&e.includes("light"))return!1}return"function"!=typeof window.matchMedia||window.matchMedia("(prefers-color-scheme: dark)").matches}();return(.299*(i*r+(s?30:255)*(1-r))+.587*(a*r+(s?41:255)*(1-r))+.114*(n*r+(s?59:255)*(1-r)))/255>.6?"#0f172a":"#ffffff"}var et,tt;!function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(et||(et={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(tt||(tt={}));const ot=e=>{((e,t,o,i)=>{i=i||{},o=null==o?{}:o;const a=new Event(t,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});a.detail=o,e.dispatchEvent(a)})(window,"haptic",e)};function it(e,t){const o=t.split(".")[0]||"homeassistant",i=(e.states?.[t]?.state||"").toLowerCase();"sensor"!==o&&"binary_sensor"!==o&&("climate"===o?"off"===i?e.callService("climate","turn_on",{entity_id:t}):e.callService("climate","turn_off",{entity_id:t}):"water_heater"===o?"off"===i?e.callService("water_heater","turn_on",{entity_id:t}):e.callService("water_heater","turn_off",{entity_id:t}):"lock"===o?"locked"===i?e.callService("lock","unlock",{entity_id:t}):e.callService("lock","lock",{entity_id:t}):e.callService(o,"toggle",{entity_id:t}))}function at(e,t,o,i){if(!t)return;const a=o.switchEntityId;if("toggle"===i){if(!a)return;try{ot("light")}catch(e){}return void it(t,a)}let n,r="auto";if("hold"===i)n=o.holdAction,r=o.holdMoreInfoTarget||"auto",n||(n=o.switchEntityId?{action:"toggle"}:{action:"more-info"});else if("double_tap"===i){if(n=o.doubleTapAction,r=o.doubleTapMoreInfoTarget||"auto",!n||"none"===n.action)return}else n=o.tapAction||{action:"more-info"},r=o.tapMoreInfoTarget||"auto";if(!n||"none"===n.action)return;const s=n.action||"none";try{if("toggle"===s){const e=n.target?.entity_id||n.entity||a;if(!e)return;try{ot("medium")}catch(e){}it(t,e)}else if("more-info-switch"===s||"more-info-device"===s){try{ot("selection")}catch(e){}const t=o.switchEntityId||o.entityId;t&&e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}else if("more-info-sensor"===s){try{ot("selection")}catch(e){}const t=o.entityId||o.switchEntityId;t&&e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}else if("more-info"===s){try{ot("selection")}catch(e){}let t;const a=n.target?.entity_id||n.entity,s="hold"===i?o.holdMoreInfoEntity:"double_tap"===i?o.doubleTapMoreInfoEntity:o.tapMoreInfoEntity;t=a||(s||("custom"===r?s||o.entityId||o.switchEntityId:"soc"===r?o.socEntityId||o.entityId:"secondary"===r?o.secondaryEntityId||o.entityId:"amperage"===r?o.amperageEntityId||o.entityId:"sensor"===r?o.entityId:"switch"===r?o.switchEntityId||o.entityId:"battery"===o.id&&"hold"===i&&o.socEntityId?o.socEntityId:o.switchEntityId||o.entityId)),t&&e.dispatchEvent(new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}))}else if("call-service"===s||"perform-action"===s){try{ot("success")}catch(e){}const e=n.service||n.perform_action;if(e){const[o,i]=e.split(".",2);t.callService(o,i,n.service_data||n.data||{},n.target)}}else if("navigate"===s){const t=n.navigation_path;if(t){try{ot("selection")}catch(e){}window.history.pushState(null,"",t),e.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0}))}}else if("url"===s){const e=n.url_path;if(e){try{ot("selection")}catch(e){}window.open(e,"_blank")}}else if("assist"===s){try{ot("selection")}catch(e){}e.dispatchEvent(new CustomEvent("show-dialog",{bubbles:!0,composed:!0,detail:{dialogTag:"ha-voice-command-dialog",dialogImport:()=>customElements.get("ha-voice-command-dialog")?void 0:customElements.whenDefined("ha-voice-command-dialog"),dialogParams:{pipeline_id:n.pipeline_id,start_listening:n.start_listening}}}))}else if("fire-dom-event"===s){try{ot("selection")}catch(e){}e.dispatchEvent(new CustomEvent("ll-custom",{bubbles:!0,composed:!0,detail:n}))}}catch(e){console.warn("[SimplePowerFlow] Action execution failed:",e)}}class nt{constructor(e){this._lastTapTime=0,this._startX=0,this._startY=0,this._isHoldTriggered=!1,this._onAction=e}handlePointerDown(e,t){e.target?.closest?.(".node-badge-group")||"mouse"===e.pointerType&&0!==e.button||(this._startX=e.clientX,this._startY=e.clientY,this._isHoldTriggered=!1,this._currentNode=t,e.preventDefault(),clearTimeout(this._holdTimer),this._holdTimer=setTimeout(()=>{this._isHoldTriggered=!0,this._onAction(t,"hold")},500))}handlePointerMove(e){const t=e.clientX-this._startX,o=e.clientY-this._startY;Math.sqrt(t*t+o*o)>12&&clearTimeout(this._holdTimer)}handlePointerUp(e,t){if(clearTimeout(this._holdTimer),e.target?.closest?.(".node-badge-group"))return void this.handlePointerCancel();if(this._isHoldTriggered)return void(this._isHoldTriggered=!1);const o=e.clientX-this._startX,i=e.clientY-this._startY;if(Math.sqrt(o*o+i*i)>12)return;const a=Date.now(),n=this._lastTappedNodeId===t.id&&a-this._lastTapTime<350,r=Boolean(t.doubleTapAction&&"none"!==t.doubleTapAction.action);n&&r?(clearTimeout(this._tapTimer),this._lastTapTime=0,this._lastTappedNodeId=void 0,this._onAction(t,"double_tap")):(this._lastTapTime=a,this._lastTappedNodeId=t.id,r?(clearTimeout(this._tapTimer),this._tapTimer=setTimeout(()=>{this._onAction(t,"tap"),this._lastTapTime=0,this._lastTappedNodeId=void 0},260)):this._onAction(t,"tap"))}handlePointerCancel(){clearTimeout(this._holdTimer),clearTimeout(this._tapTimer),this._isHoldTriggered=!1,this._currentNode=void 0}}function rt(e){if(!e||"object"!=typeof e)return e;const t={...e,...e.badge||{},...e.label_chip||{},...e.actions||{}};return delete t.badge,delete t.label_chip,delete t.actions,t}function st(e){if(!e)return{};const t=rt(e);return{...t,badge:{badge_enabled:void 0!==t.badge_enabled?"boolean"==typeof t.badge_enabled?t.badge_enabled?"enabled":"disabled":t.badge_enabled:"auto",badge_style:t.badge_style,badge_position:t.badge_position,badge_size:t.badge_size,badge_color_on:t.badge_color_on,badge_color_off:t.badge_color_off,badge_pulse:t.badge_pulse,badge_quick_toggle:t.badge_quick_toggle,badge_tap_behavior:t.badge_tap_behavior},label_chip:{show_label:void 0!==t.show_label?"boolean"==typeof t.show_label?t.show_label?"enabled":"disabled":t.show_label:"auto",spacing_text_above_icon:t.spacing_text_above_icon,spacing_text_below_icon:t.spacing_text_below_icon,label_font_size:t.label_font_size??t.font_size_label,label_spacing_below_node:t.label_spacing_below_node??t.spacing_label_below_node,label_chip_enabled:void 0!==t.label_chip_enabled?"boolean"==typeof t.label_chip_enabled?t.label_chip_enabled?"enabled":"disabled":t.label_chip_enabled:"auto",label_chip_opacity:t.label_chip_opacity,label_chip_padding_x:t.label_chip_padding_x,label_chip_padding_y:t.label_chip_padding_y,label_border_radius:t.label_border_radius,label_border_width:t.label_border_width,label_color:t.label_color,label_color_mode:t.label_color_mode},actions:{tap_action:t.tap_action,hold_action:t.hold_action,double_tap_action:t.double_tap_action,tap_more_info_target:t.tap_more_info_target,hold_more_info_target:t.hold_more_info_target,double_tap_more_info_target:t.double_tap_more_info_target,tap_more_info_entity:t.tap_more_info_entity,hold_more_info_entity:t.hold_more_info_entity,double_tap_more_info_entity:t.double_tap_more_info_entity}}}function lt(e){if(!e)return{};const{badge:t,label_chip:o,actions:i,...a}=e;return{...a,...t||{},...o||{},...i||{}}}function dt(e,t){if(!e&&!t)return{};const o=e&&"object"==typeof e?e:{},i=t&&"object"==typeof t?t:{},a={...o,...o.node_dimensions||{},...o.shadows||{},...o.typography||{},...o.labels||{},...o.label_chip||{},...o.home_ring||{},...o.cables_and_bus||{},...o.wires||{},...o.particle_dynamics||{},...o.particles||{},...o.energy_mix||{},...o.bus_routing||{},...o.layout_spacing||{}};return void 0!==i.stroke_mode&&void 0===a.stroke_mode&&(a.stroke_mode=i.stroke_mode),void 0!==i.speed_mode&&void 0===a.speed_mode&&(a.speed_mode=i.speed_mode),void 0!==i.min_stroke&&void 0===a.min_stroke&&(a.min_stroke=i.min_stroke),void 0!==i.max_stroke&&void 0===a.max_stroke&&(a.max_stroke=i.max_stroke),void 0!==i.min_duration&&void 0===a.min_duration&&(a.min_duration=i.min_duration),void 0!==i.max_duration&&void 0===a.max_duration&&(a.max_duration=i.max_duration),void 0!==i.max_total_particles&&void 0===a.max_total_particles&&(a.max_total_particles=i.max_total_particles),void 0!==i.normalize_speed_by_length&&void 0===a.normalize_speed_by_length&&(a.normalize_speed_by_length=i.normalize_speed_by_length),delete a.node_dimensions,delete a.shadows,delete a.typography,delete a.labels,delete a.label_chip,delete a.home_ring,delete a.cables_and_bus,delete a.wires,delete a.particle_dynamics,delete a.particles,delete a.energy_mix,delete a.bus_routing,delete a.layout_spacing,"curved"===a.line_routing_mode?a.line_routing_mode="bezier_curved":"orthogonal"===a.line_routing_mode&&(a.line_routing_mode="orthogonal_bus"),"fixed"===a.home_glow_mode&&(a.home_glow_mode="custom"),a}function ct(e){const t=e||{};return{meteor_trail:{...ye.meteor_trail,...t.meteor_trail||{}},living_icons:{...ye.living_icons,...t.living_icons||{}},glassmorphism:{...ye.glassmorphism,...t.glassmorphism||{}},impact_ripples:{...ye.impact_ripples,...t.impact_ripples||{}},celestial_tracker:{...ye.celestial_tracker,...t.celestial_tracker||{}},self_sufficiency:{...ye.self_sufficiency,...t.self_sufficiency||{}}}}var _t={title:"Power Flow",solar:"Solar",grid:"Grid",battery:"Battery",home:"Home",production:"Production",consumption:"Consumption",import:"Import",export:"Export",charge:"Charge",discharge:"Discharge",inactive:"Inactive",active:"Active",unbalanced:"Unbalance",not_tracked:"Untracked"},pt={device_default_name:"Device",section:{general:"General",nodes:"Primary Nodes",solar:"Solar Node",grid:"Grid Power Node",battery:"Battery & Storage Node",home:"Home & Consumption Node",devices:"Individual Devices & Loads",styles:"Style, Dimensions & Typography",effects:"Visual Effects & Animations ✨",advanced:"Advanced & Calculation Engine",node_dimensions:"Node Radii & Dimensions",shadows:"Shadows & 3D Depth",typography:"Typography & Spacing",labels:"Node Labels & Chip/Tag Style",cables_and_bus:"Wire Geometry & Bus Routing",wires:"Wire Thickness & Zero-Flow Lines",particle_dynamics:"Particle Speed & Dynamics",particles:"Particle Rendering & Density",home_ring:"Home Multi-Color Mix Ring",meteor_trail:"Meteor Comet Particles (Meteor Trail)",living_icons:"Living & Animated Icons (Living Icons)",glassmorphism:"3D Glassmorphism & Neon Core",impact_ripples:"Impact Shockwaves (Impact Ripples)",celestial_tracker:"Solar & Lunar Celestial Tracker ☀️🌙",self_sufficiency:"Self-Sufficiency Hub (Central Node 🌿)",badge:"Status Badge & Switch Control",secondary_info:"Secondary Information",label_chip:"Label & Chip/Tag Background",actions:"Gestures & Tap Actions"},title:"Card Title",solar:"Solar Node",grid:"Grid Node",battery:"Battery Node",home:"Home Node",devices:"Individual Devices",add_device:"Add Device",remove_device:"Remove Device",move_up:"Move up",move_down:"Move down",device_name:"Device Name",device_icon:"Icon",device_color:"Color",id:"Unique Device ID",name:"Custom Name",icon:"Icon",color:"Primary Color",color_charge:"Charge Color",color_discharge:"Discharge Color",color_idle:"Idle Color (Standby)",use_idle_color:"Enable Dedicated Color for Idle Battery",entity:"Power Entity (Watts)",entity_import:"Grid Import Entity",entity_export:"Grid Export Entity",entity_charge:"Battery Charge Entity",entity_discharge:"Battery Discharge Entity",entity_in:"Input Entity (Legacy)",entity_out:"Output Entity (Legacy)",entity_amperage:"Current Entity (Amperes)",state_of_charge:"State of Charge Entity (SoC %)",switch_entity:"Switch / Control Entity",invert:"Invert Sign Convention (+/-)",include_in_home:"Include in Home Total",display_zero:"Show Zero-Flow Line",display_zero_tolerance:"Zero-Flow Tolerance (W)",show_label:"Show Name / Label",stroke_mode:"Line Thickness Mode",speed_mode:"Particle Speed Mode",layout_mode:"Visual Layout Mode",auto_layout_breakpoint:"Mobile Layout Threshold (Breakpoint px)",min_duration:"Minimum Particle Duration (s)",max_duration:"Maximum Particle Duration (s)",normalize_speed_by_length:"Normalize Speed by Wire Length",min_stroke:"Minimum Line Width (px)",max_stroke:"Maximum Line Width (px)",scale_min:"Scale Minimum Power (W)",scale_max:"Scale Maximum Power (W)",scale_curve:"Power Scaling Curve",smoothing_factor:"Smoothing Factor (EMA)",max_total_particles:"Max Active Particles on Screen",decimals:"Number of Decimal Places",w_to_kw_threshold:"Threshold from Watts to kW",residual_handling:"Energy Balance Residual Handling",residual_absorb_target:"Residual Absorb Target",node_radius_primary:"Primary Node Radius (px)",node_radius_secondary:"Secondary Node Radius (px)",node_radius_tertiary:"Tertiary Sub-Device Node Radius (px)",node_border_width:"Circle Border Width (px)",sub_device_border_width:"Sub-Device Border Width (px)",icon_size_primary:"Primary Icon Size (px)",icon_size_secondary:"Secondary Icon Size (px)",icon_size_tertiary:"Tertiary Sub-Device Icon Size (px)",spacing_text_above_icon:"Space Above Icon (px)",spacing_text_below_icon:"Space Below Icon (px)",spacing_horizontal:"Grid Horizontal Spacing (px)",spacing_vertical:"Grid Vertical Spacing (px)",sub_device_spacing_x:"Sub-Devices Horizontal Spacing (px)",sub_device_spacing_y:"Sub-Devices Vertical Spacing (px)",sub_devices_section:"Nested Sub-Devices",add_sub_device:"Add Sub-Device",edit_sub_device:"Edit Sub-Device",no_sub_devices:"No nested sub-devices attached to this node.",sub_device_default_name:"Sub-Device",include_in_parent:"Include in Parent Device",distance_x:"Horizontal Distance (Offset X)",distance_y:"Vertical Distance (Offset Y)",sub_device_radius:"Sub-Device Radius (px)",sub_device_icon_size:"Sub-Device Icon Size (px)",cancel:"Cancel",save:"Save",font_size_primary:"Primary Value Font Size (px)",font_size_secondary:"Secondary Value Font Size (px)",font_size_unit:"Unit Font Size W/kW/A (px)",font_size_extra:"Directional Flow Font Size (px)",font_size_sub:"Subtext & Secondary Info Font Size (px)",font_size_value:"Power Value Font Size (px)",font_size_label:"Node Label Font Size (px)",font_size_directional:"Directional Flow Font Size (px)",font_size_top_info:"Top Info Font Size SoC/Amperes (px)",font_size_tertiary:"Tertiary Sub-Device Font Size (px)",label_font_size:"Node Label Font Size (px)",label_spacing_below_node:"Label Gap Below Node (px)",spacing_label_below_node:"Label Gap Below Circle (px)",mode:"Visual Mode",anchor:"Anchor Node",weather_entity:"Weather Entity",show_markers:"Show Sunrise/Sunset Markers",show_marker_icons:"Show Marker Icons",sunrise_icon:"Sunrise Icon",sunset_icon:"Sunset Icon",show_rays:"Show Sun Rays",show_tail:"Show Orbit Tail",show_stars:"Show Night Stars",night_node_mode:"Night Node Appearance",scope:"Calculation Scope",label_style:"Percentage Label Style",radius:"Element Radius (px)",show_ring:"Show Progress Ring",ring_width:"Ring Thickness (px)",show_glow:"Show Neon Glow",custom_label:"Custom Label",custom_icon:"Custom Icon",entity_solar_energy:"Solar Energy Sensor (kWh)",entity_battery_energy_discharge:"Battery Discharged Energy Sensor (kWh)",entity_grid_energy_import:"Grid Import Energy Sensor (kWh)",entity_home_energy:"Home Total Energy Sensor (kWh)",entity_self_sufficiency:"Direct Self-Sufficiency Sensor (%)",show_labels:"Show Global Labels",label_chip_enabled:"Enable Chip / Tag Style Background",label_chip_opacity:"Chip Background Opacity",label_chip_padding_x:"Chip Horizontal Padding (px)",label_chip_padding_y:"Chip Vertical Padding (px)",label_border_radius:"Chip Border Radius (px)",label_border_width:"Chip Border Width (px)",label_color_mode:"Label Text Color Mode",label_color:"Custom Label Text Color",line_routing_mode:"Device Path Routing Mode",bus_lane_spacing:"Parallel Bus Lane Spacing (px)",bus_corner_radius:"90° Bus Corner Radius (px)",invert_bus_lane_order:"Invert Bus Lane Order",particles_per_arc:"Particles per Active Line",particle_size_offset:"Particle Extra Radius (px)",particle_inner_glow:"White Bright Core (Inner Glow)",particle_soft_edge:"Soft Radial Blurred Edge",inactive_wire_opacity:"Zero-Flow Wire Opacity",inactive_wire_style:"Zero-Flow Line Style",hover_glow_radius:"Hover Glow Radius (px)",show_node_shadows:"Enable Node Shadows",node_shadow_color:"Custom Shadow Color",node_shadow_blur:"Node Shadow Blur (px)",node_shadow_spread:"Node Shadow Spread (px)",node_shadow_opacity:"Node Shadow Opacity",node_shadow_offset_y:"Node Shadow Vertical Offset (px)",show_home_mix_ring:"Show Multi-Color Home Mix Ring",home_glow_mode:"Home Hover Glow Color",enabled:"Enable Effect",tail_length:"Comet Tail Length",glow_intensity:"Tail Glow Intensity",battery_type:"Battery Visual Style",battery_animated:"Continuous Wave Animation",load_animation:"Load Icon Animation",intensity:"Glass Reflection Intensity (%)",neon_core:"Concentric Inner Glowing Ring (Neon Core)",ripple_size:"Shockwave Size (px)",ripple_color:"Custom Shockwave Color",meteor_trail_enabled:"Enable Meteor Comet Trails",meteor_trail_tail_length:"Tail Length (Normalized)",meteor_trail_glow_intensity:"Tail Glow Intensity",living_icons_enabled:"Enable Living Icons & Battery Wave",living_icons_battery_type:"Battery Visual Style",living_icons_battery_animated:"Continuous Battery Wave Animation",living_icons_load_animation:"Active Load Icon Animation",glassmorphism_enabled:"Enable 3D Glassmorphism & Neon Ring",glassmorphism_intensity:"Glass Glare Intensity (%)",glassmorphism_neon_core:"Inner Glowing Ring (Neon Core)",impact_ripples_enabled:"Enable Arrival Shockwave Ripples",impact_ripples_size:"Shockwave Size (px)",impact_ripples_color:"Custom Shockwave Color",badge_enabled:"Show Status Notification Badge",badge_style:"Badge Visual Style",badge_position:"Badge Anchor Position",badge_size:"Badge Size (px)",badge_color_on:"Active State Color (ON)",badge_color_off:"Inactive State Color (OFF)",badge_pulse:"Pulse Animation when Active",badge_quick_toggle:"Quick Tap to Toggle Switch",badge_tap_behavior:"Badge Tap Behavior",secondary_info_entity:"Secondary Info Entity",secondary_info_unit:"Custom Unit",secondary_info_decimals:"Number of Decimals",secondary_info_template:"Formatting Template",unit:"Custom Unit of Measurement",glow_color:"Custom Aura Glow Color",tap_action:"Single Tap Action",hold_action:"Hold Action",double_tap_action:"Double Tap Action",tap_more_info_target:"More Info Target (Tap)",hold_more_info_target:"More Info Target (Hold)",double_tap_more_info_target:"More Info Target (Double Tap)",tap_more_info_entity:"Custom Third-Party Entity (Tap)",hold_more_info_entity:"Custom Third-Party Entity (Hold)",double_tap_more_info_entity:"Custom Third-Party Entity (Double Tap)",helper:{label_font_size:"Font size in pixels for node labels (default: 10px).",label_spacing_below_node:"Vertical distance in pixels between the node circle and the label/chip (default: 14px).",enabled:"Enable or disable this visual feature.",mode:"Select rendering mode for this element.",anchor:"Select which primary node to anchor the celestial orb orbit trajectory to.",scope:"Choose the time interval to calculate self-sufficiency over (Today or Total).",label_style:"Display format for the descriptive text under the percentage.",radius:"Radius of the circular element in pixels.",show_ring:"Show the donut progress ring.",ring_width:"Thickness of the donut ring track in pixels.",show_glow:"Enable the ambient pulsing aura glow.",custom_label:"Custom label text to display.",custom_icon:"Custom MDI icon to display.",tap_action:"Action to perform when the node is tapped.",hold_action:"Action to perform when the node is held.",double_tap_action:"Action to perform when the node is double tapped.",tap_more_info_target:"Target entity for the More Info dialog.",tap_more_info_entity:"Custom entity to open upon tapping.",hold_more_info_target:"Target entity for the More Info dialog on hold.",hold_more_info_entity:"Custom entity to open upon holding.",double_tap_more_info_target:"Target entity for the More Info dialog on double tap.",double_tap_more_info_entity:"Custom entity to open upon double tapping.",node_shadow_offset_y:"Vertical offset of the node drop-shadow in pixels.",title:"Custom title displayed in the card header.",layout_mode:"Choose visual layout: 'Auto' adapts to screen width, 'Horizontal' lines up nodes, 'Vertical' arranges in two compact columns.",stroke_mode:"Determines whether flow line thickness scales based on Power (Watts), Current (Amperes), or stays fixed.",speed_mode:"Particle animation speed can scale with absolute power in Watts or relative percentage of total flow.",auto_layout_breakpoint:"Card width in pixels below which the responsive vertical layout activates (default: 520px).",id:"Unique internal identifier for the device load (alphanumeric, dash, or underscore).",name:"Custom display name shown below the node circle.",icon:"Material Design icon rendered inside the circle (e.g. mdi:solar-power, mdi:heat-pump).",entity:"Primary power sensor entity in Watts or kW for this node.",entity_import:"Sensor for power imported from the grid (positive Watts).",entity_export:"Sensor for power exported to the grid (positive Watts).",entity_charge:"Sensor for power absorbed by the battery during charging (positive Watts).",entity_discharge:"Sensor for power supplied by the battery during discharging (positive Watts).",state_of_charge:"Battery State of Charge sensor (SoC 0% to 100%).",entity_amperage:"Optional current sensor in Amperes shown above the center icon.",color:"Primary color for node circle, glowing particles, and attached flow lines.",color_charge:"Line and particle color during battery charging.",color_discharge:"Line and particle color during battery discharging.",use_idle_color:"Apply a dedicated color when the battery is in standby at 0 W.",color_idle:"Color applied to the battery node circle when idle (0 W).",invert:"Invert sign convention: turns positive numbers to negative and vice versa.",switch_entity:"Switch/light/relay entity associated with the node for toggle control.",include_in_home:"When disabled, this device's consumption is excluded from the calculated Home total.",display_zero:"Keep the connection line visible even when flow power is zero.",display_zero_tolerance:"Threshold in Watts below which power flow is considered zero.",show_label:"Show or hide the text label below the node circle.",node_radius_primary:"Radius in pixels for primary circles (Solar, Grid, Battery, Home; default: 36px).",node_radius_secondary:"Radius in pixels for secondary device circles (default: 28px).",node_radius_tertiary:"Standard radius in pixels for all tertiary sub-device circles (default: 21px).",icon_size_primary:"Icon size in pixels for primary nodes (default: 18px).",icon_size_secondary:"Icon size in pixels for secondary devices (default: 16px).",icon_size_tertiary:"Standard icon size in pixels for tertiary sub-devices (default: 13px).",node_border_width:"Outer circle border stroke width in pixels (default: 2.5px).",sub_device_border_width:"Border stroke width for tertiary sub-devices in pixels (default: 2.0px).",sub_device_spacing_x:"Default horizontal spacing between parent node and sub-devices (default: 75px).",sub_device_spacing_y:"Default vertical spacing between parent node and sub-devices (default: 32px).",include_in_parent:"When enabled, this sub-device's power is part of the parent device load (or contributes to its rollup if the parent has no own entity).",distance_x:"Custom relative horizontal offset from parent node in pixels.",distance_y:"Custom relative vertical offset from parent node in pixels.",sub_device_radius:"Radius of the sub-device circle in pixels (default: 21px).",sub_device_icon_size:"Size of the sub-device icon in pixels (default: 13px).",show_node_shadows:"Apply a soft drop shadow beneath node circles for 3D depth.",node_shadow_color:"Custom shadow color for node circles (leave blank for standard dark shadow).",node_shadow_blur:"Shadow blur radius in pixels (default: 10px).",node_shadow_spread:"Shadow spread expansion in pixels.",font_size_primary:"Power value font size for primary nodes (default: 10px).",font_size_secondary:"Power value font size for secondary devices (default: 9px).",font_size_unit:"Font size for measurement units W/kW/A (default: 8px).",font_size_extra:"Font size for directional arrows and dual charge/import text (default: 8.5px).",font_size_sub:"Font size for untracked consumption and secondary information (default: 9px).",font_size_label:"Font size for node description labels (default: 10px).",font_size_top_info:"Font size for SoC % and Amperage text above the icon (default: 8px).",spacing_label_below_node:"Vertical distance between the node circle and its label (default: 14px).",show_labels:"Globally show or hide labels for all nodes on the card.",label_chip_enabled:"Render a rounded chip/tag background around the label text.",label_chip_opacity:"Chip background opacity tinted with the node color (0.05 to 1.0; default: 0.18).",label_chip_padding_x:"Horizontal internal padding in pixels for the chip (default: 8px).",label_chip_padding_y:"Vertical internal padding in pixels for the chip (default: 3.5px).",label_border_radius:"Corner radius for the rounded chip box (default: 6px).",label_border_width:"Outer stroke border width of the chip (default: 1px).",label_color_mode:"Auto contrast dynamically selects pure white or dark black for guaranteed legibility.",label_color:"Specific text color when label color mode is set to 'Custom'.",inactive_wire_opacity:"Opacity of flow wires when zero energy is transferring (default: 0.35).",inactive_wire_style:"Choose whether zero-flow lines are dashed, solid, or completely hidden.",hover_glow_radius:"Radius of radiant glow halo when hovering a node (default: 10px).",show_home_mix_ring:"Show a multi-color ring around Home with segments proportional to Solar, Grid, and Battery.",home_glow_mode:"On hover, illuminate Home with the predominant power source color or fixed Home color.",line_routing_mode:"Direct Bezier curved arcs or an orthogonal central bus channel for multiple device loads.",bus_lane_spacing:"Distance between parallel load lanes in the central bus channel (default: 8px).",bus_corner_radius:"Corner radius for 90° smooth bends in the central bus channel (default: 20px).",invert_bus_lane_order:"Inverts the order of load lanes in the central channel (innermost vs outermost).",particles_per_arc:"Number of light particles flowing along each active wire (default: 3).",particle_size_offset:"Extra radius offset added to light particles (default: 1.8px).",particle_inner_glow:"Adds a bright white high-density core to each particle.",particle_soft_edge:"Applies a soft blurred radial falloff to particle edges for realistic lighting.",spacing_horizontal:"Horizontal pixel spacing between node columns (default: 120px).",spacing_vertical:"Vertical pixel spacing between node rows (default: 85px).",spacing_text_above_icon:"Gap in pixels between top text (SoC/Amps) and the center icon (default: 4px).",spacing_text_below_icon:"Gap in pixels between center icon and the power value (default: 4px).",meteor_trail:"Luminescent comet tail trailing behind flowing particles.",tail_length:"Length of the comet tail along the wire path (0.02 to 0.25).",glow_intensity:"Glow brightness intensity and thickness multiplier for the comet tail.",living_icons:"Living animations for device icons and dynamic battery visuals (liquid waves or gradient).",battery_type:"Battery visual style: 'Gradient' (radial energy glow) or 'Liquid' (animated wave clipped to circle).",battery_animated:"Maintains continuous liquid wave oscillation in the battery circle.",load_animation:"Animation applied to active device icons (spinning rotation or energy pulse).",glassmorphism:"3D convex glass lens glare filter and glowing Neon Core ring.",intensity:"Intensity percentage of glass glare reflections and neon luminescence.",neon_core:"Shows a concentric glowing inner Neon Core ring inside the node circle.",impact_ripples:"Circular shockwave ripples that expand when a particle arrives at its destination node.",ripple_size:"Maximum expansion radius of the shockwave ripple in pixels (default: 18px).",ripple_color:"Custom shockwave ripple color (leave blank to match arriving particle color).",celestial_tracker:"Real-time tracking of Sun and Moon positions along a 24-hour dial or 180° arc.",self_sufficiency:"Displays a central circular node at the intersection of the 4 primary nodes showing cumulative energy self-sufficiency percentage with a proportional donut ring.",self_sufficiency_scope:"Calculate cumulative self-sufficiency percentage based on today's energy data (Today) or all-time lifetime data (Total).",self_sufficiency_label_style:"Choose what to display under the percentage: scope indicator (TODAY/TOTAL), text 'AUTOSUFF.', MDI icon or clean percentage number.",self_sufficiency_radius:"Radius of the central hub node in pixels (default: 22px).",self_sufficiency_ring_width:"Donut ring stroke width in pixels (default: 3.2px).",self_sufficiency_show_glow:"Enables a glowing aura around the hub (green when >= 90%, amber when < 50%).",glow_color:"Custom color for the pulsing aura glow around the central hub node (leave blank for dynamic calculation based on percentage).",entity_solar_energy:"Sensor tracking solar energy production/consumption in kWh (e.g. sensor.solar_energy_today).",entity_battery_energy_discharge:"Sensor tracking battery discharge energy to home in kWh (e.g. sensor.battery_discharged_today).",entity_grid_energy_import:"Sensor tracking grid import energy to home in kWh (e.g. sensor.grid_energy_imported_today).",entity_home_energy:"Optional: sensor tracking total home consumption in kWh.",entity_self_sufficiency:"Optional: direct percentage sensor for self-sufficiency provided by your inverter.",weather_entity:"Optional weather entity to adapt celestial orb tint, rays and badges (e.g. weather.home).",show_markers:"Show sunrise and sunset graphical badges and time labels on the dial.",show_marker_icons:"Display MDI icons beside sunrise and sunset time labels.",sunrise_icon:"Custom icon for sunrise (default: mdi:weather-sunset-up).",sunset_icon:"Custom icon for sunset (default: mdi:weather-sunset-down).",show_rays:"Enable GPU-accelerated rotating sun rays around the solar orb.",show_tail:"Draw a progressive luminous trail along the traveled celestial path.",show_stars:"Display animated twinkling vector stars distributed along the night sky arc.",night_node_mode:"Transform solar node icon to moon (🌙) when night and 0W production (if not custom).",badge_enabled:"Shows a circular badge on the node corner indicating switch state (ON/OFF) or status.",badge_style:"Badge style: minimal circular LED dot, mini-power icon, or 'ON'/'OFF' text.",badge_position:"Corner anchor position of the badge around the node circle.",badge_size:"Diameter of the notification badge in pixels (default: 10px).",badge_color_on:"Badge color when the device is turned ON or active.",badge_color_off:"Badge color when the device is turned OFF or inactive.",badge_pulse:"Enables continuous energetic pulsing on the badge while active.",badge_quick_toggle:"Enables tapping the badge directly to quickly toggle the switch ON or OFF.",badge_tap_behavior:"Behavior when tapping the status badge.",secondary_info:"Displays supplementary text below the node (e.g. temperature, voltage, daily energy).",unit:"Custom unit of measurement appended to the secondary information value.",decimals:"Number of decimal places shown for power values (default: 2).",w_to_kw_threshold:"Threshold in Watts above which power is automatically formatted in kW (default: 1000 W).",scale_curve:"Mathematical curve used to map Watts to wire thickness and speed: 'Square root' provides the best dynamic range.",scale_min:"Power level below which speed and thickness remain at minimum (default: 50 W).",scale_max:"Power level at which wire thickness and particle speed reach maximum (default: 6000 W).",smoothing_factor:"Exponential moving average (EMA) factor: lower values produce smoother transitions (default: 0.35).",max_total_particles:"Maximum particles active on screen simultaneously to maintain 60 FPS performance (default: 30).",min_stroke:"Minimum flow wire stroke width in pixels (default: 2.0px).",max_stroke:"Maximum flow wire stroke width at full load in pixels (default: 7.0px).",min_duration:"Minimum travel time in seconds for particles at peak power (faster; default: 0.8s).",max_duration:"Maximum travel time in seconds for particles at minimum power (slower; default: 5.5s).",normalize_speed_by_length:"When enabled, normalizes physical particle speed in pixels per second based on the wire path length, preventing particles from flying faster across longer lines.",residual_handling:"Method for balancing mathematical discrepancies: 'Clamp' balances on the primary arc, 'Absorb' routes to grid/battery, 'Unbalanced' displays residual.",residual_absorb_target:"Designated node to absorb residual balance discrepancies when set to 'Absorb'."},option:{override:{auto:"Default (Global)",enabled:"Enabled (Force On)",disabled:"Disabled (Force Off)"},self_sufficiency_scope:{today:"Daily (Today)",total:"Historical (Total)"},self_sufficiency_label_style:{scope:"Time Scope (TODAY / TOTAL)",text:"Text 'AUTOSUFF.'",icon:"Custom MDI Icon",none:"Percentage Only (No label)"},layout_mode:{auto:"Automatic (Adaptive to screen width)",horizontal:"Horizontal (Linear grid)",vertical:"Vertical (Compact 2-Column)"},stroke_mode:{watt:"Dynamic by Power (Watts)",fixed:"Uniform Fixed Width",ampere:"Dynamic by Current (Amperes)"},speed_mode:{absolute:"Absolute Speed (Actual Watts)",relative:"Relative Speed (% of total power)"},scale_curve:{sqrt:"Square Root (Sqrt - Recommended for visual dynamics)",linear:"Linear Proportional",log:"Logarithmic (Wide dynamic range)"},residual_handling:{clamp:"Clamp (Zero balance on primary arc)",absorb:"Absorb (Route to designated target)",unbalanced:"Unbalance (Display residual difference)"},residual_absorb_target:{grid:"Electrical Grid (Grid)",battery:"Battery Storage (Battery)"},badge_style:{dot:"Minimal Circular LED Dot",icon:"Mini Power Icon (ON / OFF)",text:"Micro-Tag (ON / OFF)"},badge_position:{top_right:"Top Right (Top-Right)",top_left:"Top Left (Top-Left)",bottom_right:"Bottom Right (Bottom-Right)",bottom_left:"Bottom Left (Bottom-Left)"},badge_tap_behavior:{auto:"Automatic (Detects switch or sensor)",toggle:"Toggle Switch State (ON / OFF)","more-info-switch":"Open Switch Control Dialog","more-info-sensor":"Open Power Sensor History Dialog","more-info":"Open General Details Dialog"},more_info_target:{auto:"Automatic (Battery: SoC on Long Press, otherwise Switch/Sensor)",soc:"Battery State of Charge (SoC %)",sensor:"Main Power Sensor (W/kW)",secondary:"Secondary Sensor (Secondary Info)",amperage:"Current Sensor (Amperage)",switch:"Switch / Control Entity",custom:"Custom Third-Party Entity (Selector)"},label_color_mode:{auto_contrast:"Optimal Smart Contrast (Auto B/W)",white:"Pure White (#ffffff)",black:"Dark Black (#0f172a)",match_entity:"Match Entity Color",secondary:"Standard Secondary Grey",custom:"Custom Color"},battery_type:{gradient:"Dynamic Radial Gradient (Energy Glow)",liquid:"Animated Liquid Water Level (Liquid Wave)"},load_animation:{rotate:"Continuous Rotation (Fan / Motor)",pulse:"Energy Pulse / Breathing",none:"None (Static Icons)"},line_routing_mode:{bezier_curved:"Direct Curved Arcs (Bezier)",orthogonal_bus:"Central Bus Channel (Smooth Orthogonal)"},inactive_wire_style:{dashed:"Dashed Line",solid:"Solid Line",hidden:"Completely Hidden"},home_glow_mode:{predominant:"Dynamic (Predominant active source color)",custom:"Fixed (Default Home color)"},celestial_mode:{dial_24h:"24-Hour Circular Dial 360° (Day & Night)",semicircle:"180° Semi-circle Arc (Upper Dome)"},celestial_anchor:{home:"Around Home Node",solar:"Around Solar Node (Recommended)"}},error:{invalid_range:"Invalid range: minimum value must be strictly less than maximum value.",duplicate_id:"Device ID must be unique.",invalid_id:"ID must start with a letter and contain only alphanumeric characters, dashes, or underscores.",reserved_id:"This ID is reserved by the system.",missing_entity:"At least one valid power entity is required."}},ut={missing_entity:"At least one valid power entity is required.",invalid_range:"Invalid range: minimum value must be strictly less than maximum value."},ht={self_sufficiency:{scope_today:"TODAY",scope_total:"TOTAL",default_label:"SELF-SUFF."}},mt={card:_t,editor:pt,errors:ut,effects:ht},ft={title:"Flusso Energetico",solar:"Solare",grid:"Rete",battery:"Batteria",home:"Casa",production:"Produzione",consumption:"Consumo",import:"Prelevata",export:"Immessa",charge:"Carica",discharge:"Scarica",inactive:"Inattivo",active:"Attivo",unbalanced:"Sbilanciamento",not_tracked:"Altri Consumi"},gt={device_default_name:"Dispositivo",section:{general:"Generale",nodes:"Nodi Principali",solar:"Nodo Solare",grid:"Nodo Rete Elettrica",battery:"Nodo Batteria & Accumulo",home:"Nodo Casa & Fabbisogno",devices:"Carichi Individuali & Dispositivi",styles:"Stile, Dimensioni & Tipografia",effects:"Effetti Visivi & Animazioni ✨",advanced:"Avanzate & Motore di Calcolo",node_dimensions:"Dimensioni Nodi & Cerchi",shadows:"Ombreggiatura & Profondità 3D",typography:"Tipografia & Spaziature Interne",labels:"Etichette Nodi & Stile Chip/Tag",cables_and_bus:"Geometria Cavi & Routing Bus",wires:"Spessore Cavi & Linee a Flusso Zero",particle_dynamics:"Dinamica & Velocità Particelle",particles:"Resa & Densità Particelle",home_ring:"Anello Multi-Colore Casa",meteor_trail:"Particelle a Cometa (Meteor Trail)",living_icons:"Icone Vive & Dinamiche (Living Icons)",glassmorphism:"Effetto Vetro 3D & Neon Core",impact_ripples:"Micro-Onde d'Urto (Impact Ripples)",celestial_tracker:"Tracciatore Solare & Lunare ☀️🌙",self_sufficiency:"Autosufficienza Energetica (Nodo Centrale 🌿)",badge:"Badge di Stato & Controllo Switch",secondary_info:"Informazioni Secondarie",label_chip:"Etichetta & Sfondo Chip/Tag",actions:"Gesti & Azioni Tocco"},title:"Titolo Card",solar:"Nodo Solare",grid:"Nodo Rete",battery:"Nodo Batteria",home:"Nodo Casa",devices:"Carichi Individuali",add_device:"Aggiungi Dispositivo",remove_device:"Rimuovi Dispositivo",move_up:"Sposta su",move_down:"Sposta giù",device_name:"Nome Dispositivo",device_icon:"Icona",device_color:"Colore",id:"Identificativo ID Dispositivo",name:"Nome Personalizzato",icon:"Icona",color:"Colore Principale",color_charge:"Colore Carica",color_discharge:"Colore Scarica",color_idle:"Colore a Riposo (Standby)",use_idle_color:"Attiva Colore Dedicato per Batteria Inattiva",entity:"Entità Potenza (Watt)",entity_import:"Entità Prelievo (Import)",entity_export:"Entità Immissione (Export)",entity_charge:"Entità Carica",entity_discharge:"Entità Scarica",entity_in:"Entità Ingresso (Legacy)",entity_out:"Entità Uscita (Legacy)",entity_amperage:"Entità Corrente (Ampere)",state_of_charge:"Entità Stato di Carica (SoC %)",switch_entity:"Entità Switch / Controllo Accensione",invert:"Inverti Convenzione Segno (+/-)",include_in_home:"Includi nel Totale Casa",display_zero:"Mostra Linea a Flusso Zero",display_zero_tolerance:"Tolleranza Flusso Zero (W)",show_label:"Mostra Nome / Etichetta",stroke_mode:"Modalità Spessore Linea",speed_mode:"Modalità Velocità Particelle",layout_mode:"Modalità Layout Visivo",auto_layout_breakpoint:"Soglia Passaggio Layout Mobile (Breakpoint px)",min_duration:"Durata Minima Particelle (s)",max_duration:"Durata Massima Particelle (s)",normalize_speed_by_length:"Uniforma Velocità in base alla Lunghezza del Cavo",min_stroke:"Spessore Minimo Linea (px)",max_stroke:"Spessore Massimo Linea (px)",scale_min:"Valore Minimo Scala Potenza (W)",scale_max:"Valore Massimo Scala Potenza (W)",scale_curve:"Curva di Scala Potenza",smoothing_factor:"Fattore di Smoothing (EMA)",max_total_particles:"Max Particelle Totali a Schermo",decimals:"Numero di Cifre Decimali",w_to_kw_threshold:"Soglia Passaggio da Watt a kW",residual_handling:"Gestione Residuo Bilancio Energetico",residual_absorb_target:"Target Assorbimento Residuo",node_radius_primary:"Raggio Nodi Primari (px)",node_radius_secondary:"Raggio Nodi Secondari (px)",node_radius_tertiary:"Raggio Nodi Terziari Sub-Devices (px)",node_border_width:"Spessore Bordo Cerchi (px)",sub_device_border_width:"Spessore Bordo Sub-Device (px)",icon_size_primary:"Dimensione Icone Primarie (px)",icon_size_secondary:"Dimensione Icone Secondarie (px)",icon_size_tertiary:"Dimensione Icone Terziarie Sub-Devices (px)",spacing_text_above_icon:"Spazio Testo Sopra Icona (px)",spacing_text_below_icon:"Spazio Testo Sotto Icona (px)",spacing_horizontal:"Spaziatura Orizzontale Griglia (px)",spacing_vertical:"Spaziatura Verticale Griglia (px)",sub_device_spacing_x:"Spaziatura Orizzontale Sub-Devices (px)",sub_device_spacing_y:"Spaziatura Verticale Sub-Devices (px)",sub_devices_section:"Dispositivi Secondari Nidificati (Sub-Devices)",add_sub_device:"Aggiungi Sub-Device",edit_sub_device:"Modifica Sub-Device",no_sub_devices:"Nessun dispositivo secondario nidificato collegato a questo nodo.",sub_device_default_name:"Sub-Device",include_in_parent:"Includi nel Dispositivo Padre",distance_x:"Distanza Orizzontale (Offset X)",distance_y:"Distanza Verticale (Offset Y)",sub_device_radius:"Raggio Sub-Device (px)",sub_device_icon_size:"Dimensione Icona Sub-Device (px)",cancel:"Annulla",save:"Salva",font_size_primary:"Font Valore Nodi Primari (px)",font_size_secondary:"Font Valore Dispositivi Secondari (px)",font_size_unit:"Font Unità di Misura W/kW/A (px)",font_size_extra:"Font Frecce Direzionali Extra (px)",font_size_sub:"Font Sotto-testi e Info Secondarie (px)",font_size_value:"Font Valori Potenza (px)",font_size_label:"Font Etichette Nodi (px)",font_size_directional:"Font Frecce Direzionali (px)",font_size_top_info:"Font Info Superiori SoC/Ampere (px)",font_size_tertiary:"Font Sub-Devices Terziari (px)",label_font_size:"Dimensione Font Etichetta (px)",label_spacing_below_node:"Distanza Etichetta Sotto il Nodo (px)",spacing_label_below_node:"Distanza Etichetta dal Cerchio (px)",mode:"Modalità Visiva",anchor:"Nodo di Ancoraggio",weather_entity:"Entità Meteo",show_markers:"Mostra Indicatori Alba/Tramonto",show_marker_icons:"Mostra Icone Indicatori",sunrise_icon:"Icona Alba",sunset_icon:"Icona Tramonto",show_rays:"Mostra Raggi Solari",show_tail:"Mostra Scia Orbitale",show_stars:"Mostra Stelle Notturne",night_node_mode:"Aspetto Nodo Solare di Notte",scope:"Intervallo Temporale di Calcolo",label_style:"Stile Etichetta Percentuale",radius:"Raggio Elemento (px)",show_ring:"Mostra Anello di Progresso",ring_width:"Spessore Anello (px)",show_glow:"Mostra Bagliore Neon",custom_label:"Etichetta Personalizzata",custom_icon:"Icona Personalizzata",entity_solar_energy:"Sensore Energia Solare Prodotta (kWh)",entity_battery_energy_discharge:"Sensore Energia Batteria Scaricata (kWh)",entity_grid_energy_import:"Sensore Energia Rete Prelevata (kWh)",entity_home_energy:"Sensore Energia Totale Consumo Casa (kWh)",entity_self_sufficiency:"Sensore Diretto Autosufficienza (%)",show_labels:"Mostra Etichette Globali",label_chip_enabled:"Attiva Sfondo Stile Chip / Tag",label_chip_opacity:"Opacità Sfondo Chip",label_chip_padding_x:"Padding Orizzontale Chip (px)",label_chip_padding_y:"Padding Verticale Chip (px)",label_border_radius:"Raggio Bordo Arrotondato Chip (px)",label_border_width:"Spessore Bordo Chip (px)",label_color_mode:"Modalità Colore Testo Etichetta",label_color:"Colore Testo Etichetta Personalizzato",line_routing_mode:"Modalità Percorso Linee Dispositivi",bus_lane_spacing:"Spaziatura Corsie Parallele Bus (px)",bus_corner_radius:"Raggio Raccordo Curva Bus 90° (px)",invert_bus_lane_order:"Inverti Ordine Corsie Bus",particles_per_arc:"Particelle per Linea Attiva",particle_size_offset:"Dimensione Extra Particella Luminosa (px)",particle_inner_glow:"Bagliore Bianco Interno Particelle (Inner Glow)",particle_soft_edge:"Bordo Sfumato / Morbido Particelle",inactive_wire_opacity:"Opacità Linee a Flusso Zero",inactive_wire_style:"Stile Linea a Flusso Zero",hover_glow_radius:"Raggio Bagliore all'Hover (px)",show_node_shadows:"Attiva Ombreggiatura sui Cerchi",node_shadow_color:"Colore Ombra Personalizzato",node_shadow_blur:"Sfocatura Ombra Cerchi (px)",node_shadow_spread:"Espansione Ombra Cerchi (px)",node_shadow_opacity:"Opacità Ombra Cerchi",node_shadow_offset_y:"Offset Verticale Ombra (px)",show_home_mix_ring:"Mostra Anello Multi-Colore Quote Casa",home_glow_mode:"Colore Bagliore all'Hover sulla Casa",enabled:"Abilita Effetto",tail_length:"Lunghezza Coda a Cometa",glow_intensity:"Intensità Bagliore Coda",battery_type:"Stile Visivo Batteria",battery_animated:"Animazione Onde Continua",load_animation:"Animazione Icone Carichi",intensity:"Intensità Riflesso Vetro (%)",neon_core:"Anello Concentrico Neon Interno (Neon Core)",ripple_size:"Dimensione Espansione Onda (px)",ripple_color:"Colore Onda d'Urto Personalizzato",meteor_trail_enabled:"Attiva Coda Luminescente a Cometa",meteor_trail_tail_length:"Lunghezza Coda (Normalizzata)",meteor_trail_glow_intensity:"Intensità Bagliore Coda",living_icons_enabled:"Attiva Icone Vive & Livello Batteria",living_icons_battery_type:"Stile Visualizzazione Batteria",living_icons_battery_animated:"Animazione Continua Batteria (Onde)",living_icons_load_animation:"Animazione Icone Carichi Attivi",glassmorphism_enabled:"Attiva Riflesso Vetro Bombato & Neon Ring",glassmorphism_intensity:"Intensità Riflesso Vetro (%)",glassmorphism_neon_core:"Anello Concentrico Interno Neon (Neon Core)",impact_ripples_enabled:"Attiva Onde d'Urto all'Arrivo Particelle",impact_ripples_size:"Dimensione Espansione Onda (px)",impact_ripples_color:"Colore Onda d'Urto Personalizzato",badge_enabled:"Mostra Badge di Stato Notifica",badge_style:"Stile Visivo Badge",badge_position:"Posizione Ancoraggio Badge",badge_size:"Dimensione Badge (px)",badge_color_on:"Colore Stato Acceso (ON)",badge_color_off:"Colore Stato Spento (OFF)",badge_pulse:"Effetto Pulsazione Energetica quando Attivo",badge_quick_toggle:"Tocco Rapido per Accendere/Spegnere",badge_tap_behavior:"Comportamento al Tocco del Badge",secondary_info_entity:"Entità Informazione Secondaria",secondary_info_unit:"Unità di Misura Personalizzata",secondary_info_decimals:"Numero di Decimali",secondary_info_template:"Template Formattazione",unit:"Unità di Misura Personalizzata",glow_color:"Colore Aura Personalizzato",tap_action:"Azione Tocco Singolo (Tap)",hold_action:"Azione Pressione Prolungata (Hold)",double_tap_action:"Azione Doppio Tocco (Double Tap)",tap_more_info_target:"Destinazione Scheda Dettagli (Tap)",hold_more_info_target:"Destinazione Scheda Dettagli (Hold)",double_tap_more_info_target:"Destinazione Scheda Dettagli (Double Tap)",tap_more_info_entity:"Entità Terza Personalizzata (Tap)",hold_more_info_entity:"Entità Terza Personalizzata (Hold)",double_tap_more_info_entity:"Entità Terza Personalizzata (Double Tap)",helper:{label_font_size:"Dimensione del testo dell'etichetta del nodo in pixel (default: 10px).",label_spacing_below_node:"Distanza verticale in pixel tra il cerchio del nodo e l'etichetta/chip (default: 14px).",enabled:"Attiva o disattiva questa funzionalità visiva.",mode:"Seleziona la modalità di rendering per questo elemento.",anchor:"Seleziona a quale nodo principale ancorare la traiettoria dell'orbe celeste.",scope:"Scegli l'intervallo temporale su cui calcolare l'autosufficienza energetica (Oggi o Totale).",label_style:"Formato di visualizzazione del testo informativo sotto la percentuale.",radius:"Raggio del cerchio in pixel.",show_ring:"Mostra l'anello circolare di avanzamento.",ring_width:"Spessore della linea dell'anello in pixel.",show_glow:"Attiva il bagliore luminoso pulsante.",custom_label:"Testo personalizzato da mostrare.",custom_icon:"Icona MDI personalizzata.",tap_action:"Azione da eseguire al tocco del nodo.",hold_action:"Azione da eseguire alla pressione prolungata.",double_tap_action:"Azione da eseguire al doppio tocco.",tap_more_info_target:"Entità di destinazione per la finestra Altre Info.",tap_more_info_entity:"Entità personalizzata da aprire al tocco.",hold_more_info_target:"Entità di destinazione per la finestra Altre Info alla pressione prolungata.",hold_more_info_entity:"Entità personalizzata da aprire alla pressione prolungata.",double_tap_more_info_target:"Entità di destinazione per la finestra Altre Info al doppio tocco.",double_tap_more_info_entity:"Entità personalizzata da aprire al doppio tocco.",node_shadow_offset_y:"Offset verticale dell'ombra in pixel.",title:"Titolo personalizzato visualizzato nella barra superiore della card.",layout_mode:"Scegli il layout: 'Automatico' passa a verticale su schermi stretti, 'Orizzontale' dispone i nodi su una linea, 'Verticale' su due colonne.",stroke_mode:"Determina se lo spessore delle linee varia in base alla potenza (Watt) o alla corrente (Ampere).",speed_mode:"La velocità delle particelle può essere proporzionale ai Watt assoluti o alla percentuale sul flusso totale.",auto_layout_breakpoint:"Larghezza in pixel della card al di sotto della quale viene attivato il layout responsive verticale (default: 520px).",id:"Identificativo interno univoco del carico (alfanumerico, trattino o underscore).",name:"Nome descrittivo visualizzato nell'etichetta del nodo o carico.",icon:"Icona Material Design al centro del cerchio (es. mdi:solar-power, mdi:heat-pump).",entity:"Sensore principale di potenza in Watt (o kW) associato a questo nodo.",entity_import:"Sensore della potenza prelevata dalla rete (Watt positivi).",entity_export:"Sensore della potenza immessa in rete (Watt positivi).",entity_charge:"Sensore della potenza assorbita per caricare la batteria (Watt positivi).",entity_discharge:"Sensore della potenza erogata dalla batteria in scarica (Watt positivi).",state_of_charge:"Sensore della percentuale di carica della batteria (SoC da 0% a 100%).",entity_amperage:"Sensore opzionale di corrente (Ampere) visualizzato sopra l'icona.",color:"Colore del cerchio, delle particelle luminose e delle linee collegate.",color_charge:"Colore della linea e delle particelle durante la carica della batteria.",color_discharge:"Colore della linea e delle particelle durante la scarica della batteria.",use_idle_color:"Applica una colorazione differente quando la batteria è a riposo (0 W).",color_idle:"Colore applicato al nodo batteria quando è in standby a 0 W.",invert:"Inverte la convenzione del segno: trasforma valori positivi in negativi e viceversa.",switch_entity:"Entità switch/luce/relè associata al nodo per il controllo ON/OFF.",include_in_home:"Se disattivato, il consumo di questo dispositivo viene escluso dal totale calcolato della Casa.",display_zero:"Mantiene visibile la linea di collegamento anche quando la potenza è a zero.",display_zero_tolerance:"Soglia in Watt al di sotto della quale il flusso viene considerato nullo.",show_label:"Mostra o nasconde l'etichetta descrittiva posizionata sotto il cerchio del nodo.",node_radius_primary:"Raggio in pixel dei cerchi principali (Solare, Rete, Batteria, Casa; default: 36px).",node_radius_secondary:"Raggio in pixel dei cerchi dei dispositivi aggiuntivi (default: 28px).",node_radius_tertiary:"Raggio standard per tutti i sub-devices di terzo livello (default: 21px).",icon_size_primary:"Dimensione in pixel delle icone all'interno dei nodi primari (default: 18px).",icon_size_secondary:"Dimensione in pixel delle icone nei dispositivi secondari (default: 16px).",icon_size_tertiary:"Dimensione standard per le icone dei sub-devices di terzo livello (default: 13px).",node_border_width:"Spessore del bordo esterno dei cerchi dei nodi in pixel (default: 2.5px).",sub_device_border_width:"Spessore del bordo per i nodi terziari sub-devices in pixel (default: 2.0px).",sub_device_spacing_x:"Distanza orizzontale predefinita tra nodo genitore e sub-devices (default: 75px).",sub_device_spacing_y:"Distanza verticale predefinita tra nodo genitore e sub-devices (default: 32px).",include_in_parent:"Se abilitato, la potenza di questo sub-device fa parte del carico padre (o contribuisce al suo rollup se il padre non ha entità propria).",distance_x:"Offset orizzontale relativo personalizzato dal nodo padre in pixel.",distance_y:"Offset verticale relativo personalizzato dal nodo padre in pixel.",sub_device_radius:"Raggio del cerchio del sub-device in pixel (default: 21px).",sub_device_icon_size:"Dimensione dell'icona del sub-device in pixel (default: 13px).",show_node_shadows:"Applica un'ombra sfumata sotto i cerchi per conferire profondità 3D.",node_shadow_color:"Colore personalizzato per l'ombra dei nodi (lascia vuoto per l'ombra standard).",node_shadow_blur:"Raggio di sfocatura dell'ombra dei nodi in pixel (default: 10px).",node_shadow_spread:"Estensione dell'ombra dei nodi in pixel.",font_size_primary:"Dimensione del testo del valore di potenza nei nodi primari (default: 10px).",font_size_secondary:"Dimensione del testo del valore di potenza nei dispositivi secondari (default: 9px).",font_size_unit:"Dimensione del testo dell'unità di misura W/kW/A (default: 8px).",font_size_extra:"Dimensione del font per le frecce direzionali di carica/scarica e prelievo/immissione (default: 8.5px).",font_size_sub:"Dimensione del font per i consumi non tracciati e le info secondarie (default: 9px).",font_size_label:"Dimensione del font delle etichette dei nodi (default: 10px).",font_size_top_info:"Dimensione del testo superiore SoC % / Corrente A sopra l'icona (default: 8px).",spacing_label_below_node:"Distanza verticale in pixel tra il cerchio del nodo e l'etichetta (default: 14px).",show_labels:"Abilita o disabilita globalmente le etichette di testo per tutti i nodi.",label_chip_enabled:"Disegna un riquadro smussato in stile chip/tag attorno all'etichetta.",label_chip_opacity:"Opacità dello sfondo del chip con il colore del nodo (da 0.05 a 1.0; default: 0.18).",label_chip_padding_x:"Spaziatura orizzontale interna in pixel del chip (default: 8px).",label_chip_padding_y:"Spaziatura verticale interna in pixel del chip (default: 3.5px).",label_border_radius:"Raggio di curvatura degli angoli arrotondati del chip (default: 6px).",label_border_width:"Spessore del bordo esterno del chip in pixel (default: 1px).",label_color_mode:"Contrasto automatico calcola dinamicamente bianco o nero per la massima leggibilità.",label_color:"Colore del testo dell'etichetta quando la modalità colore è su 'Personalizzato'.",inactive_wire_opacity:"Opacità delle linee quando non c'è flusso di potenza (default: 0.35).",inactive_wire_style:"Scegli se mostrare la linea a flusso zero tratteggiata, continua o nasconderla.",hover_glow_radius:"Raggio dell'effetto bagliore luminoso al passaggio del cursore sopra un nodo (default: 10px).",show_home_mix_ring:"Mostra un anello multi-colore attorno alla Casa con quote proporzionali a Solare, Rete e Batteria.",home_glow_mode:"Al passaggio del cursore la Casa si illumina con il colore della fonte primaria o con il colore fisso.",line_routing_mode:"Scegli tra curve di Bezier dirette o canale centrale a bus ortogonale per carichi multipli.",bus_lane_spacing:"Distanza tra le corsie parallele dei carichi nel canale centrale (default: 8px).",bus_corner_radius:"Raggio di curvatura dei raccordi a 90° nel canale centrale (default: 20px).",invert_bus_lane_order:"Inverte l'ordine delle corsie del canale centrale (dalla più interna alla più esterna).",particles_per_arc:"Numero di particelle luminose che viaggiano su ogni linea attiva (default: 3).",particle_size_offset:"Aumento del raggio delle particelle luminose in pixel (default: 1.8px).",particle_inner_glow:"Aggiunge un nucleo bianco brillante ad alta densità al centro di ciascuna particella.",particle_soft_edge:"Applica una sfumatura radiale morbida ai bordi delle particelle per un effetto luce realistico.",spacing_horizontal:"Spaziatura orizzontale in pixel tra le colonne dei nodi (default: 120px).",spacing_vertical:"Spaziatura verticale in pixel tra le righe dei nodi (default: 85px).",spacing_text_above_icon:"Distanza in pixel tra il testo superiore (SoC/Ampere) e l'icona interna (default: 4px).",spacing_text_below_icon:"Distanza in pixel tra l'icona interna e il valore di potenza (default: 4px).",meteor_trail:"Coda luminescente a cometa che segue le particelle in movimento.",tail_length:"Lunghezza della scia a cometa lungo il percorso del cavo (da 0.02 a 0.25).",glow_intensity:"Intensità del bagliore e spessore della scia a cometa.",living_icons:"Icone animate per i carichi e visualizzazione dinamica della batteria (onde liquide o gradiente).",battery_type:"Visualizzazione batteria: 'Gradiente' (bagliore radiale con SoC) o 'Liquido' (onda d'acqua animata).",battery_animated:"Mantiene l'onda liquida della batteria in oscillazione continua.",load_animation:"Animazione applicata alle icone dei carichi attivi (rotazione o pulsazione).",glassmorphism:"Effetto lente in vetro 3D con riflesso bombato e anello concentrico neon luminoso.",intensity:"Percentuale di intensità dei riflessi di luce e della brillantezza del vetro.",neon_core:"Mostra un anello interno concentrico luminescente (Neon Core) all'interno del cerchio.",impact_ripples:"Onda d'urto circolare (ripple) che si espande all'arrivo di ciascuna particella sul nodo.",ripple_size:"Raggio massimo di espansione dell'onda d'urto in pixel (default: 18px).",ripple_color:"Colore dell'onda d'urto (lascia vuoto per usare il colore dell'energia in arrivo).",celestial_tracker:"Tracciamento in tempo reale della posizione del Sole e della Luna su quadrante 24h o arco 180°.",self_sufficiency:"Mostra un nodo circolare centrale all'incrocio dei 4 nodi principali che visualizza la percentuale di autosufficienza energetica cumulata nel tempo con anello proporzionale.",self_sufficiency_scope:"Calcola la percentuale di autosufficienza sui consumi odierni (Oggi) o sul totale storico complessivo (Totale).",self_sufficiency_label_style:"Cosa mostrare sotto il numero percentuale: indicatore dell'ambito (OGGI/TOTALE), testo 'AUTOSUFF.', icona MDI o solo il numero pulito.",self_sufficiency_radius:"Dimensione del raggio del cerchio centrale in pixel (default: 22px).",self_sufficiency_ring_width:"Spessore della traccia circolare dell'anello donut in pixel (default: 3.2px).",self_sufficiency_show_glow:"Attiva un'elegante aura pulsante colorata attorno al nodo (verde se >= 90%, ambra se sotto il 50%).",glow_color:"Colore personalizzato per l'aura luminosa pulsante attorno al nodo centrale (lascia vuoto per calcolo dinamico in base alla percentuale).",entity_solar_energy:"Sensore con l'energia fotovoltaica prodotta o consumata in kWh (es. sensor.solar_energy_today).",entity_battery_energy_discharge:"Sensore con l'energia scaricata dalla batteria verso i carichi in kWh (es. sensor.battery_discharged_today).",entity_grid_energy_import:"Sensore con l'energia prelevata dalla rete elettrica in kWh (es. sensor.grid_energy_imported_today).",entity_home_energy:"Opzionale: sensore del consumo complessivo della casa in kWh.",entity_self_sufficiency:"Opzionale: sensore diretto di percentuale autosufficienza fornito dall'inverter.",weather_entity:"Entità meteo opzionale per modulare colori, raggi e badge dell'orbe celeste (es. weather.home).",show_markers:"Mostra indicatori grafici e orari per Alba e Tramonto sul quadrante.",show_marker_icons:"Mostra le icone MDI a fianco degli orari di Alba e Tramonto.",sunrise_icon:"Icona personalizzata per il sorgere del sole (default: mdi:weather-sunset-up).",sunset_icon:"Icona personalizzata per il tramonto del sole (default: mdi:weather-sunset-down).",show_rays:"Attiva raggi solari rotanti ad accelerazione hardware GPU attorno all'orbe.",show_tail:"Disegna una coda luminosa progressiva lungo l'arco percorso fino all'orario attuale.",show_stars:"Mostra stelline scintillanti animate distribuite lungo l'arco notturno reale.",night_node_mode:"Di notte e con produzione a 0W, trasforma l'icona del nodo solare in luna (🌙) se non personalizzata.",badge_enabled:"Mostra un badge circolare sullo spigolo del nodo per indicare lo stato dell'interruttore (ON/OFF).",badge_style:"Stile visivo del badge: LED circolare (Dot), icona mini-power o testo 'ON'/'OFF'.",badge_position:"Posizione di ancoraggio del badge attorno al bordo del nodo.",badge_size:"Diametro del badge di notifica in pixel (default: 10px).",badge_color_on:"Colore del badge quando il dispositivo è acceso o attivo.",badge_color_off:"Colore del badge quando il dispositivo è spento o inattivo.",badge_pulse:"Attiva una pulsazione luminosa continua sul badge quando il dispositivo è acceso.",badge_quick_toggle:"Permette di toccare direttamente il badge per accendere o spegnere rapidamente il dispositivo.",badge_tap_behavior:"Comportamento quando si tocca direttamente il badge di stato.",secondary_info:"Visualizza un'informazione testuale aggiuntiva sotto il nodo (es. temperatura, energia giornaliera).",unit:"Unità di misura personalizzata da affiancare al valore dell'informazione secondaria.",decimals:"Numero di cifre decimali da visualizzare nei valori di potenza (default: 2).",w_to_kw_threshold:"Soglia in Watt oltre la quale la visualizzazione passa automaticamente a kW (default: 1000 W).",scale_curve:"La curva radice quadrata (sqrt) offre la migliore percezione visiva per piccoli e grandi consumi.",scale_min:"Potenza al di sotto della quale le particelle viaggiano alla velocità minima consentita (default: 50 W).",scale_max:"Potenza alla quale la linea raggiunge lo spessore massimo e la velocità massima (default: 6000 W).",smoothing_factor:"Fattore di smorzamento esponenziale (EMA): valori bassi rendono le transizioni più morbide (default: 0.35).",max_total_particles:"Numero massimo di particelle attive contemporaneamente a schermo per garantire 60 FPS (default: 30).",min_stroke:"Spessore minimo delle linee di flusso in pixel (default: 2.0px).",max_stroke:"Spessore massimo delle linee di flusso a pieno carico in pixel (default: 7.0px).",min_duration:"Durata minima in secondi del viaggio di una particella alla massima potenza (default: 0.8s).",max_duration:"Durata massima in secondi del viaggio di una particella alla minima potenza (default: 5.5s).",normalize_speed_by_length:"Se attivo, calcola la velocità fisica uniforme in pixel al secondo tenendo conto della lunghezza del cavo, evitando che le particelle viaggino più veloci sui percorsi lunghi.",residual_handling:"Metodo di bilanciamento delle discrepanze matematiche fra produzione, accumulo e consumi.",residual_absorb_target:"Nodo su cui convogliare l'energia residua quando la gestione è impostata su 'Assorbimento'."},option:{override:{auto:"Predefinito (Globale)",enabled:"Attivato (Forza)",disabled:"Disattivato (Nascondi)"},self_sufficiency_scope:{today:"Giornaliera (Oggi)",total:"Storica (Totale)"},self_sufficiency_label_style:{scope:"Ambito Temporale (OGGI / TOTALE)",text:"Testo 'AUTOSUFF.'",icon:"Icona MDI Personalizzata",none:"Solo Percentuale (Nessun testo)"},layout_mode:{auto:"Automatico (Adattivo al dispositivo)",horizontal:"Orizzontale (Griglia lineare)",vertical:"Verticale (Compatto a 2 Colonne)"},stroke_mode:{watt:"Dinamico in base alla Potenza (Watt)",fixed:"Spessore Fisso Uniforme",ampere:"Dinamico in base alla Corrente (Ampere)"},speed_mode:{absolute:"Velocità Assoluta (Watt effettivi)",relative:"Velocità Relativa (% sul totale energetico)"},scale_curve:{sqrt:"Radice Quadrata (Sqrt - Consigliata per dinamica visiva)",linear:"Lineare Proporzionale",log:"Logaritmica (Ampio spettro di potenza)"},residual_handling:{clamp:"Clamp (Bilancia a zero sull'arco principale)",absorb:"Assorbimento (Convoglia su target dedicato)",unbalanced:"Sbilanciamento (Visualizza quota residua)"},residual_absorb_target:{grid:"Rete Elettrica (Grid)",battery:"Batteria & Accumulo (Battery)"},badge_style:{dot:"Dot LED Circolare Minimal",icon:"Mini-Icona Power Attiva/Spenta",text:"Micro-Tag Testuale (ON / OFF)"},badge_position:{top_right:"In alto a destra (Top-Right)",top_left:"In alto a sinistra (Top-Left)",bottom_right:"In basso a destra (Bottom-Right)",bottom_left:"In basso a sinistra (Bottom-Left)"},badge_tap_behavior:{auto:"Automatico (Riconosce switch o sensore)",toggle:"Accende / Spegne lo Switch (Toggle)","more-info-switch":"Apre Scheda di Gestione dello Switch","more-info-sensor":"Apre Scheda Storico del Sensore","more-info":"Apre Scheda Dettagli Generale"},more_info_target:{auto:"Automatico (Batteria: SoC su Long Press, altrimenti Switch/Sensore)",soc:"Stato di Carica Batteria (SoC %)",sensor:"Sensore di Potenza Principale (W/kW)",secondary:"Sensore Secondario (Secondary Info)",amperage:"Sensore Corrente (Amperaggio)",switch:"Entità Switch / Controllo",custom:"Entità Terza Personalizzata"},label_color_mode:{auto_contrast:"Contrasto Intelligente Ottimale (Auto B/W)",white:"Bianco Puro (#ffffff)",black:"Nero Scuro (#0f172a)",match_entity:"Abbina al Colore dell'Entità",secondary:"Grigio Secondario Standard",custom:"Colore Personalizzato"},battery_type:{gradient:"Gradiente Radiale Dinamico (Energy Glow)",liquid:"Livello Liquido con Onda Animata (Liquid Wave)"},load_animation:{rotate:"Rotazione Continua (Ventola / Motore)",pulse:"Pulsazione / Respiro Energetico",none:"Nessuna (Icone Statiche)"},line_routing_mode:{bezier_curved:"Archi Curvi Diretti (Bezier)",orthogonal_bus:"Canale Centrale a Bus (Ortogonale Morbido)"},inactive_wire_style:{dashed:"Tratteggiato (Dashed)",solid:"Continuo (Solid)",hidden:"Completamente Nascosto"},home_glow_mode:{predominant:"Dinamico (Colore della fonte primaria attiva)",custom:"Fisso (Colore base della Casa)"},celestial_mode:{dial_24h:"Quadrante 24h a 360° (Giorno & Notte)",semicircle:"Semicerchio 180° (Cupola Superiore)"},celestial_anchor:{home:"Attorno al Nodo Casa",solar:"Attorno al Nodo Solare (Consigliato)"}},error:{invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo.",duplicate_id:"L'ID del dispositivo deve essere univoco.",invalid_id:"L'ID deve iniziare con una lettera e contenere solo caratteri alfanumerici, trattini o underscore.",reserved_id:"Questo ID è riservato dal sistema.",missing_entity:"È richiesta almeno un'entità di potenza valida."}},bt={missing_entity:"È richiesta almeno un'entità di potenza valida.",invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo."},yt={self_sufficiency:{scope_today:"OGGI",scope_total:"TOTALE",default_label:"AUTOSUFF."}},xt={card:ft,editor:gt,errors:bt,effects:yt};const vt={en:mt||Object.freeze({__proto__:null,card:_t,default:mt,editor:pt,effects:ht,errors:ut}),it:xt||Object.freeze({__proto__:null,card:ft,default:xt,editor:gt,effects:yt,errors:bt})};function wt(e,t="en"){const o=t.replace(/['"]+/g,"").replace("-","_").split("_")[0],i=vt[o]||vt.en,a=e.split(".");let n=i;for(const t of a){if(!n||"object"!=typeof n||!(t in n)){let t=vt.en;for(const o of a){if(!t||"object"!=typeof t||!(o in t))return e;t=t[o]}return"string"==typeof t?t:e}n=n[t]}return"string"==typeof n?n:e}function $t(e,t=12){if(!e)return t;try{const o=new Date(e);return isNaN(o.getTime())?t:o.getHours()+o.getMinutes()/60+o.getSeconds()/3600}catch{return t}}function St(e){const t=(e%24+24)%24,o=Math.floor(t),i=Math.round(60*(t-o))%60;return`${o.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`}function zt(e,t,o){const i=(90+15*o)*(Math.PI/180);return{x:e.x+t*Math.cos(i),y:e.y+t*Math.sin(i)}}function Ft(e,t,o,i,a,n){if(o){let o="url(#glow-sun-sunny)",r="#f59e0b";"partlycloudy"===i?(o="url(#glow-sun-partlycloudy)",r="#fbbf24"):"cloudy"===i?(o="url(#glow-sun-cloudy)",r="#94a3b8"):"rainy"===i?(o="url(#glow-sun-rainy)",r="#38bdf8"):"fog"===i?(o="url(#glow-sun-fog)",r="#cbd5e1"):"lightning"===i&&(o="url(#glow-sun-lightning)",r="#eab308");let s=V``;if(n&&"cloudy"!==i&&"fog"!==i){const e=8,t=8.5,o=13,i=[];for(let a=0;a<e;a++){const n=2*a*Math.PI/e,s=Math.cos(n)*t,l=Math.sin(n)*t,d=Math.cos(n)*o,c=Math.sin(n)*o;i.push(V`
    ...
    `}}function Ct(e,t,o,i){const{x:a,y:n}=o,r=e.mode||"dial_24h",{timeOfDay:s,sunrise:l,sunset:d,isDay:c,weatherCondition:_,weatherBadge:p}=t,u=!1!==e.show_rays,h=!1!==e.show_tail,m=!1!==e.show_stars,f=!1!==e.show_markers;if("dial_24h"===r){const t=zt(o,i,l),a=zt(o,i,d),n=zt(o,i,s),r=((d-l)%24+24)%24>12?1:0,g=((l-d)%24+24)%24>12?1:0,b="sunny"===_?"#fbbf24":"#cbd5e1",y=zt(o,i,12),x=zt(o,i,0);let v=[];if(m){const e=function(e,t,o,i){const a=((o-i)%24+24)%24,n=[7,-6,8,-6,7],r=[3.2,3.8,2.8,4,3.2];return[.15,.35,.5,.65,.85].map((o,s)=>{const l=zt(e,t+n[s],(i+o*a)%24);return{x:l.x,y:l.y,cls:`star-${s+1}`,size:r[s]}})}(o,i,l,d);v=e.map(e=>{const t=e.size;return V`
        ...
        `})}let w=V``;if(h)if(c){const e=s-l;if(e>.1){const o=e>12?1:0;w=V`
      ...
      `:V``,c=o?24:8;$=V`
        <g class="celestial-sun-markers">
          ...
          ${r}
          <text x="${(t.x-c).toFixed(1)}" y="${(t.y+3.5).toFixed(1)}" font-size="9" font-weight="600" fill="#fbbf24" text-anchor="end">${St(l)}</text>
          
          <!-- Sunset Marker -->
          <circle cx="${a.x.toFixed(1)}" cy="${a.y.toFixed(1)}" r="3" fill="#f97316" filter="url(#celestial-glow)" />
          ${s}
          <text x="${(a.x+c).toFixed(1)}" y="${(a.y+3.5).toFixed(1)}" font-size="9" font-weight="600" fill="#f97316" text-anchor="start">${St(d)}</text>
        </g>
      `}return V`
    ...
    `}{let e=0;if(c)e=Math.min(1,Math.max(0,(s-l)/(d-l)));else{const t=((l-d)%24+24)%24;e=s>=d?(s-d)/t:(s+(24-d))/t,e=Math.min(1,Math.max(0,e))}const t=Math.PI*(1-e),o=a+i*Math.cos(t),r=n-i*Math.sin(t),m=c?"sunny"===_?"rgba(251, 191, 36, 0.25)":"rgba(148, 163, 184, 0.28)":"rgba(56, 189, 248, 0.25)";let f=V``;if(h&&e>.01){const e=c?"url(#grad-sun-tail)":"url(#grad-moon-tail)";f=V`
        <path class="celestial-tail"
    ...
    `}}function At(e,t){if(!e||!t)return 0;const o=e.states[t];if(!o||"unavailable"===o.state||"unknown"===o.state)return 0;const i=parseFloat(o.state);return isNaN(i)?0:Math.max(0,i)}function kt(e,t,o,i=.35){const a=1+i;t>0&&(e.speed=function(e,t,o,i){if(i<=0)return e;const a=Math.max(.01,10*o);return t+(e-t)*Math.exp(-a*i)}(e.speed,e.targetSpeed,o,t),e.progress+=e.speed*t);const n=e.progress%a,r=e.prevNormProgress,s=r<1&&(n>=1||n<r),l=!e.isFadingOut&&s;let d=!1;return e.isFadingOut&&(s||n>=1)&&(d=!0),e.prevNormProgress=n,{cycleProg:n,completedFadeOut:d,arrivalTriggered:l}}function Mt(e,t){if(!t||0===t.length)return e;const o=t.reduce((e,t)=>e+t.speed,0);return o/t.length}function Et(e,t=.08,o=.08){return e<0||e>1?0:e<t?Math.max(0,Math.min(1,e/t)):e>1-o?Math.max(0,Math.min(1,(1-e)/o)):1}let It=class extends de{constructor(){super(...arguments),this._watchedEntities=new Set,this._previousDeviceIds=new Set,this._configWarnings=[],this._gestureController=new nt((e,t)=>at(this,this._hass,e,t)),this._particlesMap=new Map,this._particleDomElements={},this._meteorDomElements={},this._meteorGradElements={},this._pathLUT={},this._lastArcDurations={},this._lastGeometryHash="",this._lastAnimTimestamp=0,this._isCardVisible=!0,this._debugFps=0,this._debugAvgFps=0,this._debugWorstFrameMs=0,this._debugRendersPerSec=0,this._debugRenderCount=0,this._debugLastRenderSec=0,this._debugFrameTimes=[],this._debugEngine="raf",this._ripplePool=[],this._lastRippleTriggerTime={},this._liquidPhase=0,this._liquidAccumulator=0,this._lastNodePositions={},this._actualLayout="horizontal",this._handleVisibilityChange=()=>{"undefined"!=typeof document&&document.hidden?(this._isCardVisible=!1,this._stopParticleAnimation()):(this._isCardVisible=!0,this._lastAnimTimestamp=0,this._startParticleAnimation())}}static async getConfigElement(){return await Promise.resolve().then(function(){return jt}),document.createElement("simple-power-flow-card-editor")}static getStubConfig(e,t){const o=t||(e?.states?Object.keys(e.states):[]),i=t=>o.find(o=>{const i=o.toLowerCase(),a=e?.states?.[o],n="power"===a?.attributes?.device_class||"W"===a?.attributes?.unit_of_measurement||"kW"===a?.attributes?.unit_of_measurement;return t.some(e=>i.includes(e))&&(n||!e)});return{type:"custom:simple-power-flow-card",card_version:2,title:"Power Flow",solar:{entity:i(["solar","pv","fotovoltaico"])||"sensor.solar_power"},grid:{entity:i(["grid","rete","power_meter","import"])||"sensor.grid_power"},battery:{entity:i(["battery_power","accumulo","batteria"])||"sensor.battery_power"},home:{entity:i(["home_power","house_power","consumo_casa"])||"sensor.home_power"}}}static{this.styles=Ie}_purgeArc(e){for(let t=0;t<10;t++){const o=`${e}-${t}`;this._particlesMap.delete(o),this._particleDomElements[o]&&(this._particleDomElements[o].remove(),delete this._particleDomElements[o]),this._meteorDomElements[o]&&(this._meteorDomElements[o].remove(),delete this._meteorDomElements[o]),this._meteorGradElements[o]&&(this._meteorGradElements[o].remove(),delete this._meteorGradElements[o])}delete this._pathLUT[e],delete this._lastNodePositions[e],delete this._lastRippleTriggerTime[e],delete this._lastArcDurations[e]}setConfig(e){if(!e)throw new Error(wt("errors.missing_entity"));const t=function(e){if(!e||"object"!=typeof e)return e;const t={...e},o=t.card_version;return(!o||"number"!=typeof o||o<2)&&(void 0===t.display_zero_tolerance&&(t.display_zero_tolerance=0),t.card_version=2),t}(e),o=(e,t,o,i)=>{const a=((e,t)=>"number"==typeof e&&Number.isFinite(e)?e:t)(e,i);return Math.max(t,Math.min(o,a))},i=o(t.decimals,0,3,2),a=o(t.w_to_kw_threshold,100,1e4,1e3),n=o(t.scale_min,0,5e3,50),r=o(t.scale_max,500,5e4,6e3),s=o(t.min_duration,.2,5,.8),l=o(t.max_duration,1,20,5.5),d=o(t.min_stroke,.5,10,2),c=o(t.max_stroke,1,20,7),_=o(t.display_zero_tolerance,0,50,1),p=o(t.smoothing_factor,.05,1,.35),u=o(t.max_total_particles,5,100,30),h=o(t.auto_layout_breakpoint,200,1200,520),m=dt(t.styles||{},t),f=new Set(["solar","grid","battery","home"]),g=new Set;this._configWarnings=[];const b=[];Array.isArray(t.devices)&&t.devices.forEach((e,t)=>{const o=rt(e);let i=(o.id||`device_${t+1}`).trim();const a=i;if(f.has(i)&&(i=`${i}_device`,this._configWarnings.push(`Dispositivo #${t+1} usa l'ID riservato '${a}'. È stato rinominato in '${i}'. Correggi lo YAML.`)),g.has(i)){let e=2,t=`${i}_${e}`;for(;g.has(t)||f.has(t);)e++,t=`${i}_${e}`;this._configWarnings.push(`ID dispositivo duplicato '${a}'. È stato rinominato in '${t}'. Correggi lo YAML.`),i=t}g.add(i);const n=[];Array.isArray(e.sub_devices)&&e.sub_devices.forEach((e,t)=>{const o=rt(e);let a=(o.id||`${i}_sub_${t+1}`).trim();const r=a;if(f.has(a)&&(a=`${a}_sub`,this._configWarnings.push(`Sub-device #${t+1} usa l'ID riservato '${r}'. Rinominato in '${a}'.`)),g.has(a)){let e=2,t=`${a}_${e}`;for(;g.has(t)||f.has(t);)e++,t=`${a}_${e}`;this._configWarnings.push(`ID sub-device duplicato '${r}'. Rinominato in '${t}'.`),a=t}g.add(a),n.push({...o,id:a,include_in_parent:!1!==e.include_in_parent,include_in_home:!1!==e.include_in_home,distance_x:e.distance_x,distance_y:e.distance_y,sub_device_radius:e.sub_device_radius,sub_device_icon_size:e.sub_device_icon_size})}),b.push({...o,id:i,sub_devices:n})});const y={...xe,...t,card_version:t.card_version||2,decimals:i,w_to_kw_threshold:a,scale_min:n,scale_max:r,min_duration:s,max_duration:l,min_stroke:d,max_stroke:c,display_zero_tolerance:_,smoothing_factor:p,max_total_particles:u,auto_layout_breakpoint:h,stroke_mode:m.stroke_mode??t.stroke_mode??xe.stroke_mode,speed_mode:m.speed_mode??t.speed_mode??xe.speed_mode,normalize_speed_by_length:m.normalize_speed_by_length??t.normalize_speed_by_length??xe.normalize_speed_by_length,styles:{...fe,...m},devices:b};if(y.solar&&(y.solar=rt(y.solar)),y.grid&&(y.grid=rt(y.grid)),y.battery&&(y.battery=rt(y.battery)),y.home&&(y.home=rt(y.home)),void 0!==y.scale_min&&void 0!==y.scale_max&&y.scale_min>=y.scale_max){const e=y.scale_min;y.scale_min=y.scale_max,y.scale_max=e>y.scale_max?e:y.scale_max+100}if(void 0!==y.min_duration&&void 0!==y.max_duration&&y.min_duration>=y.max_duration){const e=y.min_duration;y.min_duration=y.max_duration,y.max_duration=e>y.max_duration?e:y.max_duration+.5}if(void 0!==y.min_stroke&&void 0!==y.max_stroke&&y.min_stroke>=y.max_stroke){const e=y.min_stroke;y.min_stroke=y.max_stroke,y.max_stroke=e>y.max_stroke?e:y.max_stroke+.5}const x=new Set;b.forEach(e=>{x.add(e.id),Array.isArray(e.sub_devices)&&e.sub_devices.forEach(e=>x.add(e.id))});for(const e of this._previousDeviceIds)x.has(e)||(this._purgeArc(`home-${e}`),this._purgeArc(e));this._previousDeviceIds=x,this._pathLUT={},this._config=y,this._watchedEntities.clear();const v=e=>{e&&this._watchedEntities.add(e)};[this._config.solar,this._config.grid,this._config.battery,this._config.home].forEach(e=>{e&&(v(e.entity),v(e.entity_in),v(e.entity_out),v(e.entity_import),v(e.entity_export),v(e.entity_charge),v(e.entity_discharge),v(e.state_of_charge),v(e.entity_amperage),v(e.switch_entity),v(e.secondary_info?.entity))}),Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{v(e.entity),v(e.entity_amperage),v(e.switch_entity),v(e.secondary_info?.entity),Array.isArray(e.sub_devices)&&e.sub_devices.forEach(e=>{v(e.entity),v(e.entity_amperage),v(e.switch_entity),v(e.secondary_info?.entity)})}),this._checkInitialDimensions(),this.requestUpdate()}set hass(e){const t=this._hass;this._hass=e,t&&!this._hasWatchedEntityChanged(t,e)||this.requestUpdate()}_hasWatchedEntityChanged(e,t){if(!e?.states||!t?.states)return!0;for(const o of this._watchedEntities)if(e.states[o]!==t.states[o])return!0;return!1}getCardSize(){return 4}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}getLayoutOptions(){return{grid_columns:4,grid_rows:3,grid_min_columns:2,grid_min_rows:2}}connectedCallback(){super.connectedCallback(),this._isCardVisible=!0,"undefined"!=typeof document&&document.addEventListener("visibilitychange",this._handleVisibilityChange),this._setupObservers(),this._checkInitialDimensions(),this._startParticleAnimation()}disconnectedCallback(){super.disconnectedCallback(),this._isCardVisible=!1,"undefined"!=typeof document&&document.removeEventListener("visibilitychange",this._handleVisibilityChange),this._stopParticleAnimation(),this._resetRipplePool(),this._cleanupObservers(),this._gestureController.handlePointerCancel()}updated(e){super.updated(e),this._debugRenderCount++,this._particlesLayerEl=this.shadowRoot?.querySelector("g.particles-layer"),this._ripplesLayerEl=this.shadowRoot?.querySelector("g.ripples-layer"),this._dynamicDefsEl=this.shadowRoot?.querySelector("defs.dynamic-defs"),this._wavePathsEls=this.shadowRoot?.querySelectorAll("path.node-liquid-wave"),this._syncParticles()}_checkInitialDimensions(){const e=this.getBoundingClientRect();e&&e.width>0&&this._updateLayoutFromWidth(e.width)}_resetRipplePool(){this._ripplePool.forEach(e=>{e.anim&&(e.anim.cancel(),e.anim=void 0),e.el.style.display="none",e.inUse=!1})}_updateLayoutFromWidth(e){const t=this._config?.layout_mode||"auto";if("horizontal"===t)return void("horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this._resetRipplePool(),this.requestUpdate()));if("vertical"===t)return void("vertical"!==this._actualLayout&&(this._actualLayout="vertical",this._resetRipplePool(),this.requestUpdate()));const o=this._config?.auto_layout_breakpoint??520,i=e<=o||"undefined"!=typeof window&&window.innerWidth<=o;i&&"vertical"!==this._actualLayout?(this._actualLayout="vertical",this._resetRipplePool(),this.requestUpdate()):!i&&e>o+20&&"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this._resetRipplePool(),this.requestUpdate())}_setupObservers(){this._resizeObserver||(this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e<=0||(this._resizeTimer&&clearTimeout(this._resizeTimer),this._resizeTimer=setTimeout(()=>{this._updateLayoutFromWidth(e)},120))}}),this._resizeObserver.observe(this)),this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver(e=>{for(const t of e)this._isCardVisible=t.isIntersecting,t.isIntersecting&&(this._lastAnimTimestamp=0,this._startParticleAnimation())}),this._intersectionObserver.observe(this))}_cleanupObservers(){this._resizeTimer&&(clearTimeout(this._resizeTimer),this._resizeTimer=void 0),this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=void 0),this._intersectionObserver&&(this._intersectionObserver.disconnect(),this._intersectionObserver=void 0)}_startParticleAnimation(){!this._animFrameId&&this._isCardVisible&&(this._lastAnimTimestamp=performance.now(),this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)))}_stopParticleAnimation(){this._animFrameId&&(cancelAnimationFrame(this._animFrameId),this._animFrameId=void 0)}_syncParticles(){if(!this._config||!this._lastCalculatedFlows)return;const e={...fe,...this._config.styles||{}},t=this._lastCalculatedFlows.arcs.filter(e=>e.isActive),o=this._config.effects||ye,i=Boolean(o.meteor_trail?.enabled)?2:1,a=Math.floor((this._config.max_total_particles??30)/i);let n=e.particles_per_arc;t.length*n>a&&(n=Math.max(1,Math.floor(a/t.length)));const r=new Set,s=e.normalize_speed_by_length??this._config?.normalize_speed_by_length??!0;t.forEach(t=>{r.add(t.id),this._lastArcDurations[t.id]=t.duration;let o=t.duration;const i=this._pathLUT[t.id];s&&i&&i.totalLength>0&&(o=Math.max(.3,t.duration*(i.totalLength/200)));const a=1/Math.max(.2,o),l=Math.max(4,.75*t.strokeWidth+(e.particle_size_offset??1.8));for(let e=0;e<n;e++){const o=`${t.id}-${e}`,r=this._particlesMap.get(o);if(r)r.targetSpeed=a,r.radius=l,r.arcColor=t.color,r.targetNodeId=t.to,r.isFadingOut=!1;else{const r=e/n*1.35,s=Mt(a,Array.from(this._particlesMap.values()).filter(e=>e.arcId===t.id&&!e.isFadingOut));this._particlesMap.set(o,{id:o,arcId:t.id,progress:r,prevNormProgress:r%1.35,speed:s,targetSpeed:a,radius:l,totalLength:i?.totalLength??0,arcColor:t.color,targetNodeId:t.to,isFadingOut:!1})}}for(let e=n;e<10;e++){const o=`${t.id}-${e}`,i=this._particlesMap.get(o);i&&(i.isFadingOut=!0)}});for(const[e,t]of this._particlesMap.entries())r.has(t.arcId)||(t.isFadingOut=!0);this._startParticleAnimation()}_getPathPoint(e,t){let o=this._pathLUT[e];if(!o){const t=this.shadowRoot?.querySelector(`#path-${CSS.escape(e)}`);if(!t)return null;const i=t.getTotalLength();if(!i||i<=0)return null;const a=100,n=[];for(let e=0;e<=a;e++)n.push(t.getPointAtLength(e/a*i));o={totalLength:i,points:n},this._pathLUT[e]=o;const r={...fe,...this._config?.styles||{}}.normalize_speed_by_length??this._config?.normalize_speed_by_length??!0,s=this._lastArcDurations[e];if(r&&i>0&&s){const t=Math.max(.3,s*(i/200)),o=1/Math.max(.2,t);for(let t=0;t<10;t++){const a=this._particlesMap.get(`${e}-${t}`);a&&(a.targetSpeed=o,a.totalLength=i)}}}const i=Math.max(0,Math.min(1,t))*(o.points.length-1),a=Math.floor(i);if(a>=o.points.length-1)return{pt:o.points[o.points.length-1],totalLength:o.totalLength};const n=i-a,r=o.points[a],s=o.points[a+1];return{pt:{x:r.x+(s.x-r.x)*n,y:r.y+(s.y-r.y)*n},totalLength:o.totalLength}}_triggerImpactRipple(e,t){const o=performance.now();if(o-(this._lastRippleTriggerTime[e]||0)<180)return;this._lastRippleTriggerTime[e]=o;const i=this._lastNodePositions[e];if(!i)return;const a=this._config?.effects||ye,n=a.impact_ripples?.ripple_size??18,r=a.impact_ripples?.ripple_color||t,s=this._ripplesLayerEl||this.shadowRoot?.querySelector("g.ripples-layer");if(!s)return;let l=this._ripplePool.find(e=>!e.inUse);if(!l)if(this._ripplePool.length<12){const e=document.createElementNS("http://www.w3.org/2000/svg","circle");e.setAttribute("class","impact-ripple-group"),e.setAttribute("fill","none"),s.appendChild(e),l={el:e,inUse:!0},this._ripplePool.push(l)}else l=this._ripplePool[0],l.anim&&l.anim.cancel();const d=i.radius,c=i.radius+n;l.inUse=!0;const _=l.el;if(_.setAttribute("cx",i.x.toFixed(1)),_.setAttribute("cy",i.y.toFixed(1)),_.setAttribute("stroke",r),_.setAttribute("stroke-width","3px"),_.setAttribute("r",`${d}px`),_.setAttribute("opacity","0.85"),_.style.display="","function"==typeof _.animate){const e=_.animate([{r:`${d}px`,opacity:.85,strokeWidth:"3px"},{r:`${c}px`,opacity:0,strokeWidth:"0.5px"}],{duration:700,easing:"cubic-bezier(0.1, 0.8, 0.3, 1)",fill:"forwards"});l.anim=e,e.onfinish=()=>{_.style.display="none",l.inUse=!1,l.anim=void 0},e.oncancel=()=>{_.style.display="none",l.inUse=!1,l.anim=void 0}}else{let e=performance.now();const t=700,o=i=>{const a=Math.min(1,(i-e)/t),n=1-Math.pow(1-a,3),r=d+(c-d)*n,s=.85*(1-a);_.setAttribute("r",r.toFixed(1)),_.setAttribute("opacity",s.toFixed(3)),a<1?requestAnimationFrame(o):(_.style.display="none",l.inUse=!1)};requestAnimationFrame(o)}}_updateDebugMetrics(e){if(e<=0)return;const t=performance.now(),o=1e3*e,i=1/e;for(this._debugFps=i,this._debugFrameTimes.push({time:t,duration:o,fps:i});this._debugFrameTimes.length>0&&t-this._debugFrameTimes[0].time>5e3;)this._debugFrameTimes.shift();let a=0,n=0,r=0;for(const e of this._debugFrameTimes)e.duration>a&&(a=e.duration),t-e.time<=2e3&&(n+=e.fps,r++);this._debugWorstFrameMs=a,this._debugAvgFps=r>0?n/r:i;const s=Math.floor(t/1e3);if(s!==this._debugLastRenderSec&&(this._debugRendersPerSec=this._debugRenderCount,this._debugRenderCount=0,this._debugLastRenderSec=s),this.shadowRoot){const e=this.shadowRoot.querySelector(".spf-debug-overlay");if(e){const t=e.querySelector(".debug-engine-val");t&&(t.textContent=this._debugEngine);const o=e.querySelector(".debug-fps-val");o&&(o.textContent=`${this._debugFps.toFixed(0)} / ${this._debugAvgFps.toFixed(0)}`);const i=e.querySelector(".debug-worst-val");i&&(i.textContent=`${this._debugWorstFrameMs.toFixed(1)} ms`);const a=e.querySelector(".debug-part-val");a&&(a.textContent=`${this._particlesMap.size}`);const n=e.querySelector(".debug-render-val");n&&(n.textContent=`${this._debugRendersPerSec}/s`)}}}_animateParticles(e){if(!this._isCardVisible)return void(this._animFrameId=void 0);const t="undefined"!=typeof window&&window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches;this._lastAnimTimestamp||(this._lastAnimTimestamp=e);const o=(e-this._lastAnimTimestamp)/1e3;this._lastAnimTimestamp=e;const i=function(e,t=.25){return!Number.isFinite(e)||e<=0?0:Math.min(e,t)}(o,.25);this._config?.debug_overlay&&this._updateDebugMetrics(o);const a=this._particlesLayerEl||this.shadowRoot?.querySelector("g.particles-layer"),n=this._dynamicDefsEl||this.shadowRoot?.querySelector("defs.dynamic-defs");if(!a)return void(this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)));const r=this._config?.effects||ye,s=Boolean(r.meteor_trail?.enabled&&!t),l=r.meteor_trail?.tail_length??.08,d=r.meteor_trail?.glow_intensity??1.5,c=this._config?.smoothing_factor??.35,_=[];for(const[e,o]of this._particlesMap.entries()){const p=kt(o,t?0:i,c,.35);if(p.completedFadeOut){_.push(e);continue}!t&&p.arrivalTriggered&&r.impact_ripples?.enabled&&this._triggerImpactRipple(o.targetNodeId,o.arcColor);const u=p.cycleProg;if(u>1||t){const t=this._particleDomElements[e];t&&0!==o.lastOpacity&&(t.setAttribute("opacity","0"),o.lastOpacity=0);const i=this._meteorDomElements[e];i&&i.setAttribute("d","");continue}const h=this._getPathPoint(o.arcId,u);if(!h)continue;const{pt:m}=h,f=Et(u,.08,.08);let g=this._particleDomElements[e];if(g||(g=document.createElementNS("http://www.w3.org/2000/svg","circle"),g.setAttribute("class","particle-circle"),a.appendChild(g),this._particleDomElements[e]=g),g.setAttribute("cx",m.x.toFixed(1)),g.setAttribute("cy",m.y.toFixed(1)),o.lastRadius!==o.radius&&(g.setAttribute("r",o.radius.toFixed(1)),o.lastRadius=o.radius),o.lastFill!==o.arcColor&&(g.setAttribute("fill",o.arcColor),o.lastFill=o.arcColor),o.lastOpacity!==f&&(g.setAttribute("opacity",f.toFixed(3)),o.lastOpacity=f),s&&n&&f>.05){let t=this._meteorDomElements[e],i=this._meteorGradElements[e];t||(t=document.createElementNS("http://www.w3.org/2000/svg","path"),t.setAttribute("class","meteor-tail"),t.setAttribute("fill","none"),t.setAttribute("stroke-linecap","round"),t.setAttribute("filter","url(#glow-meteor)"),a.insertBefore(t,g),this._meteorDomElements[e]=t);const r=`meteor-grad-${e.replace(/[^a-zA-Z0-9-_]/g,"_")}`;if(!i){i=document.createElementNS("http://www.w3.org/2000/svg","linearGradient"),i.setAttribute("id",r),i.setAttribute("gradientUnits","userSpaceOnUse");const a=document.createElementNS("http://www.w3.org/2000/svg","stop");a.setAttribute("offset","0%"),a.setAttribute("stop-color",o.arcColor),a.setAttribute("stop-opacity","0");const s=document.createElementNS("http://www.w3.org/2000/svg","stop");s.setAttribute("offset","100%"),s.setAttribute("stop-color",o.arcColor),s.setAttribute("stop-opacity","0.95"),i.appendChild(a),i.appendChild(s),n.appendChild(i),this._meteorGradElements[e]=i,t.setAttribute("stroke",`url(#${r})`)}const s=Math.max(0,u-l),c=this._getPathPoint(o.arcId,s),_=this._getPathPoint(o.arcId,s+.33*(u-s)),p=this._getPathPoint(o.arcId,s+.66*(u-s)),h=m;if(c&&_&&p){const e=c.pt,a=_.pt,n=p.pt,r=`M ${e.x.toFixed(1)} ${e.y.toFixed(1)} C ${a.x.toFixed(1)} ${a.y.toFixed(1)}, ${n.x.toFixed(1)} ${n.y.toFixed(1)}, ${h.x.toFixed(1)} ${h.y.toFixed(1)}`;t.setAttribute("d",r),t.setAttribute("stroke-width",(1.5*o.radius*Math.min(2.5,d)).toFixed(1)),t.setAttribute("opacity",f.toFixed(3));const s=o.lastGradCoords;(!s||Math.abs(s.x1-e.x)>2||Math.abs(s.y1-e.y)>2||Math.abs(s.x2-h.x)>2||Math.abs(s.y2-h.y)>2)&&(i.setAttribute("x1",e.x.toFixed(1)),i.setAttribute("y1",e.y.toFixed(1)),i.setAttribute("x2",h.x.toFixed(1)),i.setAttribute("y2",h.y.toFixed(1)),o.lastGradCoords={x1:e.x,y1:e.y,x2:h.x,y2:h.y})}else t.setAttribute("d","")}else{const t=this._meteorDomElements[e];t&&t.parentNode&&(t.parentNode.removeChild(t),delete this._meteorDomElements[e])}}for(const e of _){this._particlesMap.delete(e);const t=this._particleDomElements[e];t&&t.parentNode&&t.parentNode.removeChild(t),delete this._particleDomElements[e];const o=this._meteorDomElements[e];o&&o.parentNode&&o.parentNode.removeChild(o),delete this._meteorDomElements[e]}const p=r.living_icons;if(p?.enabled&&"liquid"===p.battery_type&&!1!==p.battery_animated){this._liquidPhase=function(e,t,o=120){return t<=0?e:(e+o*t)%360}(this._liquidPhase,i,120);const e=this._wavePathsEls||this.shadowRoot?.querySelectorAll("path.node-liquid-wave");if(e&&e.length>0){const t=this._liquidPhase*Math.PI/180,o=4*Math.sin(t);e.forEach(e=>{parseFloat(e.getAttribute("data-cy")||"0");const t=parseFloat(e.getAttribute("data-r")||"0"),i=parseFloat(e.getAttribute("data-wy")||"0");if(t>0){const a=i+o,n=i-o,r=parseFloat(e.getAttribute("data-x0")||"0"),s=parseFloat(e.getAttribute("data-x3")||"0"),l=`M ${r} ${i} C ${r+.35*(s-r)} ${a}, ${r+.65*(s-r)} ${n}, ${s} ${i} A ${t} ${t} 0 0 1 ${r} ${i} Z`;e.setAttribute("d",l)}})}}this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this))}_handleBadgeClick(e,t){t.stopPropagation(),t.preventDefault(),this._gestureController.handlePointerCancel();const o=e.switchEntityId,i=e.entityId,a=!1!==e.badgeQuickToggle;let n=e.badgeTapBehavior||"auto";if("auto"===n)if(o)if(a){const e=o.split(".")[0];n=["climate","media_player","cover","lock","vacuum","water_heater"].includes(e)?"more-info-switch":"toggle"}else n="more-info-switch";else n="more-info-sensor";if("toggle"===n)o&&a&&at(this,this._hass,e,"toggle");else if("more-info-switch"===n||"more-info"===n){const e=o||i;if(e){const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e}});this.dispatchEvent(t)}}else if("more-info-sensor"===n){const e=i||o;if(e){const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e}});this.dispatchEvent(t)}}}_handleNodeKeyDown(e,t){"Enter"!==e.key&&" "!==e.key||(e.preventDefault(),at(this,this._hass,t,"tap"))}render(){if(!this._config||!this._hass)return q``;const e=this._hass?.language||"en",t=this._config.decimals??2,o=this._config.w_to_kw_threshold??1e3,i={...fe,...this._config.styles||{}},a={...ye,...this._config.effects||{}},n={...ge,...this._config.effects?.celestial_tracker||{}},r=function(e,t){const o=new Date,i=o.getHours()+o.getMinutes()/60+o.getSeconds()/3600;let a=6,n=20,r=i>=a&&i<n;const s=e?.states?.["sun.sun"];s&&(s.attributes?.next_rising&&(a=$t(s.attributes.next_rising,6)),s.attributes?.next_setting&&(n=$t(s.attributes.next_setting,20)),r="above_horizon"===s.state||"below_horizon"!==s.state&&i>=a&&i<n);let l="sunny",d="";if(t&&e?.states?.[t]){const o=(e.states[t].state||"").toLowerCase();["sunny","clear-night","exceptional"].includes(o)?l="sunny":["partlycloudy","windy","windy-variant"].includes(o)?(l="partlycloudy",d="⛅"):["cloudy","overcast"].includes(o)?(l="cloudy",d="☁️"):["rainy","pouring","snowy","snowy-rainy","hail"].includes(o)?(l="rainy",d="🌧️"):["fog"].includes(o)?(l="fog",d="🌫️"):["lightning","lightning-rainy"].includes(o)&&(l="lightning",d="⚡")}return{isDay:r,timeOfDay:i,sunrise:a,sunset:n,weatherCondition:l,weatherBadge:d}}(this._hass,n.weather_entity),s=Le(this._hass,this._config.solar,"solar"),l=Le(this._hass,this._config.grid,"grid"),d=Le(this._hass,this._config.battery,"battery"),c=Le(this._hass,this._config.home,"home"),_=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Le(this._hass,e,"device"),o=[];Array.isArray(e.sub_devices)&&e.sub_devices.forEach(e=>{const t=Le(this._hass,e,"device");o.push({...e,power:t.power,ampere:t.amperage,entityId:e.entity,include_in_parent:!1!==e.include_in_parent,include_in_home:!1!==e.include_in_home,hasOwnEntity:t.isConfigured&&t.isValid,hasInvalidUnit:t.hasInvalidUnit,invalidUnitReason:t.invalidUnitReason})}),_.push({...e,power:t.power,ampere:t.amperage,entityId:e.entity,include_in_home:!1!==e.include_in_home,hasOwnEntity:t.isConfigured&&t.isValid,hasInvalidUnit:t.hasInvalidUnit,invalidUnitReason:t.invalidUnitReason,sub_devices:o})});const p=[];s.hasInvalidUnit&&s.invalidUnitReason&&p.push(`Solare: ${s.invalidUnitReason}`),l.hasInvalidUnit&&l.invalidUnitReason&&p.push(`Rete: ${l.invalidUnitReason}`),d.hasInvalidUnit&&d.invalidUnitReason&&p.push(`Batteria: ${d.invalidUnitReason}`),c.hasInvalidUnit&&c.invalidUnitReason&&p.push(`Casa: ${c.invalidUnitReason}`),_.forEach(e=>{e.hasInvalidUnit&&e.invalidUnitReason&&p.push(`${e.name||e.id}: ${e.invalidUnitReason}`),Array.isArray(e.sub_devices)&&e.sub_devices.forEach(e=>{e.hasInvalidUnit&&e.invalidUnitReason&&p.push(`${e.name||e.id}: ${e.invalidUnitReason}`)})});const u=[];this._watchedEntities.forEach(e=>{this._hass?.states&&!(e in this._hass.states)&&u.push(e)});const h=Boolean(this._config.solar?.entity||this._config.solar?.entity_import||this._config.solar?.entity_in||this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_in||this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_in||this._config.home?.entity||this._config.devices&&this._config.devices.length>0),m=Ve({solar:s.power,grid:l.power,battery:d.power,home:c.isConfigured&&c.isValid?c.power:void 0,devices:_},this._config);this._lastCalculatedFlows=m;const f=this._actualLayout,g="horizontal"===f?Ze:Qe,b=i.node_radius_primary,y=i.node_radius_secondary,x=i.node_radius_tertiary,v=i.spacing_horizontal,w=i.spacing_vertical,$=n.enabled&&"solar"===n.anchor?"vertical"===f?24:18:0,S=function(e,t,o,i){const a=o.node_radius_primary??36,n=o.node_radius_secondary??28,r=o.node_radius_tertiary??21,s={};Object.keys(i.nodes).forEach(e=>{s[e]={...i.nodes[e],radius:a,isSecondary:!1,isTertiary:!1,isSubDevice:!1}});let l=0,d=0;if(Object.values(s).forEach(e=>{l=Math.max(l,e.x+e.radius),d=Math.max(d,e.y+e.radius)}),"horizontal"===t){const t=i.devicesHorizontal||{startX:410,rowTopY:80,rowBottomY:320,spacingX:120},a=o.spacing_horizontal??t.spacingX,c=o.sub_device_spacing_x??75,_=o.sub_device_spacing_y??32,p=Math.ceil(e.length/2);let u=t.startX;for(let o=0;o<p;o++){const i=e[2*o],p=e[2*o+1];let h=!1,m=0;if(i){s[i.id]={x:u,y:t.rowTopY,radius:n,isSecondary:!0,isTertiary:!1,isSubDevice:!1},l=Math.max(l,u+n),d=Math.max(d,t.rowTopY+n);const e=(i.sub_devices||[]).filter(e=>!1!==e.display_zero||(e.power||0)>0);if(e.length>0){h=!0;const o=e.length;e.forEach((e,a)=>{const n=e.distance_x??c;m=Math.max(m,n);let p=0;p=void 0!==e.distance_y?e.distance_y:1===o?0:2===o?0===a?-_:_:3===o?0===a?1.2*-_:1===a?0:1.2*_:a*(2*_/(o-1))-_;const h=e.sub_device_radius??r,f=u+n,g=t.rowTopY+p;s[e.id]={x:f,y:g,radius:h,isSecondary:!1,isTertiary:!0,isSubDevice:!0,parentId:i.id},l=Math.max(l,f+h),d=Math.max(d,g+h)})}}if(p){s[p.id]={x:u,y:t.rowBottomY,radius:n,isSecondary:!0,isTertiary:!1,isSubDevice:!1},l=Math.max(l,u+n),d=Math.max(d,t.rowBottomY+n);const e=(p.sub_devices||[]).filter(e=>!1!==e.display_zero||(e.power||0)>0);if(e.length>0){h=!0;const o=e.length;e.forEach((e,i)=>{const a=e.distance_x??c;m=Math.max(m,a);let n=0;n=void 0!==e.distance_y?e.distance_y:1===o?0:2===o?0===i?-_:_:3===o?0===i?1.2*-_:1===i?0:1.2*_:i*(2*_/(o-1))-_;const h=e.sub_device_radius??r,f=u+a,g=t.rowBottomY+n;s[e.id]={x:f,y:g,radius:h,isSecondary:!1,isTertiary:!0,isSubDevice:!0,parentId:p.id},l=Math.max(l,f+h),d=Math.max(d,g+h)})}}u+=h?a+m-25:a}return{nodePositions:s,maxX:l,maxY:d,columnsCount:p,rowsCount:Math.min(e.length,2)}}{const t=i.devicesVertical||{startY:420,colLeftX:95,colRightX:345,spacingY:85},a=o.spacing_vertical??t.spacingY,c=o.sub_device_spacing_y??85,_=Math.ceil(e.length/2);let p=t.startY;for(let o=0;o<_;o++){const i=e[2*o],_=e[2*o+1];let u=!1,h=0;if(i){s[i.id]={x:t.colLeftX,y:p,radius:n,isSecondary:!0,isTertiary:!1,isSubDevice:!1},l=Math.max(l,t.colLeftX+n),d=Math.max(d,p+n);const e=(i.sub_devices||[]).filter(e=>!1!==e.display_zero||(e.power||0)>0);if(e.length>0){u=!0;const o=e.length;e.forEach((e,a)=>{const n=e.distance_y??c;h=Math.max(h,n);let _=t.colLeftX;_=void 0!==e.distance_x?t.colLeftX+e.distance_x:1===o?t.colLeftX:2===o?0===a?58:132:3===o?0===a?46:1===a?95:144:55+a*(80/(o-1));const u=e.sub_device_radius??r,m=p+n;s[e.id]={x:_,y:m,radius:u,isSecondary:!1,isTertiary:!0,isSubDevice:!0,parentId:i.id},l=Math.max(l,_+u),d=Math.max(d,m+u)})}}if(_){s[_.id]={x:t.colRightX,y:p,radius:n,isSecondary:!0,isTertiary:!1,isSubDevice:!1},l=Math.max(l,t.colRightX+n),d=Math.max(d,p+n);const e=(_.sub_devices||[]).filter(e=>!1!==e.display_zero||(e.power||0)>0);if(e.length>0){u=!0;const o=e.length;e.forEach((e,i)=>{const a=e.distance_y??c;h=Math.max(h,a);let n=t.colRightX;n=void 0!==e.distance_x?t.colRightX+e.distance_x:1===o?t.colRightX:2===o?0===i?308:382:3===o?0===i?296:1===i?345:394:305+i*(80/(o-1));const u=e.sub_device_radius??r,m=p+a;s[e.id]={x:n,y:m,radius:u,isSecondary:!1,isTertiary:!0,isSubDevice:!0,parentId:_.id},l=Math.max(l,n+u),d=Math.max(d,m+u)})}}p+=u?a+h-5:a}return{nodePositions:s,maxX:l,maxY:d,columnsCount:Math.min(e.length,2),rowsCount:_}}}(_,f,i,g),z=S.nodePositions,F=function(e,t,o,i){const a=-i;if("horizontal"===e){const e=o.maxX+45,n=Math.max(t.height,o.maxY+45)+i;return`0 ${a} ${Math.max(t.width,e)} ${n}`}{const e=Math.max(t.height,o.maxY+50)+i;return`0 ${a} ${t.width} ${e}`}}(f,g.viewBox,S,$,b,y),C=_.map(e=>`${e.id}:[${(e.sub_devices||[]).map(e=>`${e.id}@${e.distance_x??""}x${e.distance_y??""}`).join(",")}]`).join("|"),A=`${F}_${f}_${b}_${y}_${x}_${v}_${w}_${i.sub_device_spacing_x}_${i.sub_device_spacing_y}_${i.line_routing_mode}_${i.bus_lane_spacing}_${i.bus_corner_radius}_${i.invert_bus_lane_order}_${C}`;this._lastGeometryHash!==A&&(this._pathLUT={},this._lastGeometryHash=A),this._lastNodePositions=z;const k=m.arcs.find(e=>"solar-home"===e.id),M=m.arcs.find(e=>"battery-home"===e.id),E=m.arcs.find(e=>"grid-home"===e.id),I=k?.value||0,P=M?.value||0,D=E?.value||0,T=this._config.display_zero_tolerance??1,L=d.power,O=Math.abs(L)<=T,N=Be(this._config.battery?.color_charge||this._config.battery?.color,Se),U=Be(this._config.battery?.color_discharge,ze),R=Be(this._config.battery?.color_idle,"var(--secondary-text-color, #94a3b8)"),W=Boolean(this._config.battery?.use_idle_color);let B;B=O?W?R:N:L>0?N:U;const G=I+P+D,H=[];G>0&&(I>0&&H.push({id:"solar",color:Be(this._config.solar?.color,ve),percentage:I/G,value:I}),P>0&&H.push({id:"battery",color:U,percentage:P/G,value:P}),D>0&&H.push({id:"grid",color:Be(this._config.grid?.color,we),percentage:D/G,value:D}));let j,Y=Be(this._config.home?.color,Fe);if("predominant"===i.home_glow_mode&&H.length>0){const e=[...H].sort((e,t)=>t.value-e.value);e[0]&&e[0].value>0&&(Y=e[0].color)}const K=Be(this._config.grid?.color,we),X=$e;if(l.isDual)j=[{text:`→ ${Ke(l.inPower||0,t,o,this._hass).full}`,color:K},{text:`← ${Ke(l.outPower||0,t,o,this._hass).full}`,color:X}];else{const e=l.power;j=[{text:`${e>=0?"→":"←"} ${Ke(Math.abs(e),t,o,this._hass).full}`,color:e>=0?K:X}]}let Z;if(d.isDual)Z=[{text:`↓ ${Ke(d.inPower||0,t,o,this._hass).full}`,color:N},{text:`↑ ${Ke(d.outPower||0,t,o,this._hass).full}`,color:U}];else{const e=O&&W?R:L>=0?N:U;Z=[{text:`${L>=0?"↓":"↑"} ${Ke(Math.abs(L),t,o,this._hass).full}`,color:e}]}const Q=(e,t,o=!1)=>"enabled"===e||!0===e||"disabled"!==e&&!1!==e&&(void 0!==t?Boolean(t):o),J=(e,o,a=!1)=>{const n=function(e){if(!e||"object"!=typeof e)return e;const t={...e},o=[{actionKey:"tap_action",targetKey:"tap_more_info_target"},{actionKey:"hold_action",targetKey:"hold_more_info_target"},{actionKey:"double_tap_action",targetKey:"double_tap_more_info_target"}];for(const{actionKey:e,targetKey:i}of o){const o=t[e];if(o&&"object"==typeof o){const a=o.action;"more-info-switch"===a||"more-info-device"===a?(t[e]={...o,action:"more-info"},t[i]||(t[i]="switch")):"more-info-sensor"===a&&(t[e]={...o,action:"more-info"},t[i]||(t[i]="sensor"))}}return t}(e||{}),r=Q(n.show_label??n.show_labels,i.show_labels,!0),s=n.label_font_size??n.font_size_label??i.font_size_label??10,l=n.label_spacing_below_node??n.spacing_label_below_node??i.spacing_label_below_node??14,d=Q(n.label_chip_enabled,i.label_chip_enabled,!1),c=n.label_chip_opacity??i.label_chip_opacity??.18,_=n.label_chip_padding_x??i.label_chip_padding_x??8,p=n.label_chip_padding_y??i.label_chip_padding_y??3.5,u=n.label_border_radius??i.label_border_radius??6,h=n.label_border_width??i.label_border_width??1,m=Be(n.label_color||i.label_color,""),f=n.label_color_mode??i.label_color_mode??"auto_contrast";let g=n.switch_entity;if(!g&&o){const e=o.split(".")[0];Pe.includes(e)&&(g=o)}const b=function(e,t){if(!t||"string"!=typeof t||""===t.trim())return{isConfigured:!1,isUnavailable:!1,isUnknown:!1,isActive:!1,state:null,rawState:""};if(!e||!e.states||!e.states[t])return{isConfigured:!0,isUnavailable:!0,isUnknown:!1,isActive:!1,state:"unavailable",rawState:"unavailable",badgeIcon:"mdi:alert-circle-outline",badgeText:"ERR"};const o=e.states[t],i=(o.state||"").trim().toLowerCase(),a=t.split(".")[0]||"",n=o.attributes||{};if("unavailable"===i)return{isConfigured:!0,isUnavailable:!0,isUnknown:!1,isActive:!1,state:"unavailable",rawState:i,badgeIcon:"mdi:alert-circle-outline",badgeText:"ERR"};if("unknown"===i)return{isConfigured:!0,isUnavailable:!1,isUnknown:!0,isActive:!1,state:"unknown",rawState:i,badgeIcon:"mdi:help-circle-outline",badgeText:"?"};switch(a){case"climate":{const e="off"===i,t=(n.hvac_action||"").toLowerCase();let o,a="mdi:thermostat";"heat"===i||"heating"===t?(a="mdi:fire",o="#ff7043"):"cool"===i||"cooling"===t?(a="mdi:snowflake",o="#29b6f6"):"heat_cool"===i||"auto"===i||"auto"===t?(a="mdi:thermostat-auto",o="#66bb6a"):"fan_only"===i||"fan"===t?(a="mdi:fan",o="#ab47bc"):"dry"===i||"drying"===t?(a="mdi:water-percent",o="#26a69a"):e&&(a="mdi:power-off");let r="ON";return e?r="OFF":"heat"===i?r="HEAT":"cool"===i?r="COOL":"auto"===i||"heat_cool"===i?r="AUTO":"dry"===i?r="DRY":"fan_only"===i&&(r="FAN"),{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:!e,state:e?"off":"on",rawState:i,badgeIcon:a,badgeText:r,badgeColor:o}}case"water_heater":{const e="off"===i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:!e,state:e?"off":"on",rawState:i,badgeIcon:e?"mdi:power-off":"mdi:water-boiler",badgeText:e?"OFF":"ON",badgeColor:e?void 0:"#ff7043"}}case"media_player":{const e=["playing","paused","on","buffering"].includes(i);return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:"playing"===i?"mdi:play":"paused"===i?"mdi:pause":e?"mdi:cast":"mdi:power-off",badgeText:"playing"===i?"PLAY":"paused"===i?"PAUS":e?"ON":"OFF"}}case"vacuum":{const e=["cleaning","returning","on","auto"].includes(i);return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:e?"mdi:robot-vacuum":"mdi:robot-vacuum-off",badgeText:e?"CLEAN":"docked"===i?"DOCK":"returning"===i?"RET":"OFF"}}case"cover":{const e="closed"!==i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:e?"mdi:window-shutter-open":"mdi:window-shutter",badgeText:"open"===i?"OPEN":"closed"===i?"CLSD":i.toUpperCase().slice(0,4)}}case"lock":{const e="unlocked"===i||"unlocking"===i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:e?"mdi:lock-open-variant":"mdi:lock",badgeText:e?"UNLK":"LOCK"}}case"fan":{const e="on"===i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:e?"mdi:fan":"mdi:fan-off",badgeText:e?"ON":"OFF"}}case"light":{const e="on"===i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!1,isActive:e,state:e?"on":"off",rawState:i,badgeIcon:e?"mdi:lightbulb":"mdi:lightbulb-off",badgeText:e?"ON":"OFF"}}default:{const e="on"===i,t="off"===i;return{isConfigured:!0,isUnavailable:!1,isUnknown:!e&&!t,isActive:e,state:e?"on":t?"off":"unknown",rawState:i,badgeIcon:e?"mdi:power":"mdi:power-off",badgeText:e?"ON":t?"OFF":i.toUpperCase().slice(0,4)}}}}(this._hass,g),y=b.state,x=Boolean(g),v=a?Boolean(Q(n.badge_enabled,i.badge_enabled,!1)&&x):void 0!==n.badge_enabled&&"auto"!==n.badge_enabled?Q(n.badge_enabled,i.badge_enabled,!1):Boolean(x),w=n.badge_style??i.badge_style??"dot",$=n.badge_position??i.badge_position??"top_right",S=n.badge_size??i.badge_size??("icon"===w?15:9),z=b.badgeColor||"#4caf50",F=Be(n.badge_color_on||i.badge_color_on,z),C=Be(n.badge_color_off||i.badge_color_off,"#64748b"),A=n.badge_pulse??i.badge_pulse??!0,k=n.badge_quick_toggle??i.badge_quick_toggle??!0;let M,E=n.badge_tap_behavior;if(!E&&g){const e=g.split(".")[0];E=["climate","media_player","cover","lock","vacuum","water_heater"].includes(e)?"more-info":"toggle"}if(n.secondary_info?.entity&&this._hass?.states?.[n.secondary_info.entity]){const e=this._hass.states[n.secondary_info.entity],o=n.secondary_info.decimals??t,i=parseFloat(e.state),a=isNaN(i)?e.state:i.toFixed(o),r=void 0!==n.secondary_info.unit?n.secondary_info.unit:e.attributes?.unit_of_measurement||"";M=`${a}${r?` ${r}`:""}`}const I=n.state_of_charge||(n.secondary_info?.entity&&"battery"===this._hass?.states?.[n.secondary_info.entity]?.attributes?.device_class?n.secondary_info.entity:void 0),P=n.secondary_info?.entity,D=n.entity_amperage;return{showLabel:r,spacingTextAboveIcon:n.spacing_text_above_icon,spacingTextBelowIcon:n.spacing_text_below_icon,labelFontSize:s,labelSpacing:l,labelChipEnabled:d,labelChipOpacity:c,labelChipPaddingX:_,labelChipPaddingY:p,labelBorderRadius:u,labelBorderWidth:h,labelColor:m,labelColorMode:f,switchEntityId:g,switchState:y,socEntityId:I,secondaryEntityId:P,amperageEntityId:D,tapAction:n.tap_action,holdAction:n.hold_action,doubleTapAction:n.double_tap_action,tapMoreInfoTarget:n.tap_more_info_target,holdMoreInfoTarget:n.hold_more_info_target,doubleTapMoreInfoTarget:n.double_tap_more_info_target,tapMoreInfoEntity:n.tap_more_info_entity,holdMoreInfoEntity:n.hold_more_info_entity,doubleTapMoreInfoEntity:n.double_tap_more_info_entity,badgeEnabled:v,badgeStyle:w,badgePosition:$,badgeSize:S,badgeColorOn:F,badgeColorOff:C,badgePulse:A,badgeQuickToggle:k,badgeTapBehavior:E,badgeIcon:b.badgeIcon,badgeText:b.badgeText,secondaryInfoText:M}},ee=Ke(s.power,t,o,this._hass),te=Ke(Math.abs(l.power),t,o,this._hass),oe=Ke(Math.abs(d.power),t,o,this._hass),ie=Ke(m.homeConsumption,t,o,this._hass),ae=[];m.untrackedDevicesPower>T&&ae.push(`${wt("card.not_tracked",e)}: ${Ke(m.untrackedDevicesPower,0,o,this._hass).full}`),m.isHomeOverloaded&&ae.push(`⚠️ +${Ke(m.excessDevicesPower,0,o,this._hass).full}`),"unbalanced"===this._config.residual_handling&&m.unbalancedPower>T&&ae.push(`Residuo: ${Ke(m.unbalancedPower,0,o,this._hass).full}`);const ne=Boolean(this._config.solar?.icon),re=s.power<=T,se=n.enabled&&n.night_node_mode&&!r.isDay&&re;let le=this._config.solar?.icon||Ce,de=this._config.solar?.name||wt("card.solar",e),ce=Be(this._config.solar?.color,ve);se&&(ne||(le="mdi:weather-night"),de=this._config.solar?.name?`${this._config.solar.name} (Notte)`:`${wt("card.solar",e)} (Notte)`,ce=Be(this._config.solar?.color_idle,"var(--disabled-text-color, #94a3b8)"));const _e=[{id:"solar",label:de,icon:le,color:ce,value:ee.value,rawValue:s.power,unit:ee.unit,amperage:s.amperage,topInfo:void 0!==s.amperage?Xe(s.amperage,1,this._hass).full:void 0,isActive:s.power>T,isUnavailable:s.isUnavailable,x:z.solar.x,y:z.solar.y,radius:z.solar.radius,entityId:this._config.solar?.entity,styles:i,effects:a,isSecondary:!1,iconSize:i.icon_size_primary,...J(this._config.solar,this._config.solar?.entity,!0)},{id:"grid",label:this._config.grid?.name||wt("card.grid",e),icon:this._config.grid?.icon||Ae,color:Be(this._config.grid?.color,l.power>=0?we:$e),value:te.value,rawValue:l.power,unit:te.unit,extraValues:j,amperage:l.amperage,topInfo:void 0!==l.amperage?Xe(l.amperage,1,this._hass).full:void 0,isActive:Math.abs(l.power)>T,isUnavailable:l.isUnavailable,x:z.grid.x,y:z.grid.y,radius:z.grid.radius,entityId:this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export,styles:i,effects:a,isSecondary:!1,iconSize:i.icon_size_primary,...J(this._config.grid,this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export,!0)},{id:"battery",label:this._config.battery?.name||wt("card.battery",e),icon:this._config.battery?.icon||ke,color:B,value:oe.value,rawValue:d.power,unit:oe.unit,extraValues:Z,topInfo:d.soc||(void 0!==d.amperage?Xe(d.amperage,1,this._hass).full:void 0),socPercent:d.socPercent,amperage:d.amperage,isActive:Math.abs(d.power)>T,isUnavailable:d.isUnavailable,x:z.battery.x,y:z.battery.y,radius:z.battery.radius,entityId:this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge,styles:i,effects:a,isSecondary:!1,iconSize:i.icon_size_primary,...J(this._config.battery,this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge,!0)},{id:"home",label:this._config.home?.name||wt("card.home",e),icon:this._config.home?.icon||Me,color:Y,value:ie.value,rawValue:m.homeConsumption,unit:ie.unit,secondaryText:ae.length>0?ae.join(" | "):void 0,isActive:m.homeConsumption>T,isUnavailable:!!c.isConfigured&&c.isUnavailable,x:z.home.x,y:z.home.y,radius:z.home.radius,entityId:this._config.home?.entity,mixSegments:H,styles:i,effects:a,isSecondary:!1,iconSize:i.icon_size_primary,...J(this._config.home,this._config.home?.entity,!0)}];_.forEach(e=>{const n=z[e.id];if(n){const r=m.arcs.find(t=>t.id===`home-${e.id}`)?.value??e.power,s=Ke(r,t,o,this._hass);_e.push({id:e.id,label:e.name||e.id,icon:e.icon||Ee,color:Be(e.color,"var(--energy-device-color, #00bcd4)"),value:s.value,rawValue:r,unit:s.unit,topInfo:void 0!==e.ampere?Xe(e.ampere,1,this._hass).full:void 0,isActive:r>T,isUnavailable:!1,x:n.x,y:n.y,radius:n.radius,entityId:e.entityId,styles:i,effects:a,isSecondary:!0,isTertiary:!1,isSubDevice:!1,iconSize:i.icon_size_secondary,...J(e,e.entityId,!1)})}Array.isArray(e.sub_devices)&&e.sub_devices.forEach(n=>{const r=z[n.id];if(!r)return;const s=Math.max(0,n.power||0);if(!1===n.display_zero&&s<=T)return;const l=Ke(s,t,o,this._hass),d=Be(e.color,"var(--energy-device-color, #00bcd4)"),c=Be(n.color,d);_e.push({id:n.id,label:n.name||n.id,icon:n.icon||e.icon||Ee,color:c,value:l.value,rawValue:s,unit:l.unit,isActive:s>T,isUnavailable:!1,x:r.x,y:r.y,radius:r.radius,entityId:n.entityId,styles:i,effects:a,isSecondary:!1,isTertiary:!0,isSubDevice:!0,parentId:e.id,iconSize:n.sub_device_icon_size||i.icon_size_tertiary||13,...J(n,n.entityId,!1)})})});const pe={...be,...this._config.effects?.self_sufficiency||{}},ue={solar:ce,battery:Be(this._config.battery?.color_discharge,ze),grid:Be(this._config.grid?.color,we)},he=function(e,t,o,i=[]){if(t.entity_self_sufficiency&&e){const o=e.states[t.entity_self_sufficiency];if(o&&"unavailable"!==o.state&&"unknown"!==o.state){const e=parseFloat(o.state);if(!isNaN(e)){const t=Math.min(100,Math.max(0,Math.round(e)));return{percentage:t,totalEnergy:100,selfEnergy:t,segments:[],isEntityDriven:!0,unit:"%"}}}}let a=0,n=0,r=0,s=!1;if(Boolean(t.entity_solar_energy||t.entity_battery_energy_discharge||t.entity_grid_energy_import)&&e)a=At(e,t.entity_solar_energy),n=At(e,t.entity_battery_energy_discharge),r=At(e,t.entity_grid_energy_import),s=!0;else{const e=i.find(e=>"solar-home"===e.id)?.value||0,t=i.find(e=>"battery-home"===e.id)?.value||0,o=i.find(e=>"grid-home"===e.id)?.value||0;a=e,n=t,r=o}const l=a+n,d=l+r,c=d>0?Math.min(100,Math.max(0,Math.round(l/d*100))):100,_=t.radius??22,p=2*Math.PI*_,u=[{value:a,color:o.solar},{value:n,color:o.battery},{value:r,color:o.grid}],h=d>0?u.filter(e=>e.value>0).map(e=>({value:e.value,color:e.color,segLength:e.value/d*p})):[];return{percentage:c,totalEnergy:d,selfEnergy:l,segments:h,isEntityDriven:s,unit:s?"kWh":"W"}}(this._hass,pe,ue,m.arcs),me=function(e,t){if("vertical"===e)return{x:t.home?.x??t.solar?.x??220,y:t.grid?.y??t.battery?.y??175};return{x:t.solar?.x??t.battery?.x??175,y:t.home?.y??t.grid?.y??200}}(f,z);return q`
      <ha-card>
  ...
  `}(t,r,i)})})()}
            ...
            <!-- Layer 4: Nodes -->
            <g class="nodes-layer">
              ${_e.map(e=>function(e,t,o,i,a,n,r,s,l){const d=s||e.styles||{},c=l||e.effects||{},_=[e.secondaryText,e.secondaryInfoText].filter(Boolean).join(" - "),p=`${e.label}: ${e.value} ${e.unit}${_?` (${_})`:""}`,u=2*Math.PI*e.radius;let h=[];const m=!1!==d.show_home_mix_ring;if(m&&e.mixSegments&&e.mixSegments.length>0&&0!==(e.rawValue??0)){let t=0;h=e.mixSegments.map(o=>{const i=o.percentage*u,a=-t;return t+=i,V`
    ...
    <g class="node-group ${"off"===e.switchState?"node-is-off":""}"
      ...
      ${y?V`
        ${e.extraValues.map((t,o)=>{const i=0===o?k:E;return V`
          ...
          ${"icon"===e.badgeStyle?V`
            ...
            <foreignObject x="${(ve-Ce).toFixed(1)}" 
              ...
              <div xmlns="http://www.w3.org/1999/xhtml" style="width: ${Fe}px; height: ${Fe}px; display: flex; align-items: center; justify-content: center;">
                <ha-icon icon="${ke}" style="--mdc-icon-size: ${(.75*Fe).toFixed(1)}px; color: #ffffff; width: ${Fe}px; height: ${Fe}px; display: flex; align-items: center; justify-content: center;"></ha-icon>
              </div>
            </foreignObject>
          `:"text"===e.badgeStyle?V`
  ...
  `}(e,(e,t)=>this._gestureController.handlePointerDown(e,t),e=>this._gestureController.handlePointerMove(e),(e,t)=>this._gestureController.handlePointerUp(e,t),()=>this._gestureController.handlePointerCancel(),(e,t)=>this._handleBadgeClick(e,t),(e,t)=>this._handleNodeKeyDown(e,t),i,a))}
            ...
            ${(()=>{if(!n.enabled)return V``;const e=n.anchor||"home",t=z[e];if(!t)return V``;const o=function(e,t,o,i){const a=i.node_border_width||2.5,n=Math.min(i.hover_glow_radius||10,14),r=e.radius+a+n+8,s=e.radius+a+6;let l=r;for(const i of Object.keys(t)){if(i===o)continue;const a=t[i],n=a.x-e.x,r=a.y-e.y,d=Math.sqrt(n*n+r*r)-a.radius-12;if(d<s)return null;d<l&&(l=d)}return l}(t,z,e,i);return null===o?V``:V`
            ...
            ${pe.enabled?V`
              <g class="self-sufficiency-layer">
                ${function({config:e,data:t,center:o,lang:i}){if(!e.enabled)return V``;const a=e.radius??22,n=e.ring_width??3.2,r=2*Math.PI*a,s=e.show_glow??!0,l=e.show_ring??!0,d=e.label_style??"scope";let c=V``;s&&(c=e.glow_color?V`
    ...
    `);let p=V``;if("scope"===d){const t="total"===e.scope?wt("effects.self_sufficiency.scope_total",i)||"TOTALE":wt("effects.self_sufficiency.scope_today",i)||"OGGI";p=V`
      <text class="hub-label" x="${o.x}" y="${o.y+a+11}">${t}</text>
    `}else if("text"===d){const t=e.custom_label||wt("effects.self_sufficiency.default_label",i)||"AUTOSUFF.";p=V`
      <text class="hub-label" x="${o.x}" y="${o.y+a+11}">${t}</text>
    `}else if("icon"===d){const t=e.custom_icon||"mdi:leaf";p=V`
  ...
  `}({config:pe,data:he,center:me,lang:e})}
              </g>
            `:V``}
          </svg>
        </div>
    ...
    `}};function Pt(e){if(null!=e&&""!==e){if(Array.isArray(e))return e.map(e=>Pt(e)).filter(e=>null!=e);if("object"==typeof e){const t={};for(const[o,i]of Object.entries(e))if(null!=i&&""!==i)if("object"==typeof i){const e=Pt(i);void 0!==e&&(t[o]=e)}else t[o]=i;return t}return e}}function Dt(e){if(!e||"object"!=typeof e)return e;const t={...Pt(e)||{}};t.styles&&"object"==typeof t.styles&&(t.styles=dt(t.styles));const o=e=>{if(!e||"object"!=typeof e)return e;const t={...rt(e)};return"auto"===t.show_label&&delete t.show_label,"auto"===t.label_chip_enabled&&delete t.label_chip_enabled,"auto"===t.badge_enabled&&delete t.badge_enabled,Array.isArray(t.sub_devices)&&(t.sub_devices=t.sub_devices.map(e=>o(e))),t};if(t.solar&&(t.solar=o(t.solar)),t.grid&&(t.grid=o(t.grid)),t.battery&&(t.battery=o(t.battery)),t.home&&(t.home=o(t.home)),Array.isArray(t.devices)&&(t.devices=t.devices.map(e=>o(e))),t.styles&&"object"==typeof t.styles){const e={};let o=!1;for(const[i,a]of Object.entries(t.styles)){a!==fe[i]&&(e[i]=a,o=!0)}o?t.styles=e:delete t.styles}if(t.effects&&"object"==typeof t.effects){const e={};let o=!1;for(const[i,a]of Object.entries(t.effects))if(a&&"object"==typeof a){const t=ye[i]||{},n={};let r=!1;for(const[e,o]of Object.entries(a)){o!==t[e]&&(n[e]=o,r=!0)}r&&(e[i]=n,o=!0)}o?t.effects=e:delete t.effects}const i=new Set(["type","card_version","solar","grid","battery","home","devices","styles","effects"]);for(const[e,o]of Object.entries(t))if(!i.has(e)){const i=xe[e];void 0!==i&&o===i&&delete t[e]}return t}function Tt(e,t="en"){if(e.label)return e.label;const o=e.name;if(!o)return"";const i=`editor.${o}`,a=wt(i,t);if(a!==i)return a;const n=`editor.section.${o}`,r=wt(n,t);return r!==n?r:o}function Lt(e,t="en"){if(e.helper)return e.helper;const o=e.name;if(!o)return;const i=`editor.helper.${o}`,a=wt(i,t);return a!==i?a:void 0}function Ot(e="en"){return[{name:"title",selector:{text:{}}},{name:"layout_mode",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.layout_mode.auto",e)},{value:"horizontal",label:wt("editor.option.layout_mode.horizontal",e)},{value:"vertical",label:wt("editor.option.layout_mode.vertical",e)}]}}},{name:"auto_layout_breakpoint",selector:{number:{min:200,max:1200,step:10,unit_of_measurement:"px",mode:"slider"}}}]}function Nt(e,t="en",o){const i=[{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entity",selector:{entity:{domain:"sensor",device_class:"power"}}}];return"solar"===e?i.push({name:"color",selector:{ui_color:{default_color:"#ff9800"}}},{name:"invert",selector:{boolean:{}}}):"grid"===e?i.push({name:"entity_import",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"entity_export",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"color",selector:{ui_color:{default_color:"#f44336"}}},{name:"invert",selector:{boolean:{}}}):"battery"===e?(i.push({name:"entity_charge",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"entity_discharge",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"state_of_charge",selector:{entity:{domain:"sensor",device_class:"battery"}}},{name:"color_charge",selector:{ui_color:{default_color:"#4caf50"}}},{name:"color_discharge",selector:{ui_color:{default_color:"#9c27b0"}}},{name:"use_idle_color",selector:{boolean:{}}}),o?.use_idle_color&&i.push({name:"color_idle",selector:{ui_color:{default_color:"#94a3b8"}}}),i.push({name:"invert",selector:{boolean:{}}})):"home"===e&&i.push({name:"color",selector:{ui_color:{default_color:"#03a9f4"}}},{name:"invert",selector:{boolean:{}}}),i.push({name:"switch_entity",selector:{entity:{domain:["switch","light","fan","input_boolean","climate","water_heater","media_player","cover","lock","vacuum","humidifier"]}}},{name:"display_zero",selector:{boolean:{}}},{name:"display_zero_tolerance",selector:{number:{min:0,max:500,step:1,unit_of_measurement:"W"}}},{name:"show_label",selector:{boolean:{}}}),i.push({name:"badge",type:"expandable",title:wt("editor.section.badge",t),schema:[{name:"badge_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",t)},{value:"enabled",label:wt("editor.option.override.enabled",t)},{value:"disabled",label:wt("editor.option.override.disabled",t)}]}}},{name:"badge_style",selector:{select:{mode:"dropdown",options:[{value:"dot",label:wt("editor.option.badge_style.dot",t)},{value:"icon",label:wt("editor.option.badge_style.icon",t)},{value:"text",label:wt("editor.option.badge_style.text",t)}]}}},{name:"badge_position",selector:{select:{mode:"dropdown",options:[{value:"top_right",label:wt("editor.option.badge_position.top_right",t)},{value:"top_left",label:wt("editor.option.badge_position.top_left",t)},{value:"bottom_right",label:wt("editor.option.badge_position.bottom_right",t)},{value:"bottom_left",label:wt("editor.option.badge_position.bottom_left",t)}]}}},{name:"badge_size",selector:{number:{min:6,max:24,step:1,unit_of_measurement:"px"}}},{name:"badge_color_on",selector:{ui_color:{}}},{name:"badge_color_off",selector:{ui_color:{}}},{name:"badge_pulse",selector:{boolean:{}}},{name:"badge_quick_toggle",selector:{boolean:{}}},{name:"badge_tap_behavior",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.badge_tap_behavior.auto",t)},{value:"toggle",label:wt("editor.option.badge_tap_behavior.toggle",t)},{value:"more-info-switch",label:wt("editor.option.badge_tap_behavior.more_info_switch",t)},{value:"more-info-sensor",label:wt("editor.option.badge_tap_behavior.more_info_sensor",t)},{value:"more-info",label:wt("editor.option.badge_tap_behavior.more_info",t)}]}}}]}),i.push({name:"secondary_info",type:"expandable",title:wt("editor.section.secondary_info",t),schema:[{name:"entity",selector:{entity:{}}},{name:"decimals",selector:{number:{min:0,max:3,step:1}}},{name:"unit",selector:{text:{}}}]}),i.push({name:"label_chip",type:"expandable",title:wt("editor.section.label_chip",t),schema:[{name:"show_label",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",t)},{value:"enabled",label:wt("editor.option.override.enabled",t)},{value:"disabled",label:wt("editor.option.override.disabled",t)}]}}},{name:"spacing_text_above_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"spacing_text_below_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"label_font_size",selector:{number:{min:6,max:20,step:.5,unit_of_measurement:"px"}}},{name:"label_spacing_below_node",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"label_chip_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",t)},{value:"enabled",label:wt("editor.option.override.enabled",t)},{value:"disabled",label:wt("editor.option.override.disabled",t)}]}}},{name:"label_chip_opacity",selector:{number:{min:0,max:1,step:.05}}},{name:"label_chip_padding_x",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_chip_padding_y",selector:{number:{min:0,max:15,step:.5,unit_of_measurement:"px"}}},{name:"label_border_radius",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_border_width",selector:{number:{min:0,max:4,step:.5,unit_of_measurement:"px"}}},{name:"label_color_mode",selector:{select:{mode:"dropdown",options:[{value:"auto_contrast",label:wt("editor.option.label_color_mode.auto_contrast",t)},{value:"white",label:wt("editor.option.label_color_mode.white",t)},{value:"black",label:wt("editor.option.label_color_mode.black",t)},{value:"match_entity",label:wt("editor.option.label_color_mode.match_entity",t)},{value:"secondary",label:wt("editor.option.label_color_mode.secondary",t)},{value:"custom",label:wt("editor.option.label_color_mode.custom",t)}]}}},{name:"label_color",selector:{ui_color:{}}}]}),i.push({name:"actions",type:"expandable",title:wt("editor.section.actions",t),schema:[{name:"tap_action",selector:{ui_action:{}}},{name:"tap_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",t)},{value:"soc",label:wt("editor.option.more_info_target.soc",t)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",t)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",t)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",t)},{value:"switch",label:wt("editor.option.more_info_target.switch",t)},{value:"custom",label:wt("editor.option.more_info_target.custom",t)}]}}},{name:"tap_more_info_entity",selector:{entity:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"hold_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",t)},{value:"soc",label:wt("editor.option.more_info_target.soc",t)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",t)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",t)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",t)},{value:"switch",label:wt("editor.option.more_info_target.switch",t)},{value:"custom",label:wt("editor.option.more_info_target.custom",t)}]}}},{name:"hold_more_info_entity",selector:{entity:{}}},{name:"double_tap_action",selector:{ui_action:{}}},{name:"double_tap_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",t)},{value:"soc",label:wt("editor.option.more_info_target.soc",t)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",t)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",t)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",t)},{value:"switch",label:wt("editor.option.more_info_target.switch",t)},{value:"custom",label:wt("editor.option.more_info_target.custom",t)}]}}},{name:"double_tap_more_info_entity",selector:{entity:{}}}]}),i}function Ut(e="en"){return[{name:"node_dimensions",type:"expandable",title:wt("editor.section.node_dimensions",e),schema:[{name:"node_radius_primary",selector:{number:{min:10,max:60,step:1,unit_of_measurement:"px"}}},{name:"node_radius_secondary",selector:{number:{min:8,max:50,step:1,unit_of_measurement:"px"}}},{name:"node_radius_tertiary",selector:{number:{min:8,max:40,step:1,unit_of_measurement:"px"}}},{name:"icon_size_primary",selector:{number:{min:10,max:50,step:1,unit_of_measurement:"px"}}},{name:"icon_size_secondary",selector:{number:{min:8,max:40,step:1,unit_of_measurement:"px"}}},{name:"icon_size_tertiary",selector:{number:{min:6,max:30,step:1,unit_of_measurement:"px"}}},{name:"node_border_width",selector:{number:{min:.5,max:10,step:.5,unit_of_measurement:"px"}}},{name:"sub_device_border_width",selector:{number:{min:.5,max:6,step:.5,unit_of_measurement:"px"}}}]},{name:"shadows",type:"expandable",title:wt("editor.section.shadows",e),schema:[{name:"show_node_shadows",selector:{boolean:{}}},{name:"hover_glow_radius",selector:{number:{min:0,max:60,step:1,unit_of_measurement:"px"}}},{name:"node_shadow_color",selector:{ui_color:{}}},{name:"node_shadow_blur",selector:{number:{min:0,max:40,step:1,unit_of_measurement:"px"}}},{name:"node_shadow_spread",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"node_shadow_offset_y",selector:{number:{min:-20,max:30,step:1,unit_of_measurement:"px"}}}]},{name:"typography",type:"expandable",title:wt("editor.section.typography",e),schema:[{name:"font_size_primary",selector:{number:{min:8,max:28,step:.5,unit_of_measurement:"px"}}},{name:"font_size_secondary",selector:{number:{min:6,max:22,step:.5,unit_of_measurement:"px"}}},{name:"font_size_unit",selector:{number:{min:5,max:18,step:.5,unit_of_measurement:"px"}}},{name:"font_size_extra",selector:{number:{min:6,max:18,step:.5,unit_of_measurement:"px"}}},{name:"font_size_sub",selector:{number:{min:6,max:18,step:.5,unit_of_measurement:"px"}}},{name:"font_size_top_info",selector:{number:{min:6,max:18,step:.5,unit_of_measurement:"px"}}},{name:"spacing_text_above_icon",selector:{number:{min:0,max:30,step:.5,unit_of_measurement:"px"}}},{name:"spacing_text_below_icon",selector:{number:{min:0,max:30,step:.5,unit_of_measurement:"px"}}}]},{name:"labels",type:"expandable",title:wt("editor.section.labels",e),schema:[{name:"show_labels",selector:{boolean:{}}},{name:"font_size_label",selector:{number:{min:6,max:22,step:.5,unit_of_measurement:"px"}}},{name:"spacing_label_below_node",selector:{number:{min:2,max:40,step:1,unit_of_measurement:"px"}}},{name:"label_color_mode",selector:{select:{mode:"dropdown",options:[{value:"auto_contrast",label:wt("editor.option.label_color_mode.auto_contrast",e)},{value:"white",label:wt("editor.option.label_color_mode.white",e)},{value:"black",label:wt("editor.option.label_color_mode.black",e)},{value:"match_entity",label:wt("editor.option.label_color_mode.match_entity",e)},{value:"secondary",label:wt("editor.option.label_color_mode.secondary",e)},{value:"custom",label:wt("editor.option.label_color_mode.custom",e)}]}}},{name:"label_color",selector:{ui_color:{}}},{name:"label_chip_enabled",selector:{boolean:{}}},{name:"label_chip_opacity",selector:{number:{min:.05,max:1,step:.05,mode:"slider"}}},{name:"label_chip_padding_x",selector:{number:{min:2,max:25,step:1,unit_of_measurement:"px"}}},{name:"label_chip_padding_y",selector:{number:{min:1,max:15,step:.5,unit_of_measurement:"px"}}},{name:"label_border_radius",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_border_width",selector:{number:{min:0,max:4,step:.5,unit_of_measurement:"px"}}}]},{name:"home_ring",type:"expandable",title:wt("editor.section.home_ring",e),schema:[{name:"show_home_mix_ring",selector:{boolean:{}}},{name:"home_glow_mode",selector:{select:{mode:"dropdown",options:[{value:"predominant",label:wt("editor.option.home_glow_mode.predominant",e)},{value:"custom",label:wt("editor.option.home_glow_mode.custom",e)}]}}}]},{name:"cables_and_bus",type:"expandable",title:wt("editor.section.cables_and_bus",e),schema:[{name:"line_routing_mode",selector:{select:{mode:"dropdown",options:[{value:"bezier_curved",label:wt("editor.option.line_routing_mode.bezier_curved",e)},{value:"orthogonal_bus",label:wt("editor.option.line_routing_mode.orthogonal_bus",e)}]}}},{name:"bus_lane_spacing",selector:{number:{min:2,max:30,step:1,unit_of_measurement:"px"}}},{name:"bus_corner_radius",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"invert_bus_lane_order",selector:{boolean:{}}},{name:"spacing_horizontal",selector:{number:{min:10,max:250,step:2,unit_of_measurement:"px"}}},{name:"spacing_vertical",selector:{number:{min:10,max:250,step:2,unit_of_measurement:"px"}}},{name:"sub_device_spacing_x",selector:{number:{min:10,max:200,step:2,unit_of_measurement:"px"}}},{name:"sub_device_spacing_y",selector:{number:{min:10,max:150,step:2,unit_of_measurement:"px"}}}]},{name:"wires",type:"expandable",title:wt("editor.section.wires",e),schema:[{name:"stroke_mode",selector:{select:{mode:"dropdown",options:[{value:"watt",label:wt("editor.option.stroke_mode.watt",e)},{value:"fixed",label:wt("editor.option.stroke_mode.fixed",e)},{value:"amperage",label:wt("editor.option.stroke_mode.amperage",e)}]}}},{name:"min_stroke",selector:{number:{min:.5,max:10,step:.5,unit_of_measurement:"px"}}},{name:"max_stroke",selector:{number:{min:1,max:20,step:.5,unit_of_measurement:"px"}}},{name:"inactive_wire_style",selector:{select:{mode:"dropdown",options:[{value:"dashed",label:wt("editor.option.inactive_wire_style.dashed",e)},{value:"solid",label:wt("editor.option.inactive_wire_style.solid",e)},{value:"hidden",label:wt("editor.option.inactive_wire_style.hidden",e)}]}}},{name:"inactive_wire_opacity",selector:{number:{min:0,max:1,step:.05,mode:"slider"}}}]},{name:"particle_dynamics",type:"expandable",title:wt("editor.section.particle_dynamics",e),schema:[{name:"speed_mode",selector:{select:{mode:"dropdown",options:[{value:"absolute",label:wt("editor.option.speed_mode.absolute",e)},{value:"relative",label:wt("editor.option.speed_mode.relative",e)}]}}},{name:"normalize_speed_by_length",selector:{boolean:{}}},{name:"min_duration",selector:{number:{min:.2,max:5,step:.1,unit_of_measurement:"s"}}},{name:"max_duration",selector:{number:{min:1,max:20,step:.1,unit_of_measurement:"s"}}}]},{name:"particles",type:"expandable",title:wt("editor.section.particles",e),schema:[{name:"particles_per_arc",selector:{number:{min:1,max:10,step:1}}},{name:"max_total_particles",selector:{number:{min:5,max:100,step:1}}},{name:"particle_size_offset",selector:{number:{min:-5,max:10,step:.5,unit_of_measurement:"px"}}},{name:"particle_inner_glow",selector:{boolean:{}}},{name:"particle_soft_edge",selector:{boolean:{}}}]}]}function Rt(e="en"){return[{name:"meteor_trail",type:"expandable",title:wt("editor.section.meteor_trail",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"tail_length",selector:{number:{min:2,max:20,step:1}}},{name:"glow_intensity",selector:{number:{min:.1,max:2,step:.1,mode:"slider"}}}]},{name:"living_icons",type:"expandable",title:wt("editor.section.living_icons",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"battery_type",selector:{select:{mode:"dropdown",options:[{value:"gradient",label:wt("editor.option.battery_type.gradient",e)},{value:"liquid",label:wt("editor.option.battery_type.liquid",e)}]}}},{name:"battery_animated",selector:{boolean:{}}},{name:"load_animation",selector:{select:{mode:"dropdown",options:[{value:"rotate",label:wt("editor.option.load_animation.rotate",e)},{value:"pulse",label:wt("editor.option.load_animation.pulse",e)},{value:"none",label:wt("editor.option.load_animation.none",e)}]}}}]},{name:"glassmorphism",type:"expandable",title:wt("editor.section.glassmorphism",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"intensity",selector:{number:{min:.05,max:1,step:.05,mode:"slider"}}},{name:"neon_core",selector:{boolean:{}}}]},{name:"impact_ripples",type:"expandable",title:wt("editor.section.impact_ripples",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"ripple_size",selector:{number:{min:5,max:50,step:1,unit_of_measurement:"px"}}},{name:"ripple_color",selector:{ui_color:{}}}]},{name:"celestial_tracker",type:"expandable",title:wt("editor.section.celestial_tracker",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"dial_24h",label:wt("editor.option.celestial_mode.dial_24h",e)},{value:"semicircle",label:wt("editor.option.celestial_mode.semicircle",e)}]}}},{name:"anchor",selector:{select:{mode:"dropdown",options:[{value:"home",label:wt("editor.option.celestial_anchor.home",e)},{value:"solar",label:wt("editor.option.celestial_anchor.solar",e)}]}}},{name:"weather_entity",selector:{entity:{domain:"weather"}}},{name:"show_markers",selector:{boolean:{}}},{name:"show_marker_icons",selector:{boolean:{}}},{name:"sunrise_icon",selector:{icon:{}}},{name:"sunset_icon",selector:{icon:{}}},{name:"show_rays",selector:{boolean:{}}},{name:"show_tail",selector:{boolean:{}}},{name:"show_stars",selector:{boolean:{}}},{name:"night_node_mode",selector:{boolean:{}}}]},{name:"self_sufficiency",type:"expandable",title:wt("editor.section.self_sufficiency",e),schema:[{name:"enabled",selector:{boolean:{}}},{name:"scope",selector:{select:{mode:"dropdown",options:[{value:"today",label:wt("editor.option.self_sufficiency_scope.today",e)},{value:"total",label:wt("editor.option.self_sufficiency_scope.total",e)}]}}},{name:"label_style",selector:{select:{mode:"dropdown",options:[{value:"scope",label:wt("editor.option.self_sufficiency_label_style.scope",e)},{value:"text",label:wt("editor.option.self_sufficiency_label_style.text",e)},{value:"icon",label:wt("editor.option.self_sufficiency_label_style.icon",e)},{value:"none",label:wt("editor.option.self_sufficiency_label_style.none",e)}]}}},{name:"radius",selector:{number:{min:10,max:50,step:1,unit_of_measurement:"px",mode:"slider"}}},{name:"show_ring",selector:{boolean:{}}},{name:"ring_width",selector:{number:{min:.5,max:10,step:.5,unit_of_measurement:"px",mode:"slider"}}},{name:"show_glow",selector:{boolean:{}}},{name:"glow_color",selector:{ui_color:{}}},{name:"custom_label",selector:{text:{}}},{name:"custom_icon",selector:{icon:{}}},{name:"entity_solar_energy",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"entity_battery_energy_discharge",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"entity_grid_energy_import",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"entity_home_energy",selector:{entity:{domain:"sensor",device_class:"energy"}}},{name:"entity_self_sufficiency",selector:{entity:{domain:"sensor"}}}]}]}function Wt(e="en",t){const o=[{name:"decimals",selector:{number:{min:0,max:3,step:1}}},{name:"w_to_kw_threshold",selector:{number:{min:100,max:1e4,step:50,unit_of_measurement:"W"}}},{name:"scale_curve",selector:{select:{mode:"dropdown",options:[{value:"sqrt",label:wt("editor.option.scale_curve.sqrt",e)},{value:"linear",label:wt("editor.option.scale_curve.linear",e)},{value:"log",label:wt("editor.option.scale_curve.log",e)}]}}},{name:"scale_min",selector:{number:{min:0,max:5e3,step:10,unit_of_measurement:"W"}}},{name:"scale_max",selector:{number:{min:500,max:5e4,step:100,unit_of_measurement:"W"}}},{name:"smoothing_factor",selector:{number:{min:.05,max:1,step:.05,mode:"slider"}}},{name:"display_zero_tolerance",selector:{number:{min:0,max:50,step:.5,unit_of_measurement:"W"}}},{name:"residual_handling",selector:{select:{mode:"dropdown",options:[{value:"clamp",label:wt("editor.option.residual_handling.clamp",e)},{value:"absorb",label:wt("editor.option.residual_handling.absorb",e)},{value:"unbalanced",label:wt("editor.option.residual_handling.unbalanced",e)}]}}}];return"absorb"===t?.residual_handling&&o.push({name:"residual_absorb_target",selector:{select:{mode:"dropdown",options:[{value:"grid",label:wt("editor.option.residual_absorb_target.grid",e)},{value:"battery",label:wt("editor.option.residual_absorb_target.battery",e)}]}}}),o}function Bt(e="en"){return[{name:"id",selector:{text:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entity",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"switch_entity",selector:{entity:{domain:["switch","light","fan","input_boolean","climate","water_heater","media_player","cover","lock","vacuum","humidifier"]}}},{name:"entity_amperage",selector:{entity:{domain:"sensor",device_class:"current"}}},{name:"color",selector:{ui_color:{default_color:"#00bcd4"}}},{name:"include_in_home",selector:{boolean:{}}},{name:"invert",selector:{boolean:{}}},{name:"display_zero",selector:{boolean:{}}},{name:"display_zero_tolerance",selector:{number:{min:0,max:500,step:1,unit_of_measurement:"W"}}},{name:"secondary_info",type:"expandable",title:wt("editor.section.secondary_info",e),schema:[{name:"entity",selector:{entity:{}}},{name:"unit",selector:{text:{}}},{name:"decimals",selector:{number:{min:0,max:3,step:1}}}]},{name:"badge",type:"expandable",title:wt("editor.section.badge",e),schema:[{name:"badge_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"badge_style",selector:{select:{mode:"dropdown",options:[{value:"dot",label:wt("editor.option.badge_style.dot",e)},{value:"icon",label:wt("editor.option.badge_style.icon",e)},{value:"text",label:wt("editor.option.badge_style.text",e)}]}}},{name:"badge_position",selector:{select:{mode:"dropdown",options:[{value:"top_right",label:wt("editor.option.badge_position.top_right",e)},{value:"top_left",label:wt("editor.option.badge_position.top_left",e)},{value:"bottom_right",label:wt("editor.option.badge_position.bottom_right",e)},{value:"bottom_left",label:wt("editor.option.badge_position.bottom_left",e)}]}}},{name:"badge_size",selector:{number:{min:6,max:30,step:1,unit_of_measurement:"px",mode:"slider"}}},{name:"badge_color_on",selector:{ui_color:{default_color:"#4caf50"}}},{name:"badge_color_off",selector:{ui_color:{default_color:"#64748b"}}},{name:"badge_pulse",selector:{boolean:{}}},{name:"badge_quick_toggle",selector:{boolean:{}}},{name:"badge_tap_behavior",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.badge_tap_behavior.auto",e)},{value:"toggle",label:wt("editor.option.badge_tap_behavior.toggle",e)},{value:"more-info-switch",label:wt("editor.option.badge_tap_behavior.more_info_switch",e)},{value:"more-info-sensor",label:wt("editor.option.badge_tap_behavior.more_info_sensor",e)},{value:"more-info",label:wt("editor.option.badge_tap_behavior.more_info",e)}]}}}]},{name:"label_chip",type:"expandable",title:wt("editor.section.label_chip",e),schema:[{name:"show_label",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"spacing_text_above_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"spacing_text_below_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"label_font_size",selector:{number:{min:6,max:25,step:.5,unit_of_measurement:"px"}}},{name:"label_spacing_below_node",selector:{number:{min:2,max:40,step:1,unit_of_measurement:"px"}}},{name:"label_chip_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"label_chip_opacity",selector:{number:{min:.05,max:1,step:.05,mode:"slider"}}},{name:"label_chip_padding_x",selector:{number:{min:2,max:25,step:1,unit_of_measurement:"px"}}},{name:"label_chip_padding_y",selector:{number:{min:1,max:15,step:.5,unit_of_measurement:"px"}}},{name:"label_border_radius",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_border_width",selector:{number:{min:0,max:4,step:.5,unit_of_measurement:"px"}}},{name:"label_color_mode",selector:{select:{mode:"dropdown",options:[{value:"auto_contrast",label:wt("editor.option.label_color_mode.auto_contrast",e)},{value:"white",label:wt("editor.option.label_color_mode.white",e)},{value:"black",label:wt("editor.option.label_color_mode.black",e)},{value:"match_entity",label:wt("editor.option.label_color_mode.match_entity",e)},{value:"secondary",label:wt("editor.option.label_color_mode.secondary",e)},{value:"custom",label:wt("editor.option.label_color_mode.custom",e)}]}}},{name:"label_color",selector:{ui_color:{}}}]},{name:"actions",type:"expandable",title:wt("editor.section.actions",e),schema:[{name:"tap_action",selector:{ui_action:{}}},{name:"tap_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",e)},{value:"soc",label:wt("editor.option.more_info_target.soc",e)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",e)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",e)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",e)},{value:"switch",label:wt("editor.option.more_info_target.switch",e)},{value:"custom",label:wt("editor.option.more_info_target.custom",e)}]}}},{name:"tap_more_info_entity",selector:{entity:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"hold_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",e)},{value:"soc",label:wt("editor.option.more_info_target.soc",e)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",e)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",e)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",e)},{value:"switch",label:wt("editor.option.more_info_target.switch",e)},{value:"custom",label:wt("editor.option.more_info_target.custom",e)}]}}},{name:"hold_more_info_entity",selector:{entity:{}}},{name:"double_tap_action",selector:{ui_action:{}}},{name:"double_tap_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",e)},{value:"soc",label:wt("editor.option.more_info_target.soc",e)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",e)},{value:"secondary",label:wt("editor.option.more_info_target.secondary",e)},{value:"amperage",label:wt("editor.option.more_info_target.amperage",e)},{value:"switch",label:wt("editor.option.more_info_target.switch",e)},{value:"custom",label:wt("editor.option.more_info_target.custom",e)}]}}},{name:"double_tap_more_info_entity",selector:{entity:{}}}]}]}function Gt(e="en"){return[{name:"id",selector:{text:{}}},{name:"name",selector:{text:{}}},{name:"icon",selector:{icon:{}}},{name:"entity",selector:{entity:{domain:"sensor",device_class:"power"}}},{name:"switch_entity",selector:{entity:{domain:["switch","light","fan","input_boolean","climate","water_heater","media_player","cover","lock","vacuum","humidifier"]}}},{name:"entity_amperage",selector:{entity:{domain:"sensor",device_class:"current"}}},{name:"color",selector:{ui_color:{default_color:"#00bcd4"}}},{type:"grid",name:"",schema:[{name:"include_in_parent",selector:{boolean:{}}},{name:"include_in_home",selector:{boolean:{}}}]},{type:"grid",name:"",schema:[{name:"distance_x",selector:{number:{min:-150,max:200,step:1,mode:"box"}}},{name:"distance_y",selector:{number:{min:-150,max:150,step:1,mode:"box"}}}]},{type:"grid",name:"",schema:[{name:"sub_device_radius",selector:{number:{min:14,max:36,step:1,mode:"box"}}},{name:"sub_device_icon_size",selector:{number:{min:8,max:24,step:1,mode:"box"}}}]},{type:"grid",name:"",schema:[{name:"display_zero",selector:{boolean:{}}},{name:"display_zero_tolerance",selector:{number:{min:0,max:100,step:1,mode:"box"}}}]},{name:"badge",type:"expandable",title:wt("editor.section.badge",e),schema:[{name:"badge_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"badge_style",selector:{select:{mode:"dropdown",options:[{value:"dot",label:wt("editor.option.badge_style.dot",e)},{value:"icon",label:wt("editor.option.badge_style.icon",e)},{value:"text",label:wt("editor.option.badge_style.text",e)}]}}},{name:"badge_position",selector:{select:{mode:"dropdown",options:[{value:"top_right",label:wt("editor.option.badge_position.top_right",e)},{value:"top_left",label:wt("editor.option.badge_position.top_left",e)},{value:"bottom_right",label:wt("editor.option.badge_position.bottom_right",e)},{value:"bottom_left",label:wt("editor.option.badge_position.bottom_left",e)}]}}},{name:"badge_size",selector:{number:{min:6,max:20,step:1,unit_of_measurement:"px",mode:"slider"}}},{name:"badge_color_on",selector:{ui_color:{default_color:"#4caf50"}}},{name:"badge_color_off",selector:{ui_color:{default_color:"#64748b"}}},{name:"badge_pulse",selector:{boolean:{}}},{name:"badge_quick_toggle",selector:{boolean:{}}}]},{name:"label_chip",type:"expandable",title:wt("editor.section.label_chip",e),schema:[{name:"show_label",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"spacing_text_above_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"spacing_text_below_icon",selector:{number:{min:0,max:30,step:1,unit_of_measurement:"px"}}},{name:"label_font_size",selector:{number:{min:6,max:20,step:.5,unit_of_measurement:"px"}}},{name:"label_spacing_below_node",selector:{number:{min:2,max:40,step:1,unit_of_measurement:"px"}}},{name:"label_chip_enabled",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.override.auto",e)},{value:"enabled",label:wt("editor.option.override.enabled",e)},{value:"disabled",label:wt("editor.option.override.disabled",e)}]}}},{name:"label_chip_opacity",selector:{number:{min:.05,max:1,step:.05,mode:"slider"}}},{name:"label_chip_padding_x",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_chip_padding_y",selector:{number:{min:0,max:15,step:.5,unit_of_measurement:"px"}}},{name:"label_border_radius",selector:{number:{min:0,max:20,step:1,unit_of_measurement:"px"}}},{name:"label_border_width",selector:{number:{min:0,max:4,step:.5,unit_of_measurement:"px"}}},{name:"label_color_mode",selector:{select:{mode:"dropdown",options:[{value:"auto_contrast",label:wt("editor.option.label_color_mode.auto_contrast",e)},{value:"white",label:wt("editor.option.label_color_mode.white",e)},{value:"black",label:wt("editor.option.label_color_mode.black",e)},{value:"match_entity",label:wt("editor.option.label_color_mode.match_entity",e)},{value:"secondary",label:wt("editor.option.label_color_mode.secondary",e)},{value:"custom",label:wt("editor.option.label_color_mode.custom",e)}]}}},{name:"label_color",selector:{ui_color:{}}}]},{name:"actions",type:"expandable",title:wt("editor.section.actions",e),schema:[{name:"tap_action",selector:{ui_action:{}}},{name:"tap_more_info_target",selector:{select:{mode:"dropdown",options:[{value:"auto",label:wt("editor.option.more_info_target.auto",e)},{value:"sensor",label:wt("editor.option.more_info_target.sensor",e)},{value:"switch",label:wt("editor.option.more_info_target.switch",e)},{value:"custom",label:wt("editor.option.more_info_target.custom",e)}]}}},{name:"tap_more_info_entity",selector:{entity:{}}},{name:"hold_action",selector:{ui_action:{}}},{name:"double_tap_action",selector:{ui_action:{}}}]}]}e([he({attribute:!1})],It.prototype,"_config",void 0),e([me()],It.prototype,"_actualLayout",void 0),It=e([_e("simple-power-flow-card")],It),window.customCards=window.customCards||[],window.customCards.push({type:"simple-power-flow-card",name:"Simple Power Flow Card",description:"An elegant, adaptive power flow card with intelligent Bezier routing and RAF Particle Engine.",preview:!0,documentationURL:"https://github.com/ale8730/simple-power-flow-card"});let qt=class extends de{constructor(){super(...arguments),this.devices=[],this.lang="en",this._expandedIndex=null,this._expandedSubKey=null}static{this.styles=r`
    :host {
      display: block;
      margin-top: 8px;
    }
              ...
              >
                <div slot="header" class="panel-header">
                  <div class="panel-title">
                    ...
                    <span>${o.name||o.id||`${wt("editor.device_default_name",this.lang)} ${i+1}`}</span>
                ...
                <div class="panel-content">
                  ...
                  <ha-form
                    ...
                    .data=${st(o)}
                    .schema=${e}
                    .computeLabel=${e=>Tt(e,this.lang)}
                    .computeHelper=${e=>Lt(e,this.lang)}
                  ...
                  <div class="subdevices-section">
                    <div class="subdevices-header">
                      <div class="subdevices-title-container">
                        ...
                        <span class="subdevices-title">${wt("editor.sub_devices_section",this.lang)}</span>
                        ${r.length>0?q`<span class="sub-count-badge">${r.length}</span>`:""}
                      </div>
                      <mwc-button dense @click=${()=>this._handleAddSubDevice(i)}>
                        <ha-icon icon="mdi:plus" slot="icon"></ha-icon>
                        ${wt("editor.add_sub_device",this.lang)}
                      </mwc-button>
                    </div>

                    ${r.length>0?q`
                      <div class="subdevices-list">
                        ${r.map((e,a)=>{const n=`${i}-${a}`,s=this._expandedSubKey===n,l=this._validateSubId(e.id,i,a),d=e.color||o.color||"#00bcd4";return q`
                              ...
                              >
                                <div slot="header" class="panel-header subpanel-header">
                                  <div class="panel-title subpanel-title">
                                    ...
                                    <span>${e.name||e.id||`${wt("editor.sub_device_default_name",this.lang)} ${a+1}`}</span>
                                    <span
                    ...
                    `:q`
                      <div class="subdevices-empty">
                        ${wt("editor.no_sub_devices",this.lang)}
                      </div>
                    `}
                  </div>
                </div>
  ...
  `}setConfig(e){const t=dt(e.styles||{});this._config={...xe,...e,styles:{...fe,...t},effects:ct(e.effects)}}async firstUpdated(){await Vt(),this._componentsLoaded=!0}get _lang(){return this.hass?.language||this.hass?.locale?.language||"en"}_toggleSection(e,t){t?this._openSection=e:this._openSection===e&&(this._openSection=null)}_handleGeneralChanged(e){e.stopPropagation();const t={...this._config,...e.detail.value};this._fireConfigChanged(t)}_handleNodeChanged(e,t){t.stopPropagation();const o=lt(t.detail.value),i=rt(this._config[e]||{}),a={...this._config,[e]:{...i,...o}};this._fireConfigChanged(a)}_handleDevicesChanged(e){e.stopPropagation();const t={...this._config,devices:e.detail.devices};this._fireConfigChanged(t)}_handleStylesChanged(e){e.stopPropagation();const t=function(e){if(!e)return{};const{node_dimensions:t,shadows:o,typography:i,labels:a,label_chip:n,home_ring:r,cables_and_bus:s,wires:l,particle_dynamics:d,particles:c,energy_mix:_,bus_routing:p,layout_spacing:u,...h}=e;return dt({...h,...t||{},...o||{},...i||{},...a||{},...n||{},...r||{},...s||{},...l||{},...d||{},...c||{},..._||{},...p||{},...u||{}})}(e.detail.value),o={...dt(this._config.styles||{},this._config),...t},i={...this._config,stroke_mode:o.stroke_mode??this._config.stroke_mode,speed_mode:o.speed_mode??this._config.speed_mode,min_stroke:o.min_stroke??this._config.min_stroke,max_stroke:o.max_stroke??this._config.max_stroke,min_duration:o.min_duration??this._config.min_duration,max_duration:o.max_duration??this._config.max_duration,max_total_particles:o.max_total_particles??this._config.max_total_particles,normalize_speed_by_length:o.normalize_speed_by_length??this._config.normalize_speed_by_length,styles:o};this._fireConfigChanged(i)}_handleEffectsChanged(e){e.stopPropagation();const t={...this._config,effects:e.detail.value};this._fireConfigChanged(t)}_handleAdvancedChanged(e){e.stopPropagation();const t={...this._config,...e.detail.value};this._fireConfigChanged(t)}_fireConfigChanged(e){const t=dt(e.styles||{},e);this._config={...xe,...e,stroke_mode:t.stroke_mode??e.stroke_mode,speed_mode:t.speed_mode??e.speed_mode,min_stroke:t.min_stroke??e.min_stroke,max_stroke:t.max_stroke??e.max_stroke,min_duration:t.min_duration??e.min_duration,max_duration:t.max_duration??e.max_duration,max_total_particles:t.max_total_particles??e.max_total_particles,normalize_speed_by_length:t.normalize_speed_by_length??e.normalize_speed_by_length,styles:{...fe,...t},effects:ct(e.effects)};const o=Dt(e);this.dispatchEvent(new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:o}}))}render(){if(!this._config||!this.hass)return q``;const e=this._lang;return q`
      <div class="card-config">
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.general",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              ...
              .data=${this._config}
              .schema=${Ot(e)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.solar",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
              .data=${st(this._config.solar||{})}
              .schema=${Nt("solar",e,this._config.solar)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.grid",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
              .data=${st(this._config.grid||{})}
              .schema=${Nt("grid",e,this._config.grid)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.battery",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
              .data=${st(this._config.battery||{})}
              .schema=${Nt("battery",e,this._config.battery)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.home",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
              .data=${st(this._config.home||{})}
              .schema=${Nt("home",e,this._config.home)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.devices",e)} (${(this._config.devices||[]).length})</span>
          </div>
          <div class="section-content">
            <spfc-device-list
              .hass=${this.hass}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.effects",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
        ...
        >
          <div slot="header" class="section-header">
            ...
            <span>${wt("editor.section.advanced",e)}</span>
          </div>
          <div class="section-content">
            <ha-form
              .hass=${this.hass}
              .data=${this._config}
              .schema=${Wt(e,this._config)}
              .computeLabel=${t=>Tt(t,e)}
              .computeHelper=${t=>Lt(t,e)}
    ...
    `}};e([he({attribute:!1})],Ht.prototype,"hass",void 0),e([me()],Ht.prototype,"_config",void 0),e([me()],Ht.prototype,"_componentsLoaded",void 0),e([me()],Ht.prototype,"_openSection",void 0),Ht=e([_e("simple-power-flow-card-editor")],Ht);var jt=Object.freeze({__proto__:null,get SimplePowerFlowCardEditor(){return Ht},get SpfcDeviceList(){return qt},computeHelper:Lt,computeLabel:Tt,getAdvancedSchema:Wt,getDeviceSchema:Bt,getEffectsSchema:Rt,getGeneralSchema:Ot,getNodeSchema:Nt,getStylesSchema:Ut,getSubDeviceSchema:Gt,loadHaComponents:Vt});console.info("%c SIMPLE-POWER-FLOW-CARD %c v1.0.0 ","color: white; background: #0284c7; font-weight: 700; border-radius: 4px 0 0 4px; padding: 2px 6px;","color: #0284c7; background: #e0f2fe; font-weight: 700; border-radius: 0 4px 4px 0; padding: 2px 6px;");export{It as SimplePowerFlowCard};
