...
`;function Fe(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const i=t.replace(",",".").replace(/[^0-9.-]/g,""),o=parseFloat(i);return Number.isFinite(o)?o:null}function ze(e,t){if(!(e&&t&&e.states&&e.states[t]))return{value:0,rawState:"",unit:"",isUnavailable:!0,isUnknown:!1,isValid:!1};const i=e.states[t],o=i.state,r=i.attributes?.unit_of_measurement||"W";if("unavailable"===o)return{value:0,rawState:o,unit:r,isUnavailable:!0,isUnknown:!1,isValid:!1};if("unknown"===o)return{value:0,rawState:o,unit:r,isUnavailable:!1,isUnknown:!0,isValid:!1};const a=Fe(o);if(null===a)return{value:0,rawState:o,unit:r,isUnavailable:!1,isUnknown:!0,isValid:!1};return{value:function(e,t){switch(t.trim()){case"kW":case"kVA":case"kvar":return 1e3*e;case"MW":case"MVA":return 1e6*e;case"W":case"VA":case"var":case"A":default:return e;case"mW":case"mA":return.001*e}}(a,r),rawState:o,unit:r,isUnavailable:!1,isUnknown:!1,isValid:!0}}function Pe(e,t,i="solar"){if(!t)return{power:0,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};const o=t.entity_import||("grid"===i?t.entity_in:void 0),r=t.entity_export||("grid"===i?t.entity_out:void 0),a=t.entity_charge||("battery"===i?t.entity_in:void 0),s=t.entity_discharge||("battery"===i?t.entity_out:void 0),n=Boolean(o||r),l=Boolean(a||s);let c;const d=t.state_of_charge||(t.secondary_info?.entity&&t.secondary_info.entity.includes("soc")?t.secondary_info.entity:void 0);if(d&&e?.states?.[d]){const t=Fe(e.states[d].state);null!==t&&(c=`${Math.round(t)}%`)}if("grid"===i&&n){const t=ze(e,o),i=ze(e,r),a=t.isValid?Math.max(0,t.value):0,s=i.isValid?Math.max(0,i.value):0;return{power:a-s,inPower:a,outPower:s,isDual:!0,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}if("battery"===i&&l){const t=ze(e,a),i=ze(e,s),o=t.isValid?Math.max(0,t.value):0,r=i.isValid?Math.max(0,i.value):0;return{power:o-r,inPower:o,outPower:r,isDual:!0,soc:c,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}const h=ze(e,t.entity);let p,u=h.value;if(t.invert&&(u=-u),t.entity_amperage){const i=ze(e,t.entity_amperage);i.isValid&&(p=i.value)}return{power:u,inPower:u>=0?u:0,outPower:u<0?Math.abs(u):0,isDual:!1,soc:c,amperage:p,isUnavailable:h.isUnavailable,isUnknown:h.isUnknown,isValid:h.isValid,rawUnit:h.unit||"W"}}function Ie(e,t="sqrt"){const i=Math.max(0,Math.min(1,e));switch(t){case"linear":return i;case"sqrt":default:return Math.sqrt(i);case"log":return Math.log(1+9*i)/Math.LN10}}function Oe(e,t={}){const i=t.display_zero_tolerance??0,o=t.stroke_mode??"watt",r=t.speed_mode??"absolute",a=t.scale_curve??"sqrt",s=t.min_stroke??2,n=t.max_stroke??7,l=t.scale_min??50,c=t.scale_max??6e3,d=t.min_duration??.8,h=t.max_duration??5.5,p=t.residual_handling??"clamp",u=t.residual_absorb_target??"grid",_=Math.max(0,e.solar||0),m=Math.max(0,e.grid||0),g=Math.max(0,-(e.grid||0)),f=Math.max(0,e.battery||0),v=Math.max(0,-(e.battery||0));let y;y=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,_+m+v-g-f);let b=Math.min(_,y),x=_-b,$=y-b,w=Math.min(x,f),C=x-w,A=f-w,k=Math.min(C,g),S=Math.min(v,$),M=$-S,E=v-S,F=Math.min(E,Math.max(0,g-k)),z=Math.min(m,M),P=Math.min(Math.max(0,m-z),A),I=0;const O=y-(b+S+z);Math.abs(O)>i&&("clamp"===p?m>0||z>0?z=Math.max(0,z+O):S>0?S=Math.max(0,S+O):b=Math.max(0,b+O):"absorb"===p?"battery"===u&&(v>0||S>0)?S=Math.max(0,S+O):z=Math.max(0,z+O):I=Math.abs(O));let D=0;e.devices.forEach(e=>{!1!==e.include_in_home&&(D+=Math.max(0,e.power||0))});const T=Math.max(0,y-D),U=[{id:"solar-home",from:"solar",to:"home",value:b,color:ve,targetColor:we,gradientId:"glow-solar"},{id:"solar-battery",from:"solar",to:"battery",value:w,color:ve,targetColor:xe,gradientId:"glow-solar"},{id:"solar-grid",from:"solar",to:"grid",value:k,color:be,targetColor:be,gradientId:"glow-grid-export"},{id:"battery-home",from:"battery",to:"home",value:S,color:$e,targetColor:we,gradientId:"glow-battery-discharge"},{id:"battery-grid",from:"battery",to:"grid",value:F,color:$e,targetColor:be,gradientId:"glow-battery-discharge"},{id:"grid-home",from:"grid",to:"home",value:z,color:ye,targetColor:we,gradientId:"glow-grid-import"},{id:"grid-battery",from:"grid",to:"battery",value:P,color:ye,targetColor:xe,gradientId:"glow-grid-import"}];e.devices.forEach(e=>{const t=e.color||"var(--energy-device-color, #00bcd4)";U.push({id:`home-${e.id}`,from:"home",to:e.id,value:Math.max(0,e.power||0),color:t,targetColor:t,gradientId:"glow-device",ampere:e.ampere,isDevice:!0})});const N=U.reduce((e,t)=>e+(t.value>i?t.value:0),0),L=U.map(e=>{const t=e.value>i,p=function(e,t="watt",i="sqrt",o=2,r=7,a=50,s=6e3,n,l=5){if(e<=l)return 1.5;if("fixed"===t)return(o+r)/2;if("ampere"===t){if(null==n)return o;const e=.5;return o+Ie((n-e)/(25-e),i)*(r-o)}return o+Ie((e-a)/(s-a),i)*(r-o)}(e.value,o,a,s,n,l,c,e.ampere,i),u=function(e,t="absolute",i="sqrt",o=.8,r=5.5,a=50,s=5e3,n=0,l=5){if(e<=l)return r;let c=0;return c="relative"===t&&n>0?e/n:(e-a)/(s-a),r-Ie(c,i)*(r-o)}(e.value,r,a,d,h,l,c,N,i);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,strokeWidth:p,duration:u,isActive:t}});return{arcs:L,homeConsumption:y,untrackedDevicesPower:T,unbalancedPower:I,totalActivePower:N}}function De(e,t,i){return{x:e.x+Math.cos(i)*t,y:e.y+Math.sin(i)*t}}function Te(e,t,i=2){if(!Number.isFinite(e))return"0";if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{minimumFractionDigits:0,maximumFractionDigits:i}).format(e)}catch{}return e.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:i})}function Ue(e,t=2,i=1e3,o){const r=Math.abs(e);if(r>=1e6){const i=Te(e/1e6,o,t);return{value:i,unit:"MW",full:`${i} MW`}}if(r>=i){const i=Te(e/1e3,o,t);return{value:i,unit:"kW",full:`${i} kW`}}const a=Te(Math.round(e),o,0);return{value:a,unit:"W",full:`${a} W`}}const Ne={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:Ce,defaultColor:ve},grid:{x:65,y:200,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:175,y:335,radius:36,defaultIcon:ke,defaultColor:xe},home:{x:285,y:200,radius:38,defaultIcon:Se,defaultColor:we}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410}},Le={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:Ce,defaultColor:ve},grid:{x:85,y:175,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:355,y:175,radius:36,defaultIcon:ke,defaultColor:xe},home:{x:220,y:290,radius:38,defaultIcon:Se,defaultColor:we}},devicesVertical:{colLeftX:95,colRightX:345,startY:420}};var We={title:"Power Flow",solar:"Solar",grid:"Grid",battery:"Battery",home:"Home",production:"Production",consumption:"Consumption",import:"Import",export:"Export",charge:"Charge",discharge:"Discharge",inactive:"Inactive",active:"Active",unbalanced:"Unbalanced",not_tracked:"Other Consumption"},Re={title:"Card Title",solar:"Solar Node",grid:"Grid Node",battery:"Battery Node",home:"Home Node",devices:"Individual Devices",add_device:"Add Device",remove_device:"Remove Device",device_name:"Device Name",device_icon:"Icon",device_color:"Color",entity:"Power Entity",entity_import:"Import Entity",entity_export:"Export Entity",entity_charge:"Charge Entity",entity_discharge:"Discharge Entity",entity_amperage:"Current Entity (Amperes)",invert:"Invert Sign Convention",include_in_home:"Include in Home Total",display_zero:"Display Zero Flow",display_zero_tolerance:"Zero Tolerance (W)",stroke_mode:"Line Thickness Mode",stroke_mode_fixed:"Fixed",stroke_mode_watt:"Dynamic (Watts)",stroke_mode_ampere:"Dynamic (Amperes)",speed_mode:"Particle Speed Mode",speed_mode_absolute:"Absolute (Watts)",speed_mode_relative:"Relative (% of total)",layout_mode:"Layout Mode",layout_auto:"Auto Responsive",layout_horizontal:"Horizontal",layout_vertical:"Vertical (2-Column)",min_duration:"Min Particle Duration (s)",max_duration:"Max Particle Duration (s)",min_stroke:"Min Stroke Width (px)",max_stroke:"Max Stroke Width (px)",scale_min:"Scale Minimum",scale_max:"Scale Maximum",scale_curve:"Scale Curve",smoothing_factor:"Smoothing Factor (EMA)",max_total_particles:"Max Total Particles",residual_handling:"Residual Handling",residual_absorb_target:"Residual Absorb Target"},Ve={missing_entity:"At least one valid power entity is required.",invalid_range:"Invalid range: minimum must be strictly less than maximum."},Be={card:We,editor:Re,errors:Ve},He={title:"Flusso Energetico",solar:"Solare",grid:"Rete",battery:"Batteria",home:"Casa",production:"Produzione",consumption:"Consumo",import:"Prelevata",export:"Immessa",charge:"Carica",discharge:"Scarica",inactive:"Inattivo",active:"Attivo",unbalanced:"Sbilanciamento",not_tracked:"Altri Consumi"},je={title:"Titolo Card",solar:"Nodo Solare",grid:"Nodo Rete",battery:"Nodo Batteria",home:"Nodo Casa",devices:"Carichi Individuali",add_device:"Aggiungi Dispositivo",remove_device:"Rimuovi Dispositivo",device_name:"Nome Dispositivo",device_icon:"Icona",device_color:"Colore",entity:"Entità Potenza",entity_import:"Entità Prelievo (Import)",entity_export:"Entità Immissione (Export)",entity_charge:"Entità Carica",entity_discharge:"Entità Scarica",entity_amperage:"Entità Corrente (Ampere)",invert:"Inverti Convenzione Segno",include_in_home:"Includi nel Totale Casa",display_zero:"Mostra Linea a Flusso Zero",display_zero_tolerance:"Tolleranza Zero (W)",stroke_mode:"Modalità Spessore Linea",stroke_mode_fixed:"Fisso",stroke_mode_watt:"Dinamico (Watt)",stroke_mode_ampere:"Dinamico (Ampere)",speed_mode:"Modalità Velocità Particelle",speed_mode_absolute:"Assoluta (Watt)",speed_mode_relative:"Relativa (% sul totale)",layout_mode:"Modalità Layout",layout_auto:"Auto Responsive",layout_horizontal:"Orizzontale",layout_vertical:"Verticale (2 Colonne)",min_duration:"Durata Minima Particelle (s)",max_duration:"Durata Massima Particelle (s)",min_stroke:"Spessore Minimo Linea (px)",max_stroke:"Spessore Massimo Linea (px)",scale_min:"Valore Minimo Scala",scale_max:"Valore Massimo Scala",scale_curve:"Curva di Scala",smoothing_factor:"Fattore di Smoothing (EMA)",max_total_particles:"Max Particelle Totali",residual_handling:"Gestione Residuo Bilancio",residual_absorb_target:"Target Assorbimento Residuo"},qe={missing_entity:"È richiesta almeno un'entità di potenza valida.",invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo."},Ge={card:He,editor:je,errors:qe};const Ze={en:Be||Object.freeze({__proto__:null,card:We,default:Be,editor:Re,errors:Ve}),it:Ge||Object.freeze({__proto__:null,card:He,default:Ge,editor:je,errors:qe})};function Ye(e,t="en"){const i=t.replace(/['"]+/g,"").replace("-","_").split("_")[0],o=Ze[i]||Ze.en,r=e.split(".");let a=o;for(const t of r){if(!a||"object"!=typeof a||!(t in a)){let t=Ze.en;for(const i of r){if(!t||"object"!=typeof t||!(i in t))return e;t=t[i]}return"string"==typeof t?t:e}a=a[t]}return"string"==typeof a?a:e}let Xe=class extends ce{constructor(){super(...arguments),this._watchedEntities=new Set,this._particlesMap=new Map,this._particleDomElements={},this._pathElementsCache={},this._lastAnimTimestamp=0,this._isCardVisible=!0,this._actualLayout="horizontal"}static async getConfigElement(){return await Promise.resolve().then(function(){return Qe}),document.createElement("simple-power-flow-card-editor")}static getStubConfig(e,t){const i=t||(e?.states?Object.keys(e.states):[]),o=t=>i.find(i=>{const o=i.toLowerCase(),r=e?.states?.[i],a="power"===r?.attributes?.device_class||"W"===r?.attributes?.unit_of_measurement||"kW"===r?.attributes?.unit_of_measurement;return t.some(e=>o.includes(e))&&(a||!e)});return{type:"custom:simple-power-flow-card",card_version:1,title:"Power Flow",solar:{entity:o(["solar","pv","fotovoltaico"])||"sensor.solar_power"},grid:{entity:o(["grid","rete","power_meter","import"])||"sensor.grid_power"},battery:{entity:o(["battery_power","accumulo","batteria"])||"sensor.battery_power"},home:{entity:o(["home_power","house_power","consumo_casa"])||"sensor.home_power"},stroke_mode:"watt",speed_mode:"absolute",layout_mode:"auto",scale_curve:"sqrt",styles:ge}}static{this.styles=Ee}setConfig(e){if(!e)throw new Error(Ye("errors.missing_entity"));const t={...fe,...e,styles:{...ge,...e.styles||{}}};if((!t.card_version||t.card_version<1)&&(t.card_version=1),void 0!==t.scale_min&&void 0!==t.scale_max&&t.scale_min>=t.scale_max)throw new Error(Ye("errors.invalid_range")+" (scale_min < scale_max)");if(void 0!==t.min_duration&&void 0!==t.max_duration&&t.min_duration>=t.max_duration)throw new Error(Ye("errors.invalid_range")+" (min_duration < max_duration)");if(void 0!==t.min_stroke&&void 0!==t.max_stroke&&t.min_stroke>=t.max_stroke)throw new Error(Ye("errors.invalid_range")+" (min_stroke < max_stroke)");this._config=t,this._watchedEntities.clear();const i=e=>{e&&this._watchedEntities.add(e)};[this._config.solar,this._config.grid,this._config.battery,this._config.home].forEach(e=>{e&&(i(e.entity),i(e.entity_in),i(e.entity_out),i(e.entity_import),i(e.entity_export),i(e.entity_charge),i(e.entity_discharge),i(e.state_of_charge),i(e.entity_amperage),i(e.secondary_info?.entity))}),Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{i(e.entity),i(e.entity_amperage),i(e.secondary_info?.entity)}),this._checkInitialDimensions()}set hass(e){const t=this._hass;if(this._hass=e,!t||!e||!this._config)return void this.requestUpdate("hass",t);let i=!1;for(const o of this._watchedEntities)if(t.states?.[o]!==e.states?.[o]){i=!0;break}i&&this.requestUpdate("hass",t)}getCardSize(){return"vertical"===this._actualLayout?6:4}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}getLayoutOptions(){return{grid_columns:12,grid_rows:"auto",grid_min_columns:6,grid_min_rows:3}}connectedCallback(){super.connectedCallback(),this._setupObservers(),this._checkInitialDimensions(),this._startParticleAnimation()}firstUpdated(){this._checkInitialDimensions(),this._startParticleAnimation()}updated(){this._syncParticles()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupObservers(),this._stopParticleAnimation()}_checkInitialDimensions(){const e=this.getBoundingClientRect(),t=e.width>0?e.width:window.innerWidth;this._updateLayoutFromWidth(t)}_updateLayoutFromWidth(e){if("horizontal"===this._config?.layout_mode)return void("horizontal"!==this._actualLayout&&(this._actualLayout="horizontal"));if("vertical"===this._config?.layout_mode)return void("vertical"!==this._actualLayout&&(this._actualLayout="vertical"));const t=this._config?.auto_layout_breakpoint??520,i=e<=t||window.innerWidth<=t;i&&"vertical"!==this._actualLayout?(this._actualLayout="vertical",this.requestUpdate()):!i&&e>t+20&&"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this.requestUpdate())}_setupObservers(){this._resizeObserver||(this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e<=0||this._updateLayoutFromWidth(e)}}),this._resizeObserver.observe(this)),window.addEventListener("resize",()=>{this._checkInitialDimensions()}),this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver(e=>{for(const t of e)this._isCardVisible=t.isIntersecting,t.isIntersecting&&(this._lastAnimTimestamp=0,this._startParticleAnimation())}),this._intersectionObserver.observe(this))}_cleanupObservers(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=void 0),this._intersectionObserver&&(this._intersectionObserver.disconnect(),this._intersectionObserver=void 0)}_startParticleAnimation(){this._animFrameId||(this._lastAnimTimestamp=performance.now(),this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)))}_stopParticleAnimation(){this._animFrameId&&(cancelAnimationFrame(this._animFrameId),this._animFrameId=void 0)}_syncParticles(){if(!this._config)return;this._pathElementsCache={};const e={...ge,...this._config.styles||{}},t=Pe(this._hass,this._config.solar,"solar"),i=Pe(this._hass,this._config.grid,"grid"),o=Pe(this._hass,this._config.battery,"battery"),r=Pe(this._hass,this._config.home,"home"),a=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Pe(this._hass,e,"device");a.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const s=Oe({solar:t.power,grid:i.power,battery:o.power,home:r.isValid?r.power:void 0,devices:a},this._config).arcs.filter(e=>e.isActive),n=this._config.max_total_particles??30;let l=e.particles_per_arc;s.length*l>n&&(l=Math.max(1,Math.floor(n/s.length)));const c=new Set;s.forEach(t=>{c.add(t.id);const i=1/Math.max(.3,t.duration),o=Math.max(4,.75*t.strokeWidth+(e.particle_size_offset??1.8));for(let e=0;e<l;e++){const r=`${t.id}-${e}`,a=this._particlesMap.get(r);a?(a.targetSpeed=i,a.radius=o,a.isFadingOut=!1):this._particlesMap.set(r,{id:r,arcId:t.id,progress:e/l,speed:i,targetSpeed:i,radius:o,totalLength:0,isFadingOut:!1})}for(let e=l;e<10;e++){const i=`${t.id}-${e}`,o=this._particlesMap.get(i);o&&(o.isFadingOut=!0)}});for(const[e,t]of this._particlesMap.entries())c.has(t.arcId)||(t.isFadingOut=!0);this._startParticleAnimation()}_animateParticles(e){if(!this._isCardVisible)return void(this._animFrameId=void 0);this._lastAnimTimestamp||(this._lastAnimTimestamp=e);const t=Math.min((e-this._lastAnimTimestamp)/1e3,.1);this._lastAnimTimestamp=e;const i=this.shadowRoot?.querySelector("g.particles-layer");if(!i)return void(this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)));const o=this._config?.smoothing_factor??.35,r=[];for(const[e,a]of this._particlesMap.entries()){if(a.speed+=(a.targetSpeed-a.speed)*Math.min(1,o*t*10),a.progress+=a.speed*t,a.isFadingOut&&a.progress>=1){r.push(e);continue}const s=a.progress%1;let n=this._pathElementsCache[a.arcId];if(!n){const e=this.shadowRoot?.querySelector(`#path-${a.arcId}`);e&&(this._pathElementsCache[a.arcId]=e,n=e)}if(n&&(a.totalLength&&0!==a.totalLength||(a.totalLength=n.getTotalLength()),a.totalLength>0)){const t=n.getPointAtLength(s*a.totalLength);let o=this._particleDomElements[e];o||(o=document.createElementNS("http://www.w3.org/2000/svg","circle"),o.setAttribute("pointer-events","none"),i.appendChild(o),this._particleDomElements[e]=o),o.setAttribute("cx",t.x.toFixed(2)),o.setAttribute("cy",t.y.toFixed(2)),o.setAttribute("r",a.radius.toFixed(1)),o.setAttribute("fill",`url(#glow-arc-${a.arcId})`),a.isFadingOut?o.setAttribute("opacity",Math.max(0,1-s).toFixed(2)):o.removeAttribute("opacity")}}for(const e of r){this._particlesMap.delete(e);const t=this._particleDomElements[e];t&&t.parentNode&&t.parentNode.removeChild(t),delete this._particleDomElements[e]}this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this))}_handleNodeClick(e){if(!this._hass||!e.entityId)return;const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e.entityId}});this.dispatchEvent(t)}render(){if(!this._config)return H``;const e=this._hass?.language||"en",t=this._config.decimals??2,i=this._config.w_to_kw_threshold??1e3,o={...ge,...this._config.styles||{}},r=Pe(this._hass,this._config.solar,"solar"),a=Pe(this._hass,this._config.grid,"grid"),s=Pe(this._hass,this._config.battery,"battery"),n=Pe(this._hass,this._config.home,"home"),l=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Pe(this._hass,e,"device");l.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const c=[];this._watchedEntities.forEach(e=>{this._hass?.states&&!(e in this._hass.states)&&c.push(e)});const d=Oe({solar:r.power,grid:a.power,battery:s.power,home:n.isValid?n.power:void 0,devices:l},this._config),h=this._actualLayout,p="horizontal"===h?Ne:Le,u=o.node_radius_primary,_=o.node_radius_secondary,m=o.spacing_horizontal,g=o.spacing_vertical,f={};Object.keys(p.nodes).forEach(e=>{f[e]={...p.nodes[e],radius:u}});let v=`0 0 ${p.viewBox.width} ${p.viewBox.height}`;if("horizontal"===h){const e=Ne;if(l.forEach((t,i)=>{const o=Math.floor(i/2),r=i%2,a=e.devicesHorizontal.startX+o*m,s=0===r?e.devicesHorizontal.rowTopY:e.devicesHorizontal.rowBottomY;f[t.id]={x:a,y:s,radius:_}}),l.length>2){const t=Math.ceil(l.length/2),i=e.devicesHorizontal.startX+t*m+35;v=`0 0 ${Math.max(620,i)} 410`}}else{const e=Le;if(l.forEach((t,i)=>{const o=i%2,r=Math.floor(i/2),a=0===o?e.devicesVertical.colLeftX:e.devicesVertical.colRightX,s=e.devicesVertical.startY+r*g;f[t.id]={x:a,y:s,radius:_}}),l.length>2){const t=Math.ceil(l.length/2),i=e.devicesVertical.startY+t*g+45;v=`0 0 440 ${Math.max(560,i)}`}}const y=d.arcs.find(e=>"solar-home"===e.id),b=d.arcs.find(e=>"battery-home"===e.id),x=d.arcs.find(e=>"grid-home"===e.id),$=y?.value||0,w=b?.value||0,C=x?.value||0,A=$+w+C,k=[];A>0&&($>0&&k.push({id:"solar",color:this._config.solar?.color||ve,percentage:$/A,value:$}),w>0&&k.push({id:"battery",color:this._config.battery?.color||$e,percentage:w/A,value:w}),C>0&&k.push({id:"grid",color:this._config.grid?.color||ye,percentage:C/A,value:C}));let S,M=this._config.home?.color||we;if("predominant"===o.home_glow_mode&&k.length>0){const e=[...k].sort((e,t)=>t.value-e.value);e[0]&&e[0].value>0&&(M=e[0].color)}const E=this._config.grid?.color||ye,F=be;if(a.isDual)S=[{text:`← ${Ue(a.inPower||0,t,i,this._hass).full}`,color:E},{text:`→ ${Ue(a.outPower||0,t,i,this._hass).full}`,color:F}];else{const e=a.power;S=[{text:`${e>=0?"←":"→"} ${Ue(Math.abs(e),t,i,this._hass).full}`,color:e>=0?E:F}]}let z;const P=this._config.battery?.color||xe,I=$e;if(s.isDual)z=[{text:`↓ ${Ue(s.inPower||0,t,i,this._hass).full}`,color:P},{text:`↑ ${Ue(s.outPower||0,t,i,this._hass).full}`,color:I}];else{const e=s.power;z=[{text:`${e>=0?"↓":"↑"} ${Ue(Math.abs(e),t,i,this._hass).full}`,color:e>=0?P:I}]}const O=this._config.display_zero_tolerance??0,D=[{id:"solar",label:this._config.solar?.name||Ye("card.solar",e),icon:this._config.solar?.icon||Ce,color:this._config.solar?.color||ve,value:Ue(r.power,t,i,this._hass).value,unit:Ue(r.power,t,i,this._hass).unit,amperage:r.amperage,topInfo:void 0!==r.amperage?`${r.amperage} A`:void 0,isActive:r.power>O,isUnavailable:r.isUnavailable,x:f.solar.x,y:f.solar.y,radius:f.solar.radius,entityId:this._config.solar?.entity,styles:o,isSecondary:!1,iconSize:o.icon_size_primary},{id:"grid",label:this._config.grid?.name||Ye("card.grid",e),icon:this._config.grid?.icon||Ae,color:this._config.grid?.color||(a.power>=0?ye:be),value:Ue(Math.abs(a.power),t,i,this._hass).value,unit:Ue(Math.abs(a.power),t,i,this._hass).unit,extraValues:S,amperage:a.amperage,topInfo:void 0!==a.amperage?`${a.amperage} A`:void 0,isActive:Math.abs(a.power)>O,isUnavailable:a.isUnavailable,x:f.grid.x,y:f.grid.y,radius:f.grid.radius,entityId:this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export,styles:o,isSecondary:!1,iconSize:o.icon_size_primary},{id:"battery",label:this._config.battery?.name||Ye("card.battery",e),icon:this._config.battery?.icon||ke,color:this._config.battery?.color||(s.power>=0?xe:$e),value:Ue(Math.abs(s.power),t,i,this._hass).value,unit:Ue(Math.abs(s.power),t,i,this._hass).unit,extraValues:z,topInfo:s.soc||(void 0!==s.amperage?`${s.amperage} A`:void 0),amperage:s.amperage,isActive:Math.abs(s.power)>O,isUnavailable:s.isUnavailable,x:f.battery.x,y:f.battery.y,radius:f.battery.radius,entityId:this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge,styles:o,isSecondary:!1,iconSize:o.icon_size_primary},{id:"home",label:this._config.home?.name||Ye("card.home",e),icon:this._config.home?.icon||Se,color:M,value:Ue(d.homeConsumption,t,i,this._hass).value,unit:Ue(d.homeConsumption,t,i,this._hass).unit,secondaryText:d.untrackedDevicesPower>O?`${Ye("card.not_tracked",e)}: ${Ue(d.untrackedDevicesPower,0,i,this._hass).full}`:void 0,isActive:d.homeConsumption>O,isUnavailable:n.isUnavailable&&!r.isValid&&!a.isValid,x:f.home.x,y:f.home.y,radius:f.home.radius,entityId:this._config.home?.entity,mixSegments:k,styles:o,isSecondary:!1,iconSize:o.icon_size_primary}];return l.forEach(e=>{const r=f[e.id];r&&D.push({id:e.id,label:e.name||e.id,icon:e.icon||Me,color:e.color||"var(--energy-device-color, #00bcd4)",value:Ue(e.power,t,i,this._hass).value,unit:Ue(e.power,t,i,this._hass).unit,topInfo:void 0!==e.ampere?`${e.ampere} A`:void 0,isActive:e.power>O,isUnavailable:!1,x:r.x,y:r.y,radius:r.radius,entityId:e.entityId,styles:o,isSecondary:!0,iconSize:o.icon_size_secondary})}),H`
      <ha-card>
        ${this._config.title?H`<div class="card-header">${this._config.title}</div>`:""}

        ${c.length>0&&!this._config.solar?.entity?.includes("dummy")?H`
  ...
  `}(d.arcs)}
            ...
            <!-- Layer 1: Wires -->
            <g class="wires-layer">
              ${(()=>{const e=d.arcs.filter(e=>e.id.startsWith("home-"));return d.arcs.map(t=>{const i=f[t.from],r=f[t.to];if(!i||!r)return j``;const a=t.id.startsWith("home-")?e.findIndex(e=>e.id===t.id):0,s=function(e,t,i,o,r=0,a=1,s){const n=s?.line_routing_mode||"bezier_curved",l=s?.bus_lane_spacing??8,c=s?.bus_corner_radius??20,d=t.x-e.x,h=t.y-e.y,p=Math.atan2(h,d),u=De({x:e.x,y:e.y},e.radius,p),_=De({x:t.x,y:t.y},t.radius,p+Math.PI);if("horizontal"===i){if("solar-home"===o){const i=De({x:e.x,y:e.y},e.radius,.1),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("battery-home"===o){const i=De({x:e.x,y:e.y},e.radius,-.1),o=De({x:t.x,y:t.y},t.radius,Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("solar-battery"===o){const i=De({x:e.x,y:e.y},e.radius,Math.PI/2),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.y<e.y;if("orthogonal_bus"===n){const o=(Math.floor(r/2)+.5)*l,a=i?e.y-o:e.y+o,s=Math.asin(Math.max(-.9,Math.min(.9,(a-e.y)/e.radius))),n=e.x+Math.cos(s)*e.radius,d=t.x,h=i?t.y+t.radius:t.y-t.radius,p=Math.min(c,.45*Math.abs(d-n),.45*Math.abs(h-a)),u=Math.max(6,p);if(i){const e=d-u,t=a-u;return`M ${n.toFixed(1)} ${a.toFixed(1)} L ${e.toFixed(1)} ${a.toFixed(1)} C ${(e+.55*u).toFixed(1)} ${a.toFixed(1)}, ${d.toFixed(1)} ${(a-.45*u).toFixed(1)}, ${d.toFixed(1)} ${t.toFixed(1)} L ${d.toFixed(1)} ${h.toFixed(1)}`}{const e=d-u,t=a+u;return`M ${n.toFixed(1)} ${a.toFixed(1)} L ${e.toFixed(1)} ${a.toFixed(1)} C ${(e+.55*u).toFixed(1)} ${a.toFixed(1)}, ${d.toFixed(1)} ${(a+.45*u).toFixed(1)}, ${d.toFixed(1)} ${t.toFixed(1)} L ${d.toFixed(1)} ${h.toFixed(1)}`}}{const i=De({x:e.x,y:e.y},e.radius,0),o=De({x:t.x,y:t.y},t.radius,Math.PI),r=Math.max(40,o.x-i.x),a=i.x+.45*r,s=i.y,n=i.x+.55*r,l=o.y;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${a.toFixed(1)} ${s.toFixed(1)}, ${n.toFixed(1)} ${l.toFixed(1)}, ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}}return`M ${u.x.toFixed(1)} ${u.y.toFixed(1)} L ${_.x.toFixed(1)} ${_.y.toFixed(1)}`}if("solar-home"===o){const i=De({x:e.x,y:e.y},e.radius,Math.PI/2),o=De({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("grid-battery"===o){const i=De({x:e.x,y:e.y},e.radius,0),o=De({x:t.x,y:t.y},t.radius,Math.PI);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.x<e.x;if("orthogonal_bus"===n){const o=(Math.floor(r/2)+.5)*l,a=i?e.x-o:e.x+o,s=Math.max(-.9,Math.min(.9,(a-e.x)/e.radius)),n=Math.PI/2+Math.asin(s),d=e.y+Math.sin(n)*e.radius,h=i?t.x+t.radius:t.x-t.radius,p=t.y,u=Math.min(c,.45*Math.abs(h-a),.45*Math.abs(p-d)),_=Math.max(6,u);if(i){const e=p-_,t=a-_;return`M ${a.toFixed(1)} ${d.toFixed(1)} L ${a.toFixed(1)} ${e.toFixed(1)} C ${a.toFixed(1)} ${(e+.55*_).toFixed(1)}, ${(a-.45*_).toFixed(1)} ${p.toFixed(1)}, ${t.toFixed(1)} ${p.toFixed(1)} L ${h.toFixed(1)} ${p.toFixed(1)}`}{const e=p-_,t=a+_;return`M ${a.toFixed(1)} ${d.toFixed(1)} L ${a.toFixed(1)} ${e.toFixed(1)} C ${a.toFixed(1)} ${(e+.55*_).toFixed(1)}, ${(a+.45*_).toFixed(1)} ${p.toFixed(1)}, ${t.toFixed(1)} ${p.toFixed(1)} L ${h.toFixed(1)} ${p.toFixed(1)}`}}{const o=De({x:e.x,y:e.y},e.radius,Math.PI/2),r=i?0:Math.PI,a=De({x:t.x,y:t.y},t.radius,r),s=Math.max(40,a.y-o.y),n=o.x,l=o.y+.45*s,c=a.x+(i?20:-20),d=o.y+.65*s;return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} C ${n.toFixed(1)} ${l.toFixed(1)}, ${c.toFixed(1)} ${d.toFixed(1)}, ${a.x.toFixed(1)} ${a.y.toFixed(1)}`}}return`M ${u.x.toFixed(1)} ${u.y.toFixed(1)} L ${_.x.toFixed(1)} ${_.y.toFixed(1)}`}(i,r,h,t.id,a,e.length,o);return function(e,t,i){const o=e.isActive?e.color:e.targetColor||e.color,r=e.isActive?1:i?.inactive_wire_opacity??.35,a=!e.isActive&&"solid"!==i?.inactive_wire_style;return j`
    <path id="path-${e.id}"
  ...
  `}(t,s,o)})})()}
            ...
            <!-- Layer 2: Particles (Managed via continuous RAF Engine for Zero Glitch & Smooth Flow) -->
            <g class="particles-layer"></g>

            <!-- Layer 3: Nodes -->
            <g class="nodes-layer">
              ${D.map(e=>function(e,t,i){const o=i||e.styles||{},r=`${e.label}: ${e.value} ${e.unit}${e.secondaryText?` (${e.secondaryText})`:""}`,a=2*Math.PI*e.radius;let s=[];const n=!1!==o.show_home_mix_ring;if(n&&e.mixSegments&&e.mixSegments.length>0&&0!==Number(e.value)){let t=0;s=e.mixSegments.map(i=>{const r=i.percentage*a,s=-t;return t+=r,j`
        <circle class="node-mix-segment"
                ...
                stroke-dasharray="${r.toFixed(2)} ${a.toFixed(2)}"
                stroke-dashoffset="${s.toFixed(2)}"
                transform="rotate(-90 ${e.x} ${e.y})" />
      `})}const l="solar"===e.id||"grid"===e.id||"battery"===e.id||"home"===e.id,c=void 0!==e.isSecondary?e.isSecondary:!l,d=Boolean(e.extraValues&&e.extraValues.length>0),h=Boolean(d&&(e.extraValues?.length||0)>=2),p=Boolean(e.topInfo),u=e.iconSize||(c?o.icon_size_secondary??16:o.icon_size_primary??18),_=o.spacing_text_above_icon??4,m=o.spacing_text_below_icon??4,g=e.x-u/2;let f=e.y-u/2,v=f-_-2,y=f+u+m+9,b=f+u+m+8,x=b+(o.font_size_directional?o.font_size_directional+3:11.5);c?p?(f=e.y-u/2-1,v=f-_-2,y=f+u+m+8):(f=e.y-u-1,y=f+u+m+8):p&&h?(f=e.y-u/2-4,v=f-_-3,b=f+u+m+8,x=b+(o.font_size_directional?o.font_size_directional+3:11.5)):p&&!h?(f=e.y-u/2-3,v=f-_-3,y=f+u+m+9,b=y):!p&&h?(f=e.y-u-4,b=f+u+m+7,x=b+(o.font_size_directional?o.font_size_directional+3:11.5)):(f=e.y-u-2,y=f+u+m+9);const $=e.y+e.radius+14,w=e.y+e.radius+26;let C=j`<tspan x="${e.x}">${e.label}</tspan>`;if(e.label.length>11)if(e.label.includes("/")){const t=e.label.split("/");C=j`
        <tspan x="${e.x}" dy="0">${t[0]}/</tspan>
        <tspan x="${e.x}" dy="11">${t.slice(1).join("/")}</tspan>
      `}else if(e.label.includes(" ")){const t=e.label.split(" "),i=Math.ceil(t.length/2),o=t.slice(0,i).join(" "),r=t.slice(i).join(" ");C=j`
        <tspan x="${e.x}" dy="0">${o}</tspan>
        <tspan x="${e.x}" dy="11">${r}</tspan>
      `}const A=`\n    --node-hover-color: ${e.color};\n    --node-hover-glow-radius: ${o.hover_glow_radius??10}px;\n    --node-border-width: ${o.node_border_width??2.5}px;\n    --node-shadow-blur: ${o.node_shadow_blur??10}px;\n    --node-shadow-opacity: ${o.node_shadow_opacity??.35};\n    --node-shadow-offset-y: ${o.node_shadow_offset_y??4}px;\n    --font-size-value: ${o.font_size_value??10}px;\n    --font-size-label: ${o.font_size_label??10}px;\n    --font-size-top-info: ${o.font_size_top_info??8}px;\n    --font-size-directional: ${o.font_size_directional??8.5}px;\n  `;return j`
    <g class="node-group"
       tabindex="0"
       role="group"
       style="${A}"
      ...
      ${p?j`
        <text class="node-top-info" x="${e.x}" y="${v.toFixed(1)}">
          ${e.topInfo}
        </text>
      `:""}

      <!-- Center Icon with direct pixel dimensions and CSS variable -->
      <foreignObject x="${g.toFixed(1)}" y="${f.toFixed(1)}" width="${u.toFixed(1)}" height="${u.toFixed(1)}" style="overflow: visible;">
        <div class="node-icon-foreign" xmlns="http://www.w3.org/1999/xhtml" style="width: ${u.toFixed(1)}px; height: ${u.toFixed(1)}px; display: flex; align-items: center; justify-content: center;">
          <ha-icon icon="${e.icon}" style="--mdc-icon-size: ${u.toFixed(1)}px; width: ${u.toFixed(1)}px; height: ${u.toFixed(1)}px; display: flex; align-items: center; justify-content: center;"></ha-icon>
        </div>
      </foreignObject>

      <!-- Values Inside Circle -->
      ${d?j`
        ${e.extraValues.map((t,i)=>{const o=0===i?b:x;return j`
          ...
          `})}
      `:j`
        <text class="node-value" x="${e.x}" y="${y.toFixed(1)}">
          ${e.isUnavailable?"--":`${e.value} ${e.unit}`}
        </text>
      `}

      <!-- Outside Label -->
      <text class="node-label-outside" x="${e.x}" y="${$}">
        ${C}
      </text>

      <!-- Optional Secondary Text -->
      ${e.secondaryText&&!d?j`
        <text class="node-sub-outside" x="${e.x}" y="${w}">
          ${e.secondaryText}
        </text>
      `:""}
    </g>
    ...
    `}render(){if(!this._config)return H``;const e=this.hass?.language||"en",t=this._config.styles||ge;return H`
      <div class="card-config">
        ...
        ${"general"===this._activeTab?H`
          ...
          <div class="form-row">
            <label>${Ye("editor.layout_mode",e)}</label>
            <select .value=${this._config.layout_mode||"auto"} @change=${e=>this._valueChanged("layout_mode",e.target.value)}>
              ...
              <option value="horizontal">${Ye("editor.layout_horizontal",e)}</option>
              <option value="vertical">${Ye("editor.layout_vertical",e)}</option>
            </select>
          </div>

          <div class="form-row">
            <label>${Ye("editor.stroke_mode",e)}</label>
            <select .value=${this._config.stroke_mode||"watt"} @change=${e=>this._valueChanged("stroke_mode",e.target.value)}>
              <option value="watt">${Ye("editor.stroke_mode_watt",e)}</option>
              <option value="fixed">${Ye("editor.stroke_mode_fixed",e)}</option>
              <option value="ampere">${Ye("editor.stroke_mode_ampere",e)}</option>
            </select>
          </div>

          <div class="form-row">
            <label>${Ye("editor.speed_mode",e)}</label>
            <select .value=${this._config.speed_mode||"absolute"} @change=${e=>this._valueChanged("speed_mode",e.target.value)}>
              <option value="absolute">${Ye("editor.speed_mode_absolute",e)}</option>
              <option value="relative">${Ye("editor.speed_mode_relative",e)}</option>
            </select>
          </div>
        `:""}
        ...
        ${"nodes"===this._activeTab?H`
          <!-- Solar -->
          <div class="section-title">☀️ ${Ye("editor.solar",e)}</div>
          <div class="form-row">
            <label>${Ye("editor.entity",e)}</label>
          ...
          <!-- Grid -->
          <div class="section-title">⚡ ${Ye("editor.grid",e)}</div>
          <div class="form-row">
            <label>${Ye("editor.entity",e)} (Singola con segno +/-)</label>
            ${this._renderEntityPicker(this._config.grid?.entity,e=>this._nodeChanged("grid","entity",e))}
          </div>
          <div class="form-row">
            <label>Oppure ${Ye("editor.entity_import",e)} (Prelievo)</label>
            ${this._renderEntityPicker(this._config.grid?.entity_import,e=>this._nodeChanged("grid","entity_import",e))}
          </div>
          <div class="form-row">
            <label>${Ye("editor.entity_export",e)} (Immissione)</label>
          ...
          <!-- Home -->
          <div class="section-title">🏠 ${Ye("editor.home",e)}</div>
          <div class="form-row">
            <label>${Ye("editor.entity",e)} (Opzionale: se vuoto, calcolato da flussi)</label>
        ...
        ${"devices"===this._activeTab?H`
          ${(this._config.devices||[]).map((t,i)=>H`
            <div class="device-card">
              ...
              <div class="form-row">
                <label>${Ye("editor.device_name",e)}</label>
              ...
              <div class="form-row">
                <label>${Ye("editor.entity",e)} (Potenza Watt)</label>
              ...
              <div class="form-row">
                <label>${Ye("editor.device_icon",e)}</label>
              ...
              <div class="checkbox-row">
                ...
                <label for="dev_home_${i}">${Ye("editor.include_in_home",e)}</label>
              </div>
            </div>
          `)}

          <button class="add-device-btn" @click=${()=>this._addDevice()}>
            + ${Ye("editor.add_device",e)}
          </button>
        `:""}
        ...
        ${"advanced"===this._activeTab?H`
          ...
          <div class="form-row">
            <label>${Ye("editor.display_zero_tolerance",e)} (W)</label>
          ...
          <div class="form-row">
            <label>${Ye("editor.scale_curve",e)}</label>
          ...
          <div class="form-row">
            <label>${Ye("editor.max_total_particles",e)}</label>
          ...
          <div class="form-row">
            <label>${Ye("editor.residual_handling",e)}</label>
