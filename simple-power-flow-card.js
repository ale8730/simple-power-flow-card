...
`;function Pe(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const i=t.replace(",",".").replace(/[^0-9.-]/g,""),o=parseFloat(i);return Number.isFinite(o)?o:null}function ze(e,t){if(!(e&&t&&e.states&&e.states[t]))return{value:0,rawState:"",unit:"",isUnavailable:!0,isUnknown:!1,isValid:!1};const i=e.states[t],o=i.state,a=i.attributes?.unit_of_measurement||"W";if("unavailable"===o)return{value:0,rawState:o,unit:a,isUnavailable:!0,isUnknown:!1,isValid:!1};if("unknown"===o)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};const r=Pe(o);if(null===r)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};return{value:function(e,t){switch(t.trim()){case"kW":case"kVA":case"kvar":return 1e3*e;case"MW":case"MVA":return 1e6*e;case"W":case"VA":case"var":case"A":default:return e;case"mW":case"mA":return.001*e}}(r,a),rawState:o,unit:a,isUnavailable:!1,isUnknown:!1,isValid:!0}}function Ie(e,t,i="solar"){if(!t)return{power:0,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};const o=t.entity_import||("grid"===i?t.entity_in:void 0),a=t.entity_export||("grid"===i?t.entity_out:void 0),r=t.entity_charge||("battery"===i?t.entity_in:void 0),s=t.entity_discharge||("battery"===i?t.entity_out:void 0),n=Boolean(o||a),l=Boolean(r||s);let c,d;const h=t.state_of_charge||(t.secondary_info?.entity&&t.secondary_info.entity.includes("soc")?t.secondary_info.entity:void 0);if(h&&e?.states?.[h]){const t=Pe(e.states[h].state);null!==t&&(d=Math.max(0,Math.min(100,t)),c=`${Math.round(t)}%`)}if("grid"===i&&n){const t=ze(e,o),i=ze(e,a),r=t.isValid?Math.max(0,t.value):0,s=i.isValid?Math.max(0,i.value):0;return{power:r-s,inPower:r,outPower:s,isDual:!0,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}if("battery"===i&&l){const t=ze(e,r),i=ze(e,s),o=t.isValid?Math.max(0,t.value):0,a=i.isValid?Math.max(0,i.value):0;return{power:o-a,inPower:o,outPower:a,isDual:!0,soc:c,socPercent:d,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}const p=ze(e,t.entity);let _,u=p.value;if(t.invert&&(u=-u),t.entity_amperage){const i=ze(e,t.entity_amperage);i.isValid&&(_=i.value)}return{power:u,inPower:u>=0?u:0,outPower:u<0?Math.abs(u):0,isDual:!1,soc:c,socPercent:d,amperage:_,isUnavailable:p.isUnavailable,isUnknown:p.isUnknown,isValid:p.isValid,rawUnit:p.unit||"W"}}function Ne(e,t="sqrt"){const i=Math.max(0,Math.min(1,e));switch(t){case"linear":return i;case"sqrt":default:return Math.sqrt(i);case"log":return Math.log(1+9*i)/Math.LN10}}function Oe(e,t={}){const i=t.display_zero_tolerance??0,o=t.stroke_mode??"watt",a=t.speed_mode??"absolute",r=t.scale_curve??"sqrt",s=t.min_stroke??2,n=t.max_stroke??7,l=t.scale_min??50,c=t.scale_max??6e3,d=t.min_duration??.8,h=t.max_duration??5.5,p=t.residual_handling??"clamp",_=t.residual_absorb_target??"grid",u=Math.max(0,e.solar||0),g=Math.max(0,e.grid||0),m=Math.max(0,-(e.grid||0)),f=Math.max(0,e.battery||0),b=Math.max(0,-(e.battery||0));let v;v=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,u+g+b-m-f);let y=Math.min(u,v),x=u-y,$=v-y,w=Math.min(x,f),C=x-w,k=f-w,A=Math.min(C,m),S=Math.min(b,$),M=$-S,F=b-S,E=Math.min(F,Math.max(0,m-A)),P=Math.min(g,M),z=Math.min(Math.max(0,g-P),k),I=0;const N=v-(y+S+P);Math.abs(N)>i&&("clamp"===p?g>0||P>0?P=Math.max(0,P+N):S>0?S=Math.max(0,S+N):y=Math.max(0,y+N):"absorb"===p?"battery"===_&&(b>0||S>0)?S=Math.max(0,S+N):P=Math.max(0,P+N):I=Math.abs(N));let O=0;e.devices.forEach(e=>{!1!==e.include_in_home&&(O+=Math.max(0,e.power||0))});const T=Math.max(0,v-O),D=t.solar?.color||ve,L=t.grid?.color||ye,U=xe,R=t.battery?.color_charge||t.battery?.color||$e,W=t.battery?.color_discharge||we,B=t.home?.color||Ce,V=[{id:"solar-home",from:"solar",to:"home",value:y,color:D,targetColor:B,gradientId:"glow-solar"},{id:"solar-battery",from:"solar",to:"battery",value:w,color:D,targetColor:R,gradientId:"glow-solar"},{id:"solar-grid",from:"solar",to:"grid",value:A,color:U,targetColor:U,gradientId:"glow-grid-export"},{id:"battery-home",from:"battery",to:"home",value:S,color:W,targetColor:B,gradientId:"glow-battery-discharge"},{id:"battery-grid",from:"battery",to:"grid",value:E,color:W,targetColor:U,gradientId:"glow-battery-discharge"},{id:"grid-home",from:"grid",to:"home",value:P,color:L,targetColor:B,gradientId:"glow-grid-import"},{id:"grid-battery",from:"grid",to:"battery",value:z,color:L,targetColor:R,gradientId:"glow-grid-import"}];e.devices.forEach(e=>{const t=e.color||"var(--energy-device-color, #00bcd4)";V.push({id:`home-${e.id}`,from:"home",to:e.id,value:Math.max(0,e.power||0),color:t,targetColor:t,gradientId:"glow-device",ampere:e.ampere,isDevice:!0})});const q=V.reduce((e,t)=>e+(t.value>i?t.value:0),0),G=V.map(e=>{const t=e.value>i,p=function(e,t="watt",i="sqrt",o=2,a=7,r=50,s=6e3,n,l=5){if(e<=l)return 1.5;if("fixed"===t)return(o+a)/2;if("ampere"===t){if(null==n)return o;const e=.5;return o+Ne((n-e)/(25-e),i)*(a-o)}return o+Ne((e-r)/(s-r),i)*(a-o)}(e.value,o,r,s,n,l,c,e.ampere,i),_=function(e,t="absolute",i="sqrt",o=.8,a=5.5,r=50,s=5e3,n=0,l=5){if(e<=l)return a;let c=0;return c="relative"===t&&n>0?e/n:(e-r)/(s-r),a-Ne(c,i)*(a-o)}(e.value,a,r,d,h,l,c,q,i);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,strokeWidth:p,duration:_,isActive:t}});return{arcs:G,homeConsumption:v,untrackedDevicesPower:T,unbalancedPower:I,totalActivePower:q}}function Te(e,t,i){return{x:e.x+Math.cos(i)*t,y:e.y+Math.sin(i)*t}}function De(e,t,i=2){if(!Number.isFinite(e))return"0";if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{minimumFractionDigits:0,maximumFractionDigits:i}).format(e)}catch{}return e.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:i})}function Le(e,t=2,i=1e3,o){const a=Math.abs(e);if(a>=1e6){const i=De(e/1e6,o,t);return{value:i,unit:"MW",full:`${i} MW`}}if(a>=i){const i=De(e/1e3,o,t);return{value:i,unit:"kW",full:`${i} kW`}}const r=De(Math.round(e),o,0);return{value:r,unit:"W",full:`${r} W`}}const Ue={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:ke,defaultColor:ve},grid:{x:65,y:200,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:175,y:335,radius:36,defaultIcon:Se,defaultColor:$e},home:{x:285,y:200,radius:38,defaultIcon:Me,defaultColor:Ce}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410}},Re={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:ke,defaultColor:ve},grid:{x:85,y:175,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:355,y:175,radius:36,defaultIcon:Se,defaultColor:$e},home:{x:220,y:290,radius:38,defaultIcon:Me,defaultColor:Ce}},devicesVertical:{colLeftX:95,colRightX:345,startY:420}};function We(e,t,i,o){const a=i||e.styles||{},r=o||e.effects||{},s=`${e.label}: ${e.value} ${e.unit}${e.secondaryText?` (${e.secondaryText})`:""}`,n=2*Math.PI*e.radius;let l=[];const c=!1!==a.show_home_mix_ring;if(c&&e.mixSegments&&e.mixSegments.length>0&&0!==Number(e.value)){let t=0;l=e.mixSegments.map(i=>{const o=i.percentage*n,r=-t;return t+=o,G`
        <circle class="node-mix-segment"
                ...
                fill="none"
                stroke="${i.color}"
                stroke-width="${a.node_border_width??3.5}"
                stroke-dasharray="${o.toFixed(2)} ${n.toFixed(2)}"
                stroke-dashoffset="${r.toFixed(2)}"
                transform="rotate(-90 ${e.x} ${e.y})" />
      `})}const d="solar"===e.id||"grid"===e.id||"battery"===e.id||"home"===e.id,h=void 0!==e.isSecondary?e.isSecondary:!d,p=Boolean(e.extraValues&&e.extraValues.length>0),_=Boolean(p&&(e.extraValues?.length||0)>=2),u=Boolean(e.topInfo),g=e.iconSize||(h?a.icon_size_secondary??16:a.icon_size_primary??18),m=a.spacing_text_above_icon??4,f=a.spacing_text_below_icon??4,b=e.x-g/2;let v=e.y-g/2,y=v-m-2,x=v+g+f+9,$=v+g+f+8,w=$+(a.font_size_directional?a.font_size_directional+3:11.5);h?u?(v=e.y-g/2-1,y=v-m-2,x=v+g+f+8):(v=e.y-g-1,x=v+g+f+8):u&&_?(v=e.y-g/2-4,y=v-m-3,$=v+g+f+8,w=$+(a.font_size_directional?a.font_size_directional+3:11.5)):u&&!_?(v=e.y-g/2-3,y=v-m-3,x=v+g+f+9,$=x):!u&&_?(v=e.y-g-4,$=v+g+f+7,w=$+(a.font_size_directional?a.font_size_directional+3:11.5)):(v=e.y-g-2,x=v+g+f+9);const C=!1!==e.showLabel,k=e.labelFontSize??a.font_size_label??10,A=e.labelSpacing??a.spacing_label_below_node??14,S=Boolean(e.labelChipEnabled),M=e.labelChipOpacity??a.label_chip_opacity??.18,F=e.labelChipPaddingX??a.label_chip_padding_x??8,E=e.labelChipPaddingY??a.label_chip_padding_y??3.5,P=e.labelBorderRadius??a.label_border_radius??6,z=e.labelBorderWidth??a.label_border_width??1,I=e.labelColorMode??a.label_color_mode??"auto_contrast",N=e.y+e.radius+A;let O=!1,T=e.label.length,D=G`<tspan x="${e.x}">${e.label}</tspan>`;if(e.label.length>11)if(e.label.includes("/")){const t=e.label.split("/"),i=t[0]+"/",o=t.slice(1).join("/");O=!0,T=Math.max(i.length,o.length),D=G`
        <tspan x="${e.x}" dy="0">${i}</tspan>
        <tspan x="${e.x}" dy="${(1.15*k).toFixed(1)}">${o}</tspan>
      `}else if(e.label.includes(" ")){const t=e.label.split(" "),i=Math.ceil(t.length/2),o=t.slice(0,i).join(" "),a=t.slice(i).join(" ");O=!0,T=Math.max(o.length,a.length),D=G`
        <tspan x="${e.x}" dy="0">${o}</tspan>
        <tspan x="${e.x}" dy="${(1.15*k).toFixed(1)}">${a}</tspan>
      `}const L=.62*k,U=Math.max(24,T*L+2*F),R=O?2.2*k+2*E:1.15*k+2*E,W=e.x-U/2,B=N-.85*k-E;let V;V="auto_contrast"===I?S?function(e,t=1){let i=255,o=255,a=255;if(e.startsWith("#")){const t=e.replace("#","");3===t.length?(i=parseInt(t[0]+t[0],16),o=parseInt(t[1]+t[1],16),a=parseInt(t[2]+t[2],16)):t.length>=6&&(i=parseInt(t.substring(0,2),16),o=parseInt(t.substring(2,4),16),a=parseInt(t.substring(4,6),16))}else if(e.startsWith("rgb")){const t=e.match(/\d+/g);t&&t.length>=3&&(i=parseInt(t[0],10),o=parseInt(t[1],10),a=parseInt(t[2],10))}const r=Math.max(0,Math.min(1,t));return(.299*(i*r+30*(1-r))+.587*(o*r+41*(1-r))+.114*(a*r+59*(1-r)))/255>.58?"#0f172a":"#ffffff"}(e.color,M):e.color:"white"===I?"#ffffff":"black"===I?"#0f172a":"match_entity"===I?e.color:"custom"===I&&(e.labelColor||a.label_color)?e.labelColor||a.label_color||"#ffffff":"var(--secondary-text-color, #94a3b8)";const q=N+(O?2.3*k:1.2*k)+6,H=`\n    --node-hover-color: ${e.color};\n    --node-hover-glow-radius: ${a.hover_glow_radius??10}px;\n    --node-border-width: ${a.node_border_width??2.5}px;\n    --node-shadow-blur: ${a.node_shadow_blur??10}px;\n    --node-shadow-opacity: ${a.node_shadow_opacity??.35};\n    --node-shadow-offset-y: ${a.node_shadow_offset_y??4}px;\n    --font-size-value: ${a.font_size_value??10}px;\n    --font-size-label: ${k}px;\n    --font-size-top-info: ${a.font_size_top_info??8}px;\n    --font-size-directional: ${a.font_size_directional??8.5}px;\n  `;let j="";if(r.living_icons?.enabled&&e.isActive){if("home"===e.id||h){const e=r.living_icons.load_animation||"rotate";"rotate"===e?j="animate-rotate":"pulse"===e&&(j="animate-pulse")}}const Z="battery"===e.id,Y=Boolean(Z&&r.living_icons?.enabled&&"liquid"===r.living_icons.battery_type),X=Boolean(Z&&r.living_icons?.enabled&&"gradient"===r.living_icons.battery_type),Q=Boolean(r.glassmorphism?.enabled),J=(r.glassmorphism?.intensity??50)/50,K=Boolean(Q&&!1!==r.glassmorphism?.neon_core);let ee="";if(Y){const t=e.socPercent??50,i=e.y+e.radius-t/100*(2*e.radius);ee=`M ${e.x-e.radius} ${i} Q ${e.x-e.radius/2} ${i-3} ${e.x} ${i} T ${e.x+e.radius} ${i} L ${e.x+e.radius} ${e.y+e.radius} L ${e.x-e.radius} ${e.y+e.radius} Z`}return G`
    <g class="node-group"
       tabindex="0"
       role="group"
       style="${H}"
      ...
      <defs>
        ...
        ${Q?G`
          <linearGradient id="glass-glare-${e.id}" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stop-color="#ffffff" stop-opacity="${(.28*J).toFixed(2)}" />
            <stop offset="40%" stop-color="#ffffff" stop-opacity="${(.08*J).toFixed(2)}" />
            <stop offset="65%" stop-color="#ffffff" stop-opacity="0" />
            <stop offset="100%" stop-color="#000000" stop-opacity="${(.22*J).toFixed(2)}" />
          </linearGradient>
        `:""}
      </defs>
      ...
      ${K?G`
        <circle class="node-neon-ring"
                ...
                stroke="${e.color}"
                stroke-width="1.5"
                stroke-opacity="${(.65*J).toFixed(2)}" />
      `:""}

      <!-- Top Info (e.g. SoC 65% or Amperage 1 A) -->
      ${u?G`
        <text class="node-top-info" x="${e.x}" y="${y.toFixed(1)}">
          ${e.topInfo}
        </text>
      `:""}

      <!-- Center Icon with direct pixel dimensions and Living Icon animation class -->
      <foreignObject x="${b.toFixed(1)}" y="${v.toFixed(1)}" width="${g.toFixed(1)}" height="${g.toFixed(1)}" style="overflow: visible;">
        <div class="node-icon-foreign ${j}" xmlns="http://www.w3.org/1999/xhtml" style="width: ${g.toFixed(1)}px; height: ${g.toFixed(1)}px; display: flex; align-items: center; justify-content: center;">
          <ha-icon icon="${e.icon}" style="--mdc-icon-size: ${g.toFixed(1)}px; width: ${g.toFixed(1)}px; height: ${g.toFixed(1)}px; display: flex; align-items: center; justify-content: center;"></ha-icon>
        </div>
      </foreignObject>
      ...
      ${C?G`
        ${S?G`
          <rect class="node-label-chip"
                ...
                ry="${P}"
                fill="${e.color}"
                fill-opacity="${M.toFixed(2)}"
                stroke="${e.color}"
                stroke-opacity="${Math.min(1,2.2*M).toFixed(2)}"
                stroke-width="${z}"
                pointer-events="none" />
        `:""}
  ...
  `}(h.arcs,o)}
            ...
            <!-- Layer 1: Wires -->
            <g class="wires-layer">
              ${(()=>{const e=h.arcs.filter(e=>e.id.startsWith("home-"));return h.arcs.map(t=>{const i=b[t.from],a=b[t.to];if(!i||!a)return G``;const r=t.id.startsWith("home-")?e.findIndex(e=>e.id===t.id):0,s=function(e,t,i,o,a=0,r=1,s){const n=s?.line_routing_mode||"bezier_curved",l=s?.bus_lane_spacing??8,c=s?.bus_corner_radius??20,d=Math.min(12,.4*e.radius),h=Math.min(12,.4*t.radius),p=Math.max(4,e.radius-d),_=Math.max(4,t.radius-h),u=t.x-e.x,g=t.y-e.y,m=Math.atan2(g,u),f=Te({x:e.x,y:e.y},p,m),b=Te({x:t.x,y:t.y},_,m+Math.PI);if("horizontal"===i){if("solar-home"===o){const i=Te({x:e.x,y:e.y},p,.1),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("battery-home"===o){const i=Te({x:e.x,y:e.y},p,-.1),o=Te({x:t.x,y:t.y},_,Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("solar-battery"===o){const i=Te({x:e.x,y:e.y},p,Math.PI/2),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.y<e.y;if("orthogonal_bus"===n){const o=Math.floor(a/2),n=Math.max(0,Math.ceil(r/2)-1),d=((s?.invert_bus_lane_order?n-o:o)+.5)*l,h=i?e.y-d:e.y+d,u=Math.asin(Math.max(-.9,Math.min(.9,(h-e.y)/p))),g=e.x+Math.cos(u)*p,m=t.x,f=i?t.y+_:t.y-_,b=Math.min(c,.45*Math.abs(m-g),.45*Math.abs(f-h)),v=Math.max(6,b);if(i){const e=m-v,t=h-v;return`M ${g.toFixed(1)} ${h.toFixed(1)} L ${e.toFixed(1)} ${h.toFixed(1)} C ${(e+.55*v).toFixed(1)} ${h.toFixed(1)}, ${m.toFixed(1)} ${(h-.45*v).toFixed(1)}, ${m.toFixed(1)} ${t.toFixed(1)} L ${m.toFixed(1)} ${f.toFixed(1)}`}{const e=m-v,t=h+v;return`M ${g.toFixed(1)} ${h.toFixed(1)} L ${e.toFixed(1)} ${h.toFixed(1)} C ${(e+.55*v).toFixed(1)} ${h.toFixed(1)}, ${m.toFixed(1)} ${(h+.45*v).toFixed(1)}, ${m.toFixed(1)} ${t.toFixed(1)} L ${m.toFixed(1)} ${f.toFixed(1)}`}}{const i=Te({x:e.x,y:e.y},p,0),o=Te({x:t.x,y:t.y},_,Math.PI),a=Math.max(40,o.x-i.x),r=i.x+.45*a,s=i.y,n=i.x+.55*a,l=o.y;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${r.toFixed(1)} ${s.toFixed(1)}, ${n.toFixed(1)} ${l.toFixed(1)}, ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${b.x.toFixed(1)} ${b.y.toFixed(1)}`}if("solar-home"===o){const i=Te({x:e.x,y:e.y},p,Math.PI/2),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("grid-battery"===o){const i=Te({x:e.x,y:e.y},p,0),o=Te({x:t.x,y:t.y},_,Math.PI);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.x<e.x;if("orthogonal_bus"===n){const o=Math.floor(a/2),n=Math.max(0,Math.ceil(r/2)-1),d=((s?.invert_bus_lane_order?n-o:o)+.5)*l,h=i?e.x-d:e.x+d,u=Math.max(-.9,Math.min(.9,(h-e.x)/p)),g=Math.PI/2+Math.asin(u),m=e.y+Math.sin(g)*p,f=i?t.x+_:t.x-_,b=t.y,v=Math.min(c,.45*Math.abs(f-h),.45*Math.abs(b-m)),y=Math.max(6,v);if(i){const e=b-y,t=h-y;return`M ${h.toFixed(1)} ${m.toFixed(1)} L ${h.toFixed(1)} ${e.toFixed(1)} C ${h.toFixed(1)} ${(e+.55*y).toFixed(1)}, ${(h-.45*y).toFixed(1)} ${b.toFixed(1)}, ${t.toFixed(1)} ${b.toFixed(1)} L ${f.toFixed(1)} ${b.toFixed(1)}`}{const e=b-y,t=h+y;return`M ${h.toFixed(1)} ${m.toFixed(1)} L ${h.toFixed(1)} ${e.toFixed(1)} C ${h.toFixed(1)} ${(e+.55*y).toFixed(1)}, ${(h+.45*y).toFixed(1)} ${b.toFixed(1)}, ${t.toFixed(1)} ${b.toFixed(1)} L ${f.toFixed(1)} ${b.toFixed(1)}`}}{const o=Te({x:e.x,y:e.y},p,Math.PI/2),a=i?0:Math.PI,r=Te({x:t.x,y:t.y},_,a),s=Math.max(40,r.y-o.y),n=o.x,l=o.y+.45*s,c=r.x+(i?20:-20),d=o.y+.65*s;return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} C ${n.toFixed(1)} ${l.toFixed(1)}, ${c.toFixed(1)} ${d.toFixed(1)}, ${r.x.toFixed(1)} ${r.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${b.x.toFixed(1)} ${b.y.toFixed(1)}`}(i,a,p,t.id,r,e.length,o);return function(e,t,i){const o=e.isActive?e.color:e.targetColor||e.color,a=e.isActive?1:i?.inactive_wire_opacity??.35,r=!e.isActive&&"solid"!==i?.inactive_wire_style;return G`
    <path id="path-${e.id}"
  ...
  `}(t,s,o)})})()}
            ...
            <!-- Layer 4: Nodes -->
            <g class="nodes-layer">
              ${B.map(e=>We(e,e=>this._handleNodeClick(e),o,a))}
            </g>
          </svg>
        </div>
      </ha-card>
    `}};e([ue({attribute:!1})],Je.prototype,"_config",void 0),e([ge()],Je.prototype,"_actualLayout",void 0),Je=e([he("simple-power-flow-card")],Je),window.customCards=window.customCards||[],window.customCards.push({type:"simple-power-flow-card",name:"Simple Power Flow Card",description:"An elegant, adaptive power flow card with intelligent Bezier routing and RAF Particle Engine.",preview:!0,documentationURL:"https://github.com/custom-cards/simple-power-flow-card"});let Ke=class extends ce{constructor(){super(...arguments),this._activeTab="general"}static{this.styles=s`
    .card-config {
      display: flex;
      flex-direction: column;
      gap: 16px;
  ...
  `}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config||!this.hass)return;const i={...this._config,[e]:t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}_styleChanged(e,t){if(!this._config)return;const i={...this._config.styles||me,[e]:t};this._valueChanged("styles",i)}_effectChanged(e,t,i){if(!this._config)return;const o=this._config.effects||fe,a={...o[e]||fe[e],[t]:i},r={...o,[e]:a};this._valueChanged("effects",r)}_nodeChanged(e,t,i){if(!this._config)return;const o={...this._config[e]||{},[t]:i};this._valueChanged(e,o)}_addDevice(){const e=[...this._config.devices||[]],t={id:`device_${Date.now()}`,name:`Carico ${e.length+1}`,entity:"",icon:"mdi:power-plug",color:"#00bcd4",include_in_home:!0};e.push(t),this._valueChanged("devices",e)}_removeDevice(e){const t=[...this._config.devices||[]];t.splice(e,1),this._valueChanged("devices",t)}_moveDevice(e,t){const i=[...this._config.devices||[]],o="up"===t?e-1:e+1;if(o<0||o>=i.length)return;const a=i[e];i[e]=i[o],i[o]=a,this._valueChanged("devices",i)}_updateDevice(e,t,i){const o=[...this._config.devices||[]];o[e]={...o[e],[t]:i},this._valueChanged("devices",o)}_renderSliderWithNumber(e,t,i,o,a,r,s){return q`
      <div class="form-row">
        <label>${e}</label>
    ...
    `}_renderEntityPicker(e,t,i=["sensor","input_number"]){return customElements.get("ha-entity-picker")?q`
        <ha-entity-picker
          .hass=${this.hass}
          .value=${e||""}
          .includeDomains=${i}
    ...
    `}render(){if(!this._config)return q``;const e=this.hass?.language||"en",t=this._config.styles||me;return q`
      <div class="card-config">
        ...
        ${"general"===this._activeTab?q`
          ...
          <div class="form-row">
            <label>${Qe("editor.layout_mode",e)}</label>
            <select .value=${this._config.layout_mode||"auto"} @change=${e=>this._valueChanged("layout_mode",e.target.value)}>
              ...
              <option value="horizontal">${Qe("editor.layout_horizontal",e)}</option>
              <option value="vertical">${Qe("editor.layout_vertical",e)}</option>
            </select>
          </div>

          <div class="form-row">
            <label>${Qe("editor.stroke_mode",e)}</label>
            <select .value=${this._config.stroke_mode||"watt"} @change=${e=>this._valueChanged("stroke_mode",e.target.value)}>
              <option value="watt">${Qe("editor.stroke_mode_watt",e)}</option>
              <option value="fixed">${Qe("editor.stroke_mode_fixed",e)}</option>
              <option value="ampere">${Qe("editor.stroke_mode_ampere",e)}</option>
            </select>
          </div>

          <div class="form-row">
            <label>${Qe("editor.speed_mode",e)}</label>
            <select .value=${this._config.speed_mode||"absolute"} @change=${e=>this._valueChanged("speed_mode",e.target.value)}>
              <option value="absolute">${Qe("editor.speed_mode_absolute",e)}</option>
              <option value="relative">${Qe("editor.speed_mode_relative",e)}</option>
            </select>
          </div>
        `:""}
        ...
        ${"nodes"===this._activeTab?q`
          <!-- Solar -->
          <div class="section-title">☀️ ${Qe("editor.solar",e)}</div>
          <div class="form-row">
            <label>${Qe("editor.entity",e)}</label>
          ...
          <!-- Grid -->
          <div class="section-title">⚡ ${Qe("editor.grid",e)}</div>
          <div class="form-row">
            <label>${Qe("editor.entity",e)} (Singola con segno +/-)</label>
            ${this._renderEntityPicker(this._config.grid?.entity,e=>this._nodeChanged("grid","entity",e))}
          </div>
          <div class="form-row">
            <label>Oppure ${Qe("editor.entity_import",e)} (Prelievo)</label>
            ${this._renderEntityPicker(this._config.grid?.entity_import,e=>this._nodeChanged("grid","entity_import",e))}
          </div>
          <div class="form-row">
            <label>${Qe("editor.entity_export",e)} (Immissione)</label>
          ...
          <!-- Home -->
          <div class="section-title">🏠 ${Qe("editor.home",e)}</div>
          <div class="form-row">
            <label>${Qe("editor.entity",e)} (Opzionale: se vuoto, calcolato da flussi)</label>
        ...
        ${"devices"===this._activeTab?q`
          ${(this._config.devices||[]).map((t,i)=>q`
            <div class="device-card">
              ...
              <div class="form-row">
                <label>${Qe("editor.device_name",e)}</label>
              ...
              <div class="form-row">
                <label>${Qe("editor.entity",e)} (Potenza Watt)</label>
              ...
              <div class="form-row">
                <label>${Qe("editor.device_icon",e)}</label>
              ...
              <div class="checkbox-row">
                ...
                <label for="dev_home_${i}">${Qe("editor.include_in_home",e)}</label>
              </div>
        ...
        ${"advanced"===this._activeTab?q`
          ...
          <div class="form-row">
            <label>${Qe("editor.display_zero_tolerance",e)} (W)</label>
          ...
          <div class="form-row">
            <label>${Qe("editor.scale_curve",e)}</label>
          ...
          <div class="form-row">
            <label>${Qe("editor.max_total_particles",e)}</label>
          ...
          <div class="form-row">
            <label>${Qe("editor.residual_handling",e)}</label>
    ...
    `}};e([ue({attribute:!1})],Ke.prototype,"hass",void 0),e([ge()],Ke.prototype,"_config",void 0),e([ge()],Ke.prototype,"_activeTab",void 0),Ke=e([he("simple-power-flow-card-editor")],Ke);var et=Object.freeze({__proto__:null,get SimplePowerFlowCardEditor(){return Ke}});console.info("%c SIMPLE-POWER-FLOW-CARD %c v1.0.0 ","color: white; background: #0284c7; font-weight: 700; border-radius: 4px 0 0 4px; padding: 2px 6px;","color: #0284c7; background: #e0f2fe; font-weight: 700; border-radius: 0 4px 4px 0; padding: 2px 6px;");export{Je as SimplePowerFlowCard};
