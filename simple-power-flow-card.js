...
`;function Se(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const i=t.replace(",",".").replace(/[^0-9.-]/g,""),o=parseFloat(i);return Number.isFinite(o)?o:null}function Pe(e,t){if(!(e&&t&&e.states&&e.states[t]))return{value:0,rawState:"",unit:"",isUnavailable:!0,isUnknown:!1,isValid:!1};const i=e.states[t],o=i.state,r=i.attributes?.unit_of_measurement||"W";if("unavailable"===o)return{value:0,rawState:o,unit:r,isUnavailable:!0,isUnknown:!1,isValid:!1};if("unknown"===o)return{value:0,rawState:o,unit:r,isUnavailable:!1,isUnknown:!0,isValid:!1};const a=Se(o);if(null===a)return{value:0,rawState:o,unit:r,isUnavailable:!1,isUnknown:!0,isValid:!1};return{value:function(e,t){switch(t.trim()){case"kW":case"kVA":case"kvar":return 1e3*e;case"MW":case"MVA":return 1e6*e;case"W":case"VA":case"var":case"A":default:return e;case"mW":case"mA":return.001*e}}(a,r),rawState:o,unit:r,isUnavailable:!1,isUnknown:!1,isValid:!0}}function Ie(e,t,i="solar"){if(!t)return{power:0,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};const o=t.entity_import||("grid"===i?t.entity_in:void 0),r=t.entity_export||("grid"===i?t.entity_out:void 0),a=t.entity_charge||("battery"===i?t.entity_in:void 0),s=t.entity_discharge||("battery"===i?t.entity_out:void 0),n=Boolean(o||r),l=Boolean(a||s);let c;const d=t.state_of_charge||(t.secondary_info?.entity&&t.secondary_info.entity.includes("soc")?t.secondary_info.entity:void 0);if(d&&e?.states?.[d]){const t=Se(e.states[d].state);null!==t&&(c=`${Math.round(t)}%`)}if("grid"===i&&n){const t=Pe(e,o),i=Pe(e,r),a=t.isValid?Math.max(0,t.value):0,s=i.isValid?Math.max(0,i.value):0;return{power:a-s,inPower:a,outPower:s,isDual:!0,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}if("battery"===i&&l){const t=Pe(e,a),i=Pe(e,s),o=t.isValid?Math.max(0,t.value):0,r=i.isValid?Math.max(0,i.value):0;return{power:o-r,inPower:o,outPower:r,isDual:!0,soc:c,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}const h=Pe(e,t.entity);let u,p=h.value;if(t.invert&&(p=-p),t.entity_amperage){const i=Pe(e,t.entity_amperage);i.isValid&&(u=i.value)}return{power:p,inPower:p>=0?p:0,outPower:p<0?Math.abs(p):0,isDual:!1,soc:c,amperage:u,isUnavailable:h.isUnavailable,isUnknown:h.isUnknown,isValid:h.isValid,rawUnit:h.unit||"W"}}function Ue(e,t="sqrt"){const i=Math.max(0,Math.min(1,e));switch(t){case"linear":return i;case"sqrt":default:return Math.sqrt(i);case"log":return Math.log(1+9*i)/Math.LN10}}function ze(e,t={}){const i=t.display_zero_tolerance??5,o=t.stroke_mode??"watt",r=t.speed_mode??"absolute",a=t.scale_curve??"sqrt",s=t.min_stroke??2,n=t.max_stroke??7,l=t.scale_min??50,c=t.scale_max??6e3,d=t.min_duration??.8,h=t.max_duration??5.5,u=t.residual_handling??"clamp",p=t.residual_absorb_target??"grid",_=Math.max(0,e.solar||0),f=Math.max(0,e.grid||0),g=Math.max(0,-(e.grid||0)),v=Math.max(0,e.battery||0),m=Math.max(0,-(e.battery||0));let y;y=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,_+f+m-g-v);let b=Math.min(_,y),x=_-b,$=y-b,w=Math.min(x,v),A=x-w,k=v-w,C=Math.min(A,g),E=Math.min(m,$),M=$-E,S=m-E,P=Math.min(S,Math.max(0,g-C)),I=Math.min(f,M),U=Math.min(Math.max(0,f-I),k),z=0;const F=y-(b+E+I);Math.abs(F)>i&&("clamp"===u?f>0||I>0?I=Math.max(0,I+F):E>0?E=Math.max(0,E+F):b=Math.max(0,b+F):"absorb"===u?"battery"===p&&(m>0||E>0)?E=Math.max(0,E+F):I=Math.max(0,I+F):z=Math.abs(F));let T=0;e.devices.forEach(e=>{!1!==e.include_in_home&&(T+=Math.max(0,e.power||0))});const O=Math.max(0,y-T),D=[{id:"solar-home",from:"solar",to:"home",value:b,color:ve,targetColor:$e,gradientId:"glow-solar"},{id:"solar-battery",from:"solar",to:"battery",value:w,color:ve,targetColor:be,gradientId:"glow-solar"},{id:"solar-grid",from:"solar",to:"grid",value:C,color:ye,targetColor:ye,gradientId:"glow-grid-export"},{id:"battery-home",from:"battery",to:"home",value:E,color:xe,targetColor:$e,gradientId:"glow-battery-discharge"},{id:"battery-grid",from:"battery",to:"grid",value:P,color:xe,targetColor:ye,gradientId:"glow-battery-discharge"},{id:"grid-home",from:"grid",to:"home",value:I,color:me,targetColor:$e,gradientId:"glow-grid-import"},{id:"grid-battery",from:"grid",to:"battery",value:U,color:me,targetColor:be,gradientId:"glow-grid-import"}];e.devices.forEach(e=>{const t=e.color||"var(--energy-device-color, #00bcd4)";D.push({id:`home-${e.id}`,from:"home",to:e.id,value:Math.max(0,e.power||0),color:t,targetColor:t,gradientId:"glow-device",ampere:e.ampere,isDevice:!0})});const R=D.reduce((e,t)=>e+(t.value>i?t.value:0),0),L=D.map(e=>{const t=e.value>i,u=function(e,t="watt",i="sqrt",o=2,r=7,a=50,s=6e3,n,l=5){if(e<=l)return 1.5;if("fixed"===t)return(o+r)/2;if("ampere"===t){if(null==n)return o;const e=.5;return o+Ue((n-e)/(25-e),i)*(r-o)}return o+Ue((e-a)/(s-a),i)*(r-o)}(e.value,o,a,s,n,l,c,e.ampere,i),p=function(e,t="absolute",i="sqrt",o=.8,r=5.5,a=50,s=5e3,n=0,l=5){if(e<=l)return r;let c=0;return c="relative"===t&&n>0?e/n:(e-a)/(s-a),r-Ue(c,i)*(r-o)}(e.value,r,a,d,h,l,c,R,i);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,strokeWidth:u,duration:p,isActive:t}});return{arcs:L,homeConsumption:y,untrackedDevicesPower:O,unbalancedPower:z,totalActivePower:R}}function Fe(e,t,i){return{x:e.x+Math.cos(i)*t,y:e.y+Math.sin(i)*t}}function Te(e,t=1,i=1e3,o){const r=Math.abs(e);if(r>=1e6){const i=(e/1e6).toFixed(t),r=Oe(parseFloat(i),o);return{value:r,unit:"MW",full:`${r} MW`}}if(r>=i){const i=(e/1e3).toFixed(t),r=Oe(parseFloat(i),o);return{value:r,unit:"kW",full:`${r} kW`}}const a=Oe(Math.round(e),o);return{value:a,unit:"W",full:`${a} W`}}function Oe(e,t){if(!Number.isFinite(e))return"0";if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{maximumFractionDigits:2}).format(e)}catch{}return e.toString()}const De={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:we,defaultColor:ve},grid:{x:65,y:200,radius:36,defaultIcon:Ae,defaultColor:me},battery:{x:175,y:335,radius:36,defaultIcon:ke,defaultColor:be},home:{x:285,y:200,radius:38,defaultIcon:Ce,defaultColor:$e}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410,spacingX:120,radius:28}},Re={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:we,defaultColor:ve},grid:{x:85,y:175,radius:36,defaultIcon:Ae,defaultColor:me},battery:{x:355,y:175,radius:36,defaultIcon:ke,defaultColor:be},home:{x:220,y:290,radius:38,defaultIcon:Ce,defaultColor:$e}},devicesVertical:{colLeftX:95,colRightX:345,startY:420,spacingY:85,radius:28}};var Le={title:"Power Flow",solar:"Solar",grid:"Grid",battery:"Battery",home:"Home",production:"Production",consumption:"Consumption",import:"Import",export:"Export",charge:"Charge",discharge:"Discharge",inactive:"Inactive",active:"Active",unbalanced:"Unbalanced",not_tracked:"Other Consumption"},Ne={title:"Card Title",solar:"Solar Node",grid:"Grid Node",battery:"Battery Node",home:"Home Node",devices:"Individual Devices",add_device:"Add Device",remove_device:"Remove Device",device_name:"Device Name",device_icon:"Icon",device_color:"Color",entity:"Power Entity",entity_import:"Import Entity",entity_export:"Export Entity",entity_charge:"Charge Entity",entity_discharge:"Discharge Entity",entity_amperage:"Current Entity (Amperes)",invert:"Invert Sign Convention",include_in_home:"Include in Home Total",display_zero:"Display Zero Flow",display_zero_tolerance:"Zero Tolerance (W)",stroke_mode:"Line Thickness Mode",stroke_mode_fixed:"Fixed",stroke_mode_watt:"Dynamic (Watts)",stroke_mode_ampere:"Dynamic (Amperes)",speed_mode:"Particle Speed Mode",speed_mode_absolute:"Absolute (Watts)",speed_mode_relative:"Relative (% of total)",layout_mode:"Layout Mode",layout_auto:"Auto Responsive",layout_horizontal:"Horizontal",layout_vertical:"Vertical (2-Column)",min_duration:"Min Particle Duration (s)",max_duration:"Max Particle Duration (s)",min_stroke:"Min Stroke Width (px)",max_stroke:"Max Stroke Width (px)",scale_min:"Scale Minimum",scale_max:"Scale Maximum",scale_curve:"Scale Curve",smoothing_factor:"Smoothing Factor (EMA)",max_total_particles:"Max Total Particles",residual_handling:"Residual Handling",residual_absorb_target:"Residual Absorb Target"},Ve={missing_entity:"At least one valid power entity is required.",invalid_range:"Invalid range: minimum must be strictly less than maximum."},He={card:Le,editor:Ne,errors:Ve},We={title:"Flusso Energetico",solar:"Solare",grid:"Rete",battery:"Batteria",home:"Casa",production:"Produzione",consumption:"Consumo",import:"Prelevata",export:"Immessa",charge:"Carica",discharge:"Scarica",inactive:"Inattivo",active:"Attivo",unbalanced:"Sbilanciamento",not_tracked:"Altri Consumi"},je={title:"Titolo Card",solar:"Nodo Solare",grid:"Nodo Rete",battery:"Nodo Batteria",home:"Nodo Casa",devices:"Carichi Individuali",add_device:"Aggiungi Dispositivo",remove_device:"Rimuovi Dispositivo",device_name:"Nome Dispositivo",device_icon:"Icona",device_color:"Colore",entity:"Entità Potenza",entity_import:"Entità Prelievo (Import)",entity_export:"Entità Immissione (Export)",entity_charge:"Entità Carica",entity_discharge:"Entità Scarica",entity_amperage:"Entità Corrente (Ampere)",invert:"Inverti Convenzione Segno",include_in_home:"Includi nel Totale Casa",display_zero:"Mostra Linea a Flusso Zero",display_zero_tolerance:"Tolleranza Zero (W)",stroke_mode:"Modalità Spessore Linea",stroke_mode_fixed:"Fisso",stroke_mode_watt:"Dinamico (Watt)",stroke_mode_ampere:"Dinamico (Ampere)",speed_mode:"Modalità Velocità Particelle",speed_mode_absolute:"Assoluta (Watt)",speed_mode_relative:"Relativa (% sul totale)",layout_mode:"Modalità Layout",layout_auto:"Auto Responsive",layout_horizontal:"Orizzontale",layout_vertical:"Verticale (2 Colonne)",min_duration:"Durata Minima Particelle (s)",max_duration:"Durata Massima Particelle (s)",min_stroke:"Spessore Minimo Linea (px)",max_stroke:"Spessore Massimo Linea (px)",scale_min:"Valore Minimo Scala",scale_max:"Valore Massimo Scala",scale_curve:"Curva di Scala",smoothing_factor:"Fattore di Smoothing (EMA)",max_total_particles:"Max Particelle Totali",residual_handling:"Gestione Residuo Bilancio",residual_absorb_target:"Target Assorbimento Residuo"},Be={missing_entity:"È richiesta almeno un'entità di potenza valida.",invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo."},qe={card:We,editor:je,errors:Be};const Ge={en:He||Object.freeze({__proto__:null,card:Le,default:He,editor:Ne,errors:Ve}),it:qe||Object.freeze({__proto__:null,card:We,default:qe,editor:je,errors:Be})};function Xe(e,t="en"){const i=t.replace(/['"]+/g,"").replace("-","_").split("_")[0],o=Ge[i]||Ge.en,r=e.split(".");let a=o;for(const t of r){if(!a||"object"!=typeof a||!(t in a)){let t=Ge.en;for(const i of r){if(!t||"object"!=typeof t||!(i in t))return e;t=t[i]}return"string"==typeof t?t:e}a=a[t]}return"string"==typeof a?a:e}let Ye=class extends ce{constructor(){super(...arguments),this._watchedEntities=new Set,this._phaseTracker={},this._actualLayout="horizontal"}static async getConfigElement(){return await Promise.resolve().then(function(){return Je}),document.createElement("simple-power-flow-card-editor")}static getStubConfig(e,t){const i=t||(e?.states?Object.keys(e.states):[]),o=t=>i.find(i=>{const o=i.toLowerCase(),r=e?.states?.[i],a="power"===r?.attributes?.device_class||"W"===r?.attributes?.unit_of_measurement||"kW"===r?.attributes?.unit_of_measurement;return t.some(e=>o.includes(e))&&(a||!e)});return{type:"custom:simple-power-flow-card",card_version:1,title:"Power Flow",solar:{entity:o(["solar","pv","fotovoltaico"])||"sensor.solar_power"},grid:{entity:o(["grid","rete","power_meter","import"])||"sensor.grid_power"},battery:{entity:o(["battery_power","accumulo","batteria"])||"sensor.battery_power"},home:{entity:o(["home_power","house_power","consumo_casa"])||"sensor.home_power"},stroke_mode:"watt",speed_mode:"absolute",layout_mode:"auto",scale_curve:"sqrt"}}static{this.styles=Me}setConfig(e){if(!e)throw new Error(Xe("errors.missing_entity"));const t={...ge,...e};if((!t.card_version||t.card_version<1)&&(t.card_version=1),void 0!==t.scale_min&&void 0!==t.scale_max&&t.scale_min>=t.scale_max)throw new Error(Xe("errors.invalid_range")+" (scale_min < scale_max)");if(void 0!==t.min_duration&&void 0!==t.max_duration&&t.min_duration>=t.max_duration)throw new Error(Xe("errors.invalid_range")+" (min_duration < max_duration)");if(void 0!==t.min_stroke&&void 0!==t.max_stroke&&t.min_stroke>=t.max_stroke)throw new Error(Xe("errors.invalid_range")+" (min_stroke < max_stroke)");this._config=t,this._watchedEntities.clear();const i=e=>{e&&this._watchedEntities.add(e)};[this._config.solar,this._config.grid,this._config.battery,this._config.home].forEach(e=>{e&&(i(e.entity),i(e.entity_in),i(e.entity_out),i(e.entity_import),i(e.entity_export),i(e.entity_charge),i(e.entity_discharge),i(e.state_of_charge),i(e.entity_amperage),i(e.secondary_info?.entity))}),Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{i(e.entity),i(e.entity_amperage),i(e.secondary_info?.entity)})}set hass(e){const t=this._hass;if(this._hass=e,!t||!e||!this._config)return void this.requestUpdate("hass",t);let i=!1;for(const o of this._watchedEntities)if(t.states?.[o]!==e.states?.[o]){i=!0;break}i&&this.requestUpdate("hass",t)}getCardSize(){return"vertical"===this._actualLayout?6:4}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}getLayoutOptions(){return{grid_columns:12,grid_rows:"auto",grid_min_columns:6,grid_min_rows:3}}connectedCallback(){super.connectedCallback(),this._setupObservers()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupObservers()}_setupObservers(){this._resizeObserver||(this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e<=0||("horizontal"===this._config?.layout_mode?"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal"):"vertical"===this._config?.layout_mode?"vertical"!==this._actualLayout&&(this._actualLayout="vertical"):e<430&&"vertical"!==this._actualLayout?this._actualLayout="vertical":e>450&&"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal"))}}),this._resizeObserver.observe(this)),this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver(e=>{const t=this.shadowRoot?.querySelector("svg.flow-svg");if(t)for(const i of e)i.isIntersecting?t.unpauseAnimations&&t.unpauseAnimations():t.pauseAnimations&&t.pauseAnimations()}),this._intersectionObserver.observe(this))}_cleanupObservers(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=void 0),this._intersectionObserver&&(this._intersectionObserver.disconnect(),this._intersectionObserver=void 0)}_handleNodeClick(e){if(!this._hass||!e.entityId)return;const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e.entityId}});this.dispatchEvent(t)}render(){if(!this._config)return j``;const e=this._hass?.language||"en",t=this._config.decimals??1,i=this._config.w_to_kw_threshold??1e3,o=Ie(this._hass,this._config.solar,"solar"),r=Ie(this._hass,this._config.grid,"grid"),a=Ie(this._hass,this._config.battery,"battery"),s=Ie(this._hass,this._config.home,"home"),n=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Ie(this._hass,e,"device");n.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const l=[];this._watchedEntities.forEach(e=>{this._hass?.states&&!(e in this._hass.states)&&l.push(e)});const c=ze({solar:o.power,grid:r.power,battery:a.power,home:s.isValid?s.power:void 0,devices:n},this._config),d=this._actualLayout,h="horizontal"===d?De:Re,u={};Object.keys(h.nodes).forEach(e=>{u[e]={...h.nodes[e]}});let p=`0 0 ${h.viewBox.width} ${h.viewBox.height}`;if("horizontal"===d){const e=De;if(n.forEach((t,i)=>{const o=Math.floor(i/2),r=i%2,a=e.devicesHorizontal.startX+o*e.devicesHorizontal.spacingX,s=0===r?e.devicesHorizontal.rowTopY:e.devicesHorizontal.rowBottomY;u[t.id]={x:a,y:s,radius:e.devicesHorizontal.radius}}),n.length>2){const t=Math.ceil(n.length/2),i=e.devicesHorizontal.startX+t*e.devicesHorizontal.spacingX+35;p=`0 0 ${Math.max(620,i)} 410`}}else{const e=Re;if(n.forEach((t,i)=>{const o=i%2,r=Math.floor(i/2),a=0===o?e.devicesVertical.colLeftX:e.devicesVertical.colRightX,s=e.devicesVertical.startY+r*e.devicesVertical.spacingY;u[t.id]={x:a,y:s,radius:e.devicesVertical.radius}}),n.length>2){const t=Math.ceil(n.length/2),i=e.devicesVertical.startY+t*e.devicesVertical.spacingY+45;p=`0 0 440 ${Math.max(560,i)}`}}const _=c.arcs.find(e=>"solar-home"===e.id),f=c.arcs.find(e=>"battery-home"===e.id),g=c.arcs.find(e=>"grid-home"===e.id),v=_?.value||0,m=f?.value||0,y=g?.value||0,b=v+m+y,x=[];let $,w;if(b>0&&(v>0&&x.push({id:"solar",color:ve,percentage:v/b,value:v}),m>0&&x.push({id:"battery",color:xe,percentage:m/b,value:m}),y>0&&x.push({id:"grid",color:me,percentage:y/b,value:y})),r.isDual)$=[{text:`← ${Te(r.inPower||0,t,i,this._hass).full}`,color:me},{text:`→ ${Te(r.outPower||0,t,i,this._hass).full}`,color:ye}];else{const e=r.power;$=[{text:`${e>=0?"←":"→"} ${Te(Math.abs(e),t,i,this._hass).full}`,color:e>=0?me:ye}]}if(a.isDual)w=[{text:`↓ ${Te(a.inPower||0,t,i,this._hass).full}`,color:be},{text:`↑ ${Te(a.outPower||0,t,i,this._hass).full}`,color:xe}];else{const e=a.power;w=[{text:`${e>=0?"↓":"↑"} ${Te(Math.abs(e),t,i,this._hass).full}`,color:e>=0?be:xe}]}const A=[{id:"solar",label:this._config.solar?.name||Xe("card.solar",e),icon:this._config.solar?.icon||we,color:this._config.solar?.color||ve,value:parseFloat(Te(o.power,t,i,this._hass).value),unit:Te(o.power,t,i,this._hass).unit,amperage:o.amperage,topInfo:void 0!==o.amperage?`${o.amperage} A`:void 0,isActive:o.power>(this._config.display_zero_tolerance??5),isUnavailable:o.isUnavailable,x:u.solar.x,y:u.solar.y,radius:u.solar.radius,entityId:this._config.solar?.entity},{id:"grid",label:this._config.grid?.name||Xe("card.grid",e),icon:this._config.grid?.icon||Ae,color:this._config.grid?.color||(r.power>=0?me:ye),value:parseFloat(Te(Math.abs(r.power),t,i,this._hass).value),unit:Te(Math.abs(r.power),t,i,this._hass).unit,extraValues:$,amperage:r.amperage,topInfo:void 0!==r.amperage?`${r.amperage} A`:void 0,isActive:Math.abs(r.power)>(this._config.display_zero_tolerance??5),isUnavailable:r.isUnavailable,x:u.grid.x,y:u.grid.y,radius:u.grid.radius,entityId:this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export},{id:"battery",label:this._config.battery?.name||Xe("card.battery",e),icon:this._config.battery?.icon||ke,color:this._config.battery?.color||(a.power>=0?be:xe),value:parseFloat(Te(Math.abs(a.power),t,i,this._hass).value),unit:Te(Math.abs(a.power),t,i,this._hass).unit,extraValues:w,topInfo:a.soc||(void 0!==a.amperage?`${a.amperage} A`:void 0),amperage:a.amperage,isActive:Math.abs(a.power)>(this._config.display_zero_tolerance??5),isUnavailable:a.isUnavailable,x:u.battery.x,y:u.battery.y,radius:u.battery.radius,entityId:this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge},{id:"home",label:this._config.home?.name||Xe("card.home",e),icon:this._config.home?.icon||Ce,color:this._config.home?.color||$e,value:parseFloat(Te(c.homeConsumption,t,i,this._hass).value),unit:Te(c.homeConsumption,t,i,this._hass).unit,secondaryText:c.untrackedDevicesPower>(this._config.display_zero_tolerance??5)?`${Xe("card.not_tracked",e)}: ${Te(c.untrackedDevicesPower,0,i,this._hass).full}`:void 0,isActive:c.homeConsumption>(this._config.display_zero_tolerance??5),isUnavailable:s.isUnavailable&&!o.isValid&&!r.isValid,x:u.home.x,y:u.home.y,radius:u.home.radius,entityId:this._config.home?.entity,mixSegments:x}];n.forEach(e=>{const o=u[e.id];o&&A.push({id:e.id,label:e.name||e.id,icon:e.icon||Ee,color:e.color||"var(--energy-device-color, #00bcd4)",value:parseFloat(Te(e.power,t,i,this._hass).value),unit:Te(e.power,t,i,this._hass).unit,topInfo:void 0!==e.ampere?`${e.ampere} A`:void 0,isActive:e.power>(this._config.display_zero_tolerance??5),isUnavailable:!1,x:o.x,y:o.y,radius:o.radius,entityId:e.entityId})});const k=this.shadowRoot?.querySelector("svg.flow-svg"),C=k?.getCurrentTime?k.getCurrentTime():0,E=c.arcs.filter(e=>e.isActive),M=this._config.max_total_particles??30;let S=3;return E.length*S>M&&(S=Math.max(1,Math.floor(M/E.length))),j`
  ...
  `}(c.arcs)}
            ...
            <!-- Layer 1: Wires -->
            <g class="wires-layer">
              ${c.arcs.map(e=>{const t=u[e.from],i=u[e.to];if(!t||!i)return B``;const o=function(e,t,i,o){const r=t.x-e.x,a=t.y-e.y,s=Math.atan2(a,r),n=Fe({x:e.x,y:e.y},e.radius,s),l=Fe({x:t.x,y:t.y},t.radius,s+Math.PI);if("horizontal"===i){if("solar-home"===o){const i=Fe({x:e.x,y:e.y},e.radius,.1),o=Fe({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("battery-home"===o){const i=Fe({x:e.x,y:e.y},e.radius,-.1),o=Fe({x:t.x,y:t.y},t.radius,Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("solar-battery"===o){const i=Fe({x:e.x,y:e.y},e.radius,Math.PI/2),o=Fe({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=Fe({x:e.x,y:e.y},e.radius,0),o=Fe({x:t.x,y:t.y},t.radius,Math.PI),r=Math.max(40,o.x-i.x),a=i.x+.45*r,s=i.y,n=i.x+.55*r,l=o.y;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${a.toFixed(1)} ${s.toFixed(1)}, ${n.toFixed(1)} ${l.toFixed(1)}, ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}return`M ${n.x.toFixed(1)} ${n.y.toFixed(1)} L ${l.x.toFixed(1)} ${l.y.toFixed(1)}`}if("solar-home"===o){const i=Fe({x:e.x,y:e.y},e.radius,Math.PI/2),o=Fe({x:t.x,y:t.y},t.radius,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("grid-battery"===o){const i=Fe({x:e.x,y:e.y},e.radius,0),o=Fe({x:t.x,y:t.y},t.radius,Math.PI);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=Fe({x:e.x,y:e.y},e.radius,Math.PI/2),o=t.x<e.x,r=o?0:Math.PI,a=Fe({x:t.x,y:t.y},t.radius,r),s=Math.max(40,a.y-i.y),n=i.x,l=i.y+.45*s,c=a.x+(o?20:-20),d=i.y+.65*s;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${n.toFixed(1)} ${l.toFixed(1)}, ${c.toFixed(1)} ${d.toFixed(1)}, ${a.x.toFixed(1)} ${a.y.toFixed(1)}`}return`M ${n.x.toFixed(1)} ${n.y.toFixed(1)} L ${l.x.toFixed(1)} ${l.y.toFixed(1)}`}(t,i,d,e.id);return function(e,t){const i=e.isActive?e.color:e.targetColor||e.color,o=e.isActive?1:.35;return B`
    <path id="path-${e.id}"
  ...
  `}(e,o)})}
            ...
            <g class="particles-layer">
              ${c.arcs.map(e=>{if(!e.isActive)return B``;const t=this._phaseTracker[e.id]||{dur:e.duration,lastTime:C,phase:0},i=C-t.lastTime,o=(t.phase+i/t.dur)%1;return this._phaseTracker[e.id]={dur:e.duration,lastTime:C,phase:o},function(e,t,i){if(!e.isActive)return[];const o=`path-${e.id}`,r=[],a=Math.max(5,.75*e.strokeWidth+1.8);for(let s=0;s<t;s++){const n=-(i+s/t)%1*e.duration,l=`anim-${e.id}-${s}`;r.push(B`
    ...
    `)}return r}(e,S,o)})}
            ...
            <!-- Layer 3: Nodes -->
            <g class="nodes-layer">
              ${A.map(e=>function(e,t){const i=`${e.label}: ${e.value} ${e.unit}${e.secondaryText?` (${e.secondaryText})`:""}`,o=2*Math.PI*e.radius;let r=[];if(e.mixSegments&&e.mixSegments.length>0&&e.value>0){let t=0;r=e.mixSegments.map(i=>{const r=i.percentage*o,a=-t;return t+=r,B`
      ...
      `})}const a=e.extraValues&&e.extraValues.length>0,s=Boolean(e.topInfo);let n=e.x-11,l=e.y-18;s?l=e.y-7:a&&(e.extraValues?.length||0)>=2&&(l=e.y-22);const c=e.y+e.radius+14,d=e.y+e.radius+26;let h=B`<tspan x="${e.x}">${e.label}</tspan>`;if(e.label.length>11)if(e.label.includes("/")){const t=e.label.split("/");h=B`
        <tspan x="${e.x}" dy="0">${t[0]}/</tspan>
        <tspan x="${e.x}" dy="11">${t.slice(1).join("/")}</tspan>
      `}else if(e.label.includes(" ")){const t=e.label.split(" "),i=Math.ceil(t.length/2),o=t.slice(0,i).join(" "),r=t.slice(i).join(" ");h=B`
    ...
    <g class="node-group"
      ...
      ${s?B`
        <text class="node-top-info" x="${e.x}" y="${e.y-16}">
          ${e.topInfo}
        </text>
      `:""}

      <!-- Center Icon -->
      <foreignObject x="${n}" y="${l}" width="${22}" height="${22}">
      ...
      ${a?B`
        ${e.extraValues.map((t,i)=>{const o=1===e.extraValues.length?e.y+11:e.y+3+12*i;return B`
          ...
          `})}
      `:B`
        <text class="node-value" x="${e.x}" y="${s?e.y+13:e.y+11}">
      ...
      ${e.secondaryText&&!a?B`
        <text class="node-sub-outside" x="${e.x}" y="${d}">
          ${e.secondaryText}
        </text>
      `:""}
    </g>
  ...
  `}setConfig(e){this._config={...e}}_valueChanged(e,t){if(!this._config)return;const i={...this._config,[e]:t};this._config=i;const o=new CustomEvent("config-changed",{bubbles:!0,composed:!0,detail:{config:i}});this.dispatchEvent(o)}_nodeChanged(e,t,i){if(!this._config)return;const o={...this._config[e]||{},[t]:i};this._valueChanged(e,o)}_addDevice(){const e=[...this._config.devices||[]],t={id:`device_${Date.now()}`,name:`Carico ${e.length+1}`,entity:"",icon:"mdi:power-plug",color:"#00bcd4",include_in_home:!0};e.push(t),this._valueChanged("devices",e)}_removeDevice(e){const t=[...this._config.devices||[]];t.splice(e,1),this._valueChanged("devices",t)}_moveDevice(e,t){const i=[...this._config.devices||[]],o="up"===t?e-1:e+1;if(o<0||o>=i.length)return;const r=i[e];i[e]=i[o],i[o]=r,this._valueChanged("devices",i)}_updateDevice(e,t,i){const o=[...this._config.devices||[]];o[e]={...o[e],[t]:i},this._valueChanged("devices",o)}_renderEntityPicker(e,t,i=["sensor","input_number"]){return customElements.get("ha-entity-picker")?j`
      ...
      />
    `}_renderIconPicker(e,t){return customElements.get("ha-icon-picker")?j`
        <ha-icon-picker
          .hass=${this.hass}
          .value=${e||""}
          @value-changed=${e=>t(e.detail.value)}>
      ...
      />
    `}render(){if(!this._config)return j``;const e=this.hass?.language||"en";return j`
        ...
        ${"general"===this._activeTab?j`
          ...
          <div class="form-row">
            ...
            <select .value=${this._config.layout_mode||"auto"} @change=${e=>this._valueChanged("layout_mode",e.target.value)}>
              <option value="auto">${Xe("editor.layout_auto",e)}</option>
