...
`;function Pe(e){if(null==e)return null;const t=String(e).trim();if(""===t||"unavailable"===t||"unknown"===t)return null;const i=t.replace(",",".").replace(/[^0-9.-]/g,""),o=parseFloat(i);return Number.isFinite(o)?o:null}function ze(e,t){if(!(e&&t&&e.states&&e.states[t]))return{value:0,rawState:"",unit:"",isUnavailable:!0,isUnknown:!1,isValid:!1};const i=e.states[t],o=i.state,a=i.attributes?.unit_of_measurement||"W";if("unavailable"===o)return{value:0,rawState:o,unit:a,isUnavailable:!0,isUnknown:!1,isValid:!1};if("unknown"===o)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};const r=Pe(o);if(null===r)return{value:0,rawState:o,unit:a,isUnavailable:!1,isUnknown:!0,isValid:!1};return{value:function(e,t){switch(t.trim()){case"kW":case"kVA":case"kvar":return 1e3*e;case"MW":case"MVA":return 1e6*e;case"W":case"VA":case"var":case"A":default:return e;case"mW":case"mA":return.001*e}}(r,a),rawState:o,unit:a,isUnavailable:!1,isUnknown:!1,isValid:!0}}function Ie(e,t,i="solar"){if(!t)return{power:0,isUnavailable:!1,isUnknown:!1,isValid:!1,rawUnit:"W"};const o=t.entity_import||("grid"===i?t.entity_in:void 0),a=t.entity_export||("grid"===i?t.entity_out:void 0),r=t.entity_charge||("battery"===i?t.entity_in:void 0),s=t.entity_discharge||("battery"===i?t.entity_out:void 0),n=Boolean(o||a),l=Boolean(r||s);let c,d;const h=t.state_of_charge||(t.secondary_info?.entity&&t.secondary_info.entity.includes("soc")?t.secondary_info.entity:void 0);if(h&&e?.states?.[h]){const t=Pe(e.states[h].state);null!==t&&(d=Math.max(0,Math.min(100,t)),c=`${Math.round(t)}%`)}if("grid"===i&&n){const t=ze(e,o),i=ze(e,a),r=t.isValid?Math.max(0,t.value):0,s=i.isValid?Math.max(0,i.value):0;return{power:r-s,inPower:r,outPower:s,isDual:!0,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}if("battery"===i&&l){const t=ze(e,r),i=ze(e,s),o=t.isValid?Math.max(0,t.value):0,a=i.isValid?Math.max(0,i.value):0;return{power:o-a,inPower:o,outPower:a,isDual:!0,soc:c,socPercent:d,isUnavailable:t.isUnavailable&&i.isUnavailable,isUnknown:t.isUnknown||i.isUnknown,isValid:t.isValid||i.isValid,rawUnit:t.unit||i.unit||"W"}}const p=ze(e,t.entity);let _,u=p.value;if(t.invert&&(u=-u),t.entity_amperage){const i=ze(e,t.entity_amperage);i.isValid&&(_=i.value)}return{power:u,inPower:u>=0?u:0,outPower:u<0?Math.abs(u):0,isDual:!1,soc:c,socPercent:d,amperage:_,isUnavailable:p.isUnavailable,isUnknown:p.isUnknown,isValid:p.isValid,rawUnit:p.unit||"W"}}function Ne(e,t="sqrt"){const i=Math.max(0,Math.min(1,e));switch(t){case"linear":return i;case"sqrt":default:return Math.sqrt(i);case"log":return Math.log(1+9*i)/Math.LN10}}function Oe(e,t={}){const i=t.display_zero_tolerance??0,o=t.stroke_mode??"watt",a=t.speed_mode??"absolute",r=t.scale_curve??"sqrt",s=t.min_stroke??2,n=t.max_stroke??7,l=t.scale_min??50,c=t.scale_max??6e3,d=t.min_duration??.8,h=t.max_duration??5.5,p=t.residual_handling??"clamp",_=t.residual_absorb_target??"grid",u=Math.max(0,e.solar||0),m=Math.max(0,e.grid||0),g=Math.max(0,-(e.grid||0)),f=Math.max(0,e.battery||0),v=Math.max(0,-(e.battery||0));let b;b=void 0!==e.home&&null!==e.home&&Number.isFinite(e.home)?Math.max(0,e.home):Math.max(0,u+m+v-g-f);let y=Math.min(u,b),x=u-y,$=b-y,w=Math.min(x,f),C=x-w,k=f-w,A=Math.min(C,g),M=Math.min(v,$),S=$-M,F=v-M,E=Math.min(F,Math.max(0,g-A)),P=Math.min(m,S),z=Math.min(Math.max(0,m-P),k),I=0;const N=b-(y+M+P);Math.abs(N)>i&&("clamp"===p?m>0||P>0?P=Math.max(0,P+N):M>0?M=Math.max(0,M+N):y=Math.max(0,y+N):"absorb"===p?"battery"===_&&(v>0||M>0)?M=Math.max(0,M+N):P=Math.max(0,P+N):I=Math.abs(N));let O=0;e.devices.forEach(e=>{!1!==e.include_in_home&&(O+=Math.max(0,e.power||0))});const T=Math.max(0,b-O),D=t.solar?.color||be,L=t.grid?.color||ye,U=xe,R=t.battery?.color_charge||t.battery?.color||$e,W=t.battery?.color_discharge||we,B=t.home?.color||Ce,V=[{id:"solar-home",from:"solar",to:"home",value:y,color:D,targetColor:B,gradientId:"glow-solar"},{id:"solar-battery",from:"solar",to:"battery",value:w,color:D,targetColor:R,gradientId:"glow-solar"},{id:"solar-grid",from:"solar",to:"grid",value:A,color:U,targetColor:U,gradientId:"glow-grid-export"},{id:"battery-home",from:"battery",to:"home",value:M,color:W,targetColor:B,gradientId:"glow-battery-discharge"},{id:"battery-grid",from:"battery",to:"grid",value:E,color:W,targetColor:U,gradientId:"glow-battery-discharge"},{id:"grid-home",from:"grid",to:"home",value:P,color:L,targetColor:B,gradientId:"glow-grid-import"},{id:"grid-battery",from:"grid",to:"battery",value:z,color:L,targetColor:R,gradientId:"glow-grid-import"}];e.devices.forEach(e=>{const t=e.color||"var(--energy-device-color, #00bcd4)";V.push({id:`home-${e.id}`,from:"home",to:e.id,value:Math.max(0,e.power||0),color:t,targetColor:t,gradientId:"glow-device",ampere:e.ampere,isDevice:!0})});const q=V.reduce((e,t)=>e+(t.value>i?t.value:0),0),G=V.map(e=>{const t=e.value>i,p=function(e,t="watt",i="sqrt",o=2,a=7,r=50,s=6e3,n,l=5){if(e<=l)return 1.5;if("fixed"===t)return(o+a)/2;if("ampere"===t){if(null==n)return o;const e=.5;return o+Ne((n-e)/(25-e),i)*(a-o)}return o+Ne((e-r)/(s-r),i)*(a-o)}(e.value,o,r,s,n,l,c,e.ampere,i),_=function(e,t="absolute",i="sqrt",o=.8,a=5.5,r=50,s=5e3,n=0,l=5){if(e<=l)return a;let c=0;return c="relative"===t&&n>0?e/n:(e-r)/(s-r),a-Ne(c,i)*(a-o)}(e.value,a,r,d,h,l,c,q,i);return{id:e.id,from:e.from,to:e.to,value:e.value,ampere:e.ampere,color:e.color,targetColor:e.targetColor,gradientId:e.gradientId,isDevice:e.isDevice,strokeWidth:p,duration:_,isActive:t}});return{arcs:G,homeConsumption:b,untrackedDevicesPower:T,unbalancedPower:I,totalActivePower:q}}function Te(e,t,i){return{x:e.x+Math.cos(i)*t,y:e.y+Math.sin(i)*t}}function De(e,t,i=2){if(!Number.isFinite(e))return"0";if(t?.locale)try{return new Intl.NumberFormat(t.locale.language||"en",{minimumFractionDigits:0,maximumFractionDigits:i}).format(e)}catch{}return e.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:i})}function Le(e,t=2,i=1e3,o){const a=Math.abs(e);if(a>=1e6){const i=De(e/1e6,o,t);return{value:i,unit:"MW",full:`${i} MW`}}if(a>=i){const i=De(e/1e3,o,t);return{value:i,unit:"kW",full:`${i} kW`}}const r=De(Math.round(e),o,0);return{value:r,unit:"W",full:`${r} W`}}const Ue={viewBox:{width:620,height:410},nodes:{solar:{x:175,y:65,radius:36,defaultIcon:ke,defaultColor:be},grid:{x:65,y:200,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:175,y:335,radius:36,defaultIcon:Me,defaultColor:$e},home:{x:285,y:200,radius:38,defaultIcon:Se,defaultColor:Ce}},devicesHorizontal:{rowTopY:80,rowBottomY:320,startX:410}},Re={viewBox:{width:440,height:560},nodes:{solar:{x:220,y:60,radius:36,defaultIcon:ke,defaultColor:be},grid:{x:85,y:175,radius:36,defaultIcon:Ae,defaultColor:ye},battery:{x:355,y:175,radius:36,defaultIcon:Me,defaultColor:$e},home:{x:220,y:290,radius:38,defaultIcon:Se,defaultColor:Ce}},devicesVertical:{colLeftX:95,colRightX:345,startY:420}};var We={title:"Power Flow",solar:"Solar",grid:"Grid",battery:"Battery",home:"Home",production:"Production",consumption:"Consumption",import:"Import",export:"Export",charge:"Charge",discharge:"Discharge",inactive:"Inactive",active:"Active",unbalanced:"Unbalanced",not_tracked:"Other Consumption"},Be={title:"Card Title",solar:"Solar Node",grid:"Grid Node",battery:"Battery Node",home:"Home Node",devices:"Individual Devices",add_device:"Add Device",remove_device:"Remove Device",device_name:"Device Name",device_icon:"Icon",device_color:"Color",entity:"Power Entity",entity_import:"Import Entity",entity_export:"Export Entity",entity_charge:"Charge Entity",entity_discharge:"Discharge Entity",entity_amperage:"Current Entity (Amperes)",invert:"Invert Sign Convention",include_in_home:"Include in Home Total",display_zero:"Display Zero Flow",display_zero_tolerance:"Zero Tolerance (W)",stroke_mode:"Line Thickness Mode",stroke_mode_fixed:"Fixed",stroke_mode_watt:"Dynamic (Watts)",stroke_mode_ampere:"Dynamic (Amperes)",speed_mode:"Particle Speed Mode",speed_mode_absolute:"Absolute (Watts)",speed_mode_relative:"Relative (% of total)",layout_mode:"Layout Mode",layout_auto:"Auto Responsive",layout_horizontal:"Horizontal",layout_vertical:"Vertical (2-Column)",min_duration:"Min Particle Duration (s)",max_duration:"Max Particle Duration (s)",min_stroke:"Min Stroke Width (px)",max_stroke:"Max Stroke Width (px)",scale_min:"Scale Minimum",scale_max:"Scale Maximum",scale_curve:"Scale Curve",smoothing_factor:"Smoothing Factor (EMA)",max_total_particles:"Max Total Particles",residual_handling:"Residual Handling",residual_absorb_target:"Residual Absorb Target"},Ve={missing_entity:"At least one valid power entity is required.",invalid_range:"Invalid range: minimum must be strictly less than maximum."},qe={card:We,editor:Be,errors:Ve},Ge={title:"Flusso Energetico",solar:"Solare",grid:"Rete",battery:"Batteria",home:"Casa",production:"Produzione",consumption:"Consumo",import:"Prelevata",export:"Immessa",charge:"Carica",discharge:"Scarica",inactive:"Inattivo",active:"Attivo",unbalanced:"Sbilanciamento",not_tracked:"Altri Consumi"},He={title:"Titolo Card",solar:"Nodo Solare",grid:"Nodo Rete",battery:"Nodo Batteria",home:"Nodo Casa",devices:"Carichi Individuali",add_device:"Aggiungi Dispositivo",remove_device:"Rimuovi Dispositivo",device_name:"Nome Dispositivo",device_icon:"Icona",device_color:"Colore",entity:"Entità Potenza",entity_import:"Entità Prelievo (Import)",entity_export:"Entità Immissione (Export)",entity_charge:"Entità Carica",entity_discharge:"Entità Scarica",entity_amperage:"Entità Corrente (Ampere)",invert:"Inverti Convenzione Segno",include_in_home:"Includi nel Totale Casa",display_zero:"Mostra Linea a Flusso Zero",display_zero_tolerance:"Tolleranza Zero (W)",stroke_mode:"Modalità Spessore Linea",stroke_mode_fixed:"Fisso",stroke_mode_watt:"Dinamico (Watt)",stroke_mode_ampere:"Dinamico (Ampere)",speed_mode:"Modalità Velocità Particelle",speed_mode_absolute:"Assoluta (Watt)",speed_mode_relative:"Relativa (% sul totale)",layout_mode:"Modalità Layout",layout_auto:"Auto Responsive",layout_horizontal:"Orizzontale",layout_vertical:"Verticale (2 Colonne)",min_duration:"Durata Minima Particelle (s)",max_duration:"Durata Massima Particelle (s)",min_stroke:"Spessore Minimo Linea (px)",max_stroke:"Spessore Massimo Linea (px)",scale_min:"Valore Minimo Scala",scale_max:"Valore Massimo Scala",scale_curve:"Curva di Scala",smoothing_factor:"Fattore di Smoothing (EMA)",max_total_particles:"Max Particelle Totali",residual_handling:"Gestione Residuo Bilancio",residual_absorb_target:"Target Assorbimento Residuo"},je={missing_entity:"È richiesta almeno un'entità di potenza valida.",invalid_range:"Range non valido: il valore minimo deve essere strettamente inferiore al massimo."},Ze={card:Ge,editor:He,errors:je};const Ye={en:qe||Object.freeze({__proto__:null,card:We,default:qe,editor:Be,errors:Ve}),it:Ze||Object.freeze({__proto__:null,card:Ge,default:Ze,editor:He,errors:je})};function Xe(e,t="en"){const i=t.replace(/['"]+/g,"").replace("-","_").split("_")[0],o=Ye[i]||Ye.en,a=e.split(".");let r=o;for(const t of a){if(!r||"object"!=typeof r||!(t in r)){let t=Ye.en;for(const i of a){if(!t||"object"!=typeof t||!(i in t))return e;t=t[i]}return"string"==typeof t?t:e}r=r[t]}return"string"==typeof r?r:e}let Qe=class extends ce{constructor(){super(...arguments),this._watchedEntities=new Set,this._particlesMap=new Map,this._particleDomElements={},this._meteorDomElements={},this._meteorGradElements={},this._pathLUT={},this._lastAnimTimestamp=0,this._isCardVisible=!0,this._ripplePool=[],this._lastRippleTriggerTime={},this._liquidPhase=0,this._liquidAccumulator=0,this._lastNodePositions={},this._actualLayout="horizontal"}static async getConfigElement(){return await Promise.resolve().then(function(){return Ke}),document.createElement("simple-power-flow-card-editor")}static getStubConfig(e,t){const i=t||(e?.states?Object.keys(e.states):[]),o=t=>i.find(i=>{const o=i.toLowerCase(),a=e?.states?.[i],r="power"===a?.attributes?.device_class||"W"===a?.attributes?.unit_of_measurement||"kW"===a?.attributes?.unit_of_measurement;return t.some(e=>o.includes(e))&&(r||!e)});return{type:"custom:simple-power-flow-card",card_version:1,title:"Power Flow",solar:{entity:o(["solar","pv","fotovoltaico"])||"sensor.solar_power"},grid:{entity:o(["grid","rete","power_meter","import"])||"sensor.grid_power"},battery:{entity:o(["battery_power","accumulo","batteria"])||"sensor.battery_power"},home:{entity:o(["home_power","house_power","consumo_casa"])||"sensor.home_power"},stroke_mode:"watt",speed_mode:"absolute",layout_mode:"auto",scale_curve:"sqrt",styles:ge,effects:fe}}static{this.styles=Ee}setConfig(e){if(!e)throw new Error(Xe("errors.missing_entity"));const t={...ve,...e,styles:{...ge,...e.styles||{}}};if((!t.card_version||t.card_version<1)&&(t.card_version=1),void 0!==t.scale_min&&void 0!==t.scale_max&&t.scale_min>=t.scale_max)throw new Error(Xe("errors.invalid_range")+" (scale_min < scale_max)");if(void 0!==t.min_duration&&void 0!==t.max_duration&&t.min_duration>=t.max_duration)throw new Error(Xe("errors.invalid_range")+" (min_duration < max_duration)");if(void 0!==t.min_stroke&&void 0!==t.max_stroke&&t.min_stroke>=t.max_stroke)throw new Error(Xe("errors.invalid_range")+" (min_stroke < max_stroke)");this._config=t,this._watchedEntities.clear();const i=e=>{e&&this._watchedEntities.add(e)};[this._config.solar,this._config.grid,this._config.battery,this._config.home].forEach(e=>{e&&(i(e.entity),i(e.entity_in),i(e.entity_out),i(e.entity_import),i(e.entity_export),i(e.entity_charge),i(e.entity_discharge),i(e.state_of_charge),i(e.entity_amperage),i(e.secondary_info?.entity))}),Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{i(e.entity),i(e.entity_amperage),i(e.secondary_info?.entity)}),this._checkInitialDimensions()}set hass(e){const t=this._hass;if(this._hass=e,!t||!e||!this._config)return void this.requestUpdate("hass",t);let i=!1;for(const o of this._watchedEntities){const a=t.states?.[o],r=e.states?.[o];if(a!==r&&(a?.state!==r?.state||a?.attributes?.unit_of_measurement!==r?.attributes?.unit_of_measurement)){i=!0;break}}i&&this.requestUpdate("hass",t)}getCardSize(){return"vertical"===this._actualLayout?6:4}getGridOptions(){return{columns:12,rows:"auto",min_columns:6,min_rows:3}}getLayoutOptions(){return{grid_columns:12,grid_rows:"auto",grid_min_columns:6,grid_min_rows:3}}connectedCallback(){super.connectedCallback(),this._setupObservers(),this._checkInitialDimensions(),this._startParticleAnimation()}firstUpdated(){this._checkInitialDimensions(),this._startParticleAnimation()}updated(){this._syncParticles()}disconnectedCallback(){super.disconnectedCallback(),this._cleanupObservers(),this._stopParticleAnimation(),this._ripplePool.forEach(e=>{e.anim&&e.anim.cancel()}),this._ripplePool=[],this._pathLUT={}}_checkInitialDimensions(){const e=this.getBoundingClientRect(),t=e.width>0?e.width:window.innerWidth;this._updateLayoutFromWidth(t)}_updateLayoutFromWidth(e){if("horizontal"===this._config?.layout_mode)return void("horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this._pathLUT={}));if("vertical"===this._config?.layout_mode)return void("vertical"!==this._actualLayout&&(this._actualLayout="vertical",this._pathLUT={}));const t=this._config?.auto_layout_breakpoint??520,i=e<=t||window.innerWidth<=t;i&&"vertical"!==this._actualLayout?(this._actualLayout="vertical",this._pathLUT={},this.requestUpdate()):!i&&e>t+20&&"horizontal"!==this._actualLayout&&(this._actualLayout="horizontal",this._pathLUT={},this.requestUpdate())}_setupObservers(){this._resizeObserver||(this._resizeObserver=new ResizeObserver(e=>{for(const t of e){const e=t.contentRect.width;e<=0||(this._pathLUT={},this._updateLayoutFromWidth(e))}}),this._resizeObserver.observe(this)),window.addEventListener("resize",()=>{this._pathLUT={},this._checkInitialDimensions()}),this._intersectionObserver||(this._intersectionObserver=new IntersectionObserver(e=>{for(const t of e)this._isCardVisible=t.isIntersecting,t.isIntersecting&&(this._lastAnimTimestamp=0,this._startParticleAnimation())}),this._intersectionObserver.observe(this))}_cleanupObservers(){this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=void 0),this._intersectionObserver&&(this._intersectionObserver.disconnect(),this._intersectionObserver=void 0)}_startParticleAnimation(){this._animFrameId||(this._lastAnimTimestamp=performance.now(),this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)))}_stopParticleAnimation(){this._animFrameId&&(cancelAnimationFrame(this._animFrameId),this._animFrameId=void 0)}_syncParticles(){if(!this._config)return;const e={...ge,...this._config.styles||{}},t=Ie(this._hass,this._config.solar,"solar"),i=Ie(this._hass,this._config.grid,"grid"),o=Ie(this._hass,this._config.battery,"battery"),a=Ie(this._hass,this._config.home,"home"),r=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Ie(this._hass,e,"device");r.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const s=Oe({solar:t.power,grid:i.power,battery:o.power,home:a.isValid?a.power:void 0,devices:r},this._config).arcs.filter(e=>e.isActive),n=this._config.effects||fe,l=Boolean(n.meteor_trail?.enabled)?2:1,c=Math.floor((this._config.max_total_particles??30)/l);let d=e.particles_per_arc;s.length*d>c&&(d=Math.max(1,Math.floor(c/s.length)));const h=new Set;s.forEach(t=>{h.add(t.id);const i=1/Math.max(.3,t.duration),o=Math.max(4,.75*t.strokeWidth+(e.particle_size_offset??1.8));for(let e=0;e<d;e++){const a=`${t.id}-${e}`,r=this._particlesMap.get(a);if(r)r.targetSpeed=i,r.radius=o,r.arcColor=t.color,r.targetNodeId=t.to,r.isFadingOut=!1;else{const r=e/d*1.35;this._particlesMap.set(a,{id:a,arcId:t.id,progress:r,prevNormProgress:r%1.35,speed:i,targetSpeed:i,radius:o,totalLength:0,arcColor:t.color,targetNodeId:t.to,isFadingOut:!1})}}for(let e=d;e<10;e++){const i=`${t.id}-${e}`,o=this._particlesMap.get(i);o&&(o.isFadingOut=!0)}});for(const[e,t]of this._particlesMap.entries())h.has(t.arcId)||(t.isFadingOut=!0);this._startParticleAnimation()}_getPathPoint(e,t){let i=this._pathLUT[e];if(!i){const t=this.shadowRoot?.querySelector(`#path-${e}`);if(!t)return null;const o=t.getTotalLength();if(!o||o<=0)return null;const a=100,r=[];for(let e=0;e<=a;e++)r.push(t.getPointAtLength(e/a*o));i={totalLength:o,points:r},this._pathLUT[e]=i}const o=Math.max(0,Math.min(1,t))*(i.points.length-1),a=Math.floor(o);if(a>=i.points.length-1)return{pt:i.points[i.points.length-1],totalLength:i.totalLength};const r=o-a,s=i.points[a],n=i.points[a+1];return{pt:{x:s.x+(n.x-s.x)*r,y:s.y+(n.y-s.y)*r},totalLength:i.totalLength}}_triggerImpactRipple(e,t){const i=performance.now();if(i-(this._lastRippleTriggerTime[e]||0)<180)return;this._lastRippleTriggerTime[e]=i;const o=this._lastNodePositions[e];if(!o)return;const a=this._config?.effects||fe,r=a.impact_ripples?.ripple_size??18,s=a.impact_ripples?.ripple_color||t,n=this.shadowRoot?.querySelector("g.ripples-layer");if(!n)return;let l=this._ripplePool.find(e=>!e.inUse);if(!l){if(!(this._ripplePool.length<12))return;{const e=document.createElementNS("http://www.w3.org/2000/svg","circle");e.setAttribute("class","impact-ripple-circle"),e.setAttribute("fill","none"),e.setAttribute("pointer-events","none"),e.style.display="none",n.appendChild(e),l={el:e,inUse:!1},this._ripplePool.push(l)}}l.inUse=!0;const c=l.el;if(c.style.display="",c.setAttribute("cx",o.x.toFixed(1)),c.setAttribute("cy",o.y.toFixed(1)),c.setAttribute("stroke",s),l.anim&&l.anim.cancel(),"function"==typeof c.animate){const e=c.animate([{r:`${o.radius.toFixed(1)}px`,opacity:"0.8",strokeWidth:"2.5px"},{r:`${(o.radius+r).toFixed(1)}px`,opacity:"0",strokeWidth:"0.5px"}],{duration:700,easing:"cubic-bezier(0.1, 0.7, 0.3, 1)",fill:"forwards"});l.anim=e,e.onfinish=()=>{c.style.display="none",l.inUse=!1,l.anim=void 0},e.oncancel=()=>{c.style.display="none",l.inUse=!1,l.anim=void 0}}else c.setAttribute("r",o.radius.toFixed(1)),setTimeout(()=>{c.style.display="none",l.inUse=!1},700)}_animateParticles(e){if(!this._isCardVisible)return void(this._animFrameId=void 0);const t="undefined"!=typeof window&&window.matchMedia?.("(prefers-reduced-motion: reduce)")?.matches;this._lastAnimTimestamp||(this._lastAnimTimestamp=e);const i=Math.min((e-this._lastAnimTimestamp)/1e3,.033);this._lastAnimTimestamp=e;const o=this.shadowRoot?.querySelector("g.particles-layer"),a=this.shadowRoot?.querySelector("defs.dynamic-defs");if(!o)return void(this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this)));const r=this._config?.effects||fe,s=Boolean(r.meteor_trail?.enabled&&!t),n=r.meteor_trail?.tail_length??.08,l=r.meteor_trail?.glow_intensity??1.5,c=this._config?.smoothing_factor??.35,d=[];for(const[e,h]of this._particlesMap.entries()){if(t||(h.speed+=(h.targetSpeed-h.speed)*Math.min(1,c*i*10),h.progress+=h.speed*i),h.isFadingOut&&h.progress>=1){d.push(e);continue}const p=h.progress%1.35;if(!t&&!h.isFadingOut&&h.prevNormProgress<1&&p>=1&&r.impact_ripples?.enabled&&this._triggerImpactRipple(h.targetNodeId,h.arcColor),h.prevNormProgress=p,p>1){const t=this._particleDomElements[e];t&&0!==h.lastOpacity&&(t.setAttribute("opacity","0"),h.lastOpacity=0);const i=this._meteorDomElements[e];i&&i.setAttribute("d","");continue}const _=p,u=this._getPathPoint(h.arcId,_);if(!u)continue;const m=u.pt;h.totalLength=u.totalLength;let g=1;const f=.12;_<f?g=Math.max(0,_/f):_>1-f&&(g=Math.max(0,(1-_)/f)),h.isFadingOut&&(g*=Math.max(0,1-_));let v=this._particleDomElements[e];v||(v=document.createElementNS("http://www.w3.org/2000/svg","circle"),v.setAttribute("pointer-events","none"),o.appendChild(v),this._particleDomElements[e]=v),v.setAttribute("cx",m.x.toFixed(1)),v.setAttribute("cy",m.y.toFixed(1)),h.lastRadius!==h.radius&&(v.setAttribute("r",h.radius.toFixed(1)),h.lastRadius=h.radius);const b=`url(#glow-arc-${h.arcId})`;if(h.lastFill!==b&&(v.setAttribute("fill",b),h.lastFill=b),(void 0===h.lastOpacity||Math.abs(h.lastOpacity-g)>.015||0===g&&0!==h.lastOpacity)&&(v.setAttribute("opacity",g.toFixed(3)),h.lastOpacity=g),s&&a){let t=this._meteorDomElements[e],i=this._meteorGradElements[e];if(!i){i=document.createElementNS("http://www.w3.org/2000/svg","linearGradient"),i.setAttribute("id",`meteor-grad-${e}`),i.setAttribute("gradientUnits","userSpaceOnUse");const t=document.createElementNS("http://www.w3.org/2000/svg","stop");t.setAttribute("offset","0%"),t.setAttribute("stop-color",h.arcColor),t.setAttribute("stop-opacity","0");const o=document.createElementNS("http://www.w3.org/2000/svg","stop");o.setAttribute("offset","100%"),o.setAttribute("stop-color",h.arcColor),o.setAttribute("stop-opacity",Math.min(1,l/1.5*.85).toFixed(2)),i.appendChild(t),i.appendChild(o),a.appendChild(i),this._meteorGradElements[e]=i}t||(t=document.createElementNS("http://www.w3.org/2000/svg","path"),t.setAttribute("pointer-events","none"),t.setAttribute("fill","none"),t.setAttribute("stroke-linecap","round"),t.setAttribute("stroke",`url(#meteor-grad-${e})`),o.insertBefore(t,v),this._meteorDomElements[e]=t);const r=Math.max(0,_-n);if(_-r>.001){const e=this._getPathPoint(h.arcId,r),o=this._getPathPoint(h.arcId,r+.33*(_-r)),a=this._getPathPoint(h.arcId,r+.66*(_-r)),s=e?e.pt:m,n=o?o.pt:m,c=a?a.pt:m,d=m,p=`M ${s.x.toFixed(1)} ${s.y.toFixed(1)} C ${n.x.toFixed(1)} ${n.y.toFixed(1)}, ${c.x.toFixed(1)} ${c.y.toFixed(1)}, ${d.x.toFixed(1)} ${d.y.toFixed(1)}`;t.setAttribute("d",p),t.setAttribute("stroke-width",(1.5*h.radius*Math.min(2.5,l)).toFixed(1)),t.setAttribute("opacity",g.toFixed(3));const u=h.lastGradCoords;(!u||Math.abs(u.x1-s.x)>2||Math.abs(u.y1-s.y)>2||Math.abs(u.x2-d.x)>2||Math.abs(u.y2-d.y)>2)&&(i.setAttribute("x1",s.x.toFixed(1)),i.setAttribute("y1",s.y.toFixed(1)),i.setAttribute("x2",d.x.toFixed(1)),i.setAttribute("y2",d.y.toFixed(1)),h.lastGradCoords={x1:s.x,y1:s.y,x2:d.x,y2:d.y})}else t.setAttribute("d","")}else{const t=this._meteorDomElements[e];t&&t.parentNode&&(t.parentNode.removeChild(t),delete this._meteorDomElements[e])}}for(const e of d){this._particlesMap.delete(e);const t=this._particleDomElements[e];t&&t.parentNode&&t.parentNode.removeChild(t),delete this._particleDomElements[e];const i=this._meteorDomElements[e];i&&i.parentNode&&i.parentNode.removeChild(i),delete this._meteorDomElements[e];const o=this._meteorGradElements[e];o&&o.parentNode&&o.parentNode.removeChild(o),delete this._meteorGradElements[e]}if(!t&&r.living_icons?.enabled&&"liquid"===r.living_icons.battery_type&&!1!==r.living_icons.battery_animated&&(this._liquidAccumulator+=i,this._liquidAccumulator>=.033)){this._liquidPhase=((this._liquidPhase||0)+3*this._liquidAccumulator)%(2*Math.PI),this._liquidAccumulator=0;const e=this.shadowRoot?.querySelector("#liquid-wave-battery"),t=this._lastNodePositions.battery;if(e&&t){const i=Ie(this._hass,this._config.battery,"battery").socPercent??50,o=t.y+t.radius-i/100*(2*t.radius),a=3.2*Math.sin(this._liquidPhase),r=`M ${(t.x-t.radius).toFixed(1)} ${o.toFixed(1)} Q ${(t.x-t.radius/2).toFixed(1)} ${(o+a).toFixed(1)} ${t.x.toFixed(1)} ${o.toFixed(1)} T ${(t.x+t.radius).toFixed(1)} ${o.toFixed(1)} L ${(t.x+t.radius).toFixed(1)} ${(t.y+t.radius).toFixed(1)} L ${(t.x-t.radius).toFixed(1)} ${(t.y+t.radius).toFixed(1)} Z`;e.setAttribute("d",r)}}this._animFrameId=requestAnimationFrame(this._animateParticles.bind(this))}_handleNodeClick(e){if(!this._hass||!e.entityId)return;const t=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:e.entityId}});this.dispatchEvent(t)}render(){if(!this._config)return q``;const e=this._hass?.language||"en",t=this._config.decimals??2,i=this._config.w_to_kw_threshold??1e3,o={...ge,...this._config.styles||{}},a={...fe,...this._config.effects||{}},r=Ie(this._hass,this._config.solar,"solar"),s=Ie(this._hass,this._config.grid,"grid"),n=Ie(this._hass,this._config.battery,"battery"),l=Ie(this._hass,this._config.home,"home"),c=[];Array.isArray(this._config.devices)&&this._config.devices.forEach(e=>{const t=Ie(this._hass,e,"device");c.push({id:e.id,power:t.power,ampere:t.amperage,color:e.color,icon:e.icon,name:e.name,entityId:e.entity,include_in_home:!1!==e.include_in_home})});const d=[];this._watchedEntities.forEach(e=>{this._hass?.states&&!(e in this._hass.states)&&d.push(e)});const h=Oe({solar:r.power,grid:s.power,battery:n.power,home:l.isValid?l.power:void 0,devices:c},this._config),p=this._actualLayout,_="horizontal"===p?Ue:Re,u=o.node_radius_primary,m=o.node_radius_secondary,g=o.spacing_horizontal,f=o.spacing_vertical,v={};Object.keys(_.nodes).forEach(e=>{v[e]={..._.nodes[e],radius:u}});let b=`0 0 ${_.viewBox.width} ${_.viewBox.height}`;if("horizontal"===p){const e=Ue;if(c.forEach((t,i)=>{const o=Math.floor(i/2),a=i%2,r=e.devicesHorizontal.startX+o*g,s=0===a?e.devicesHorizontal.rowTopY:e.devicesHorizontal.rowBottomY;v[t.id]={x:r,y:s,radius:m}}),c.length>2){const t=Math.ceil(c.length/2),i=e.devicesHorizontal.startX+t*g+35;b=`0 0 ${Math.max(620,i)} 410`}}else{const e=Re;if(c.forEach((t,i)=>{const o=i%2,a=Math.floor(i/2),r=0===o?e.devicesVertical.colLeftX:e.devicesVertical.colRightX,s=e.devicesVertical.startY+a*f;v[t.id]={x:r,y:s,radius:m}}),c.length>2){const t=Math.ceil(c.length/2),i=e.devicesVertical.startY+t*f+45;b=`0 0 440 ${Math.max(560,i)}`}}this._lastNodePositions=v;const y=h.arcs.find(e=>"solar-home"===e.id),x=h.arcs.find(e=>"battery-home"===e.id),$=h.arcs.find(e=>"grid-home"===e.id),w=y?.value||0,C=x?.value||0,k=$?.value||0,A=this._config.display_zero_tolerance??0,M=n.power,S=Math.abs(M)<=A,F=this._config.battery?.color_charge||this._config.battery?.color||$e,E=this._config.battery?.color_discharge||we,P=this._config.battery?.color_idle||"var(--secondary-text-color, #94a3b8)",z=Boolean(this._config.battery?.use_idle_color);let I;I=S?z?P:F:M>0?F:E;const N=w+C+k,O=[];N>0&&(w>0&&O.push({id:"solar",color:this._config.solar?.color||be,percentage:w/N,value:w}),C>0&&O.push({id:"battery",color:E,percentage:C/N,value:C}),k>0&&O.push({id:"grid",color:this._config.grid?.color||ye,percentage:k/N,value:k}));let T,D=this._config.home?.color||Ce;if("predominant"===o.home_glow_mode&&O.length>0){const e=[...O].sort((e,t)=>t.value-e.value);e[0]&&e[0].value>0&&(D=e[0].color)}const L=this._config.grid?.color||ye,U=xe;if(s.isDual)T=[{text:`← ${Le(s.inPower||0,t,i,this._hass).full}`,color:L},{text:`→ ${Le(s.outPower||0,t,i,this._hass).full}`,color:U}];else{const e=s.power;T=[{text:`${e>=0?"←":"→"} ${Le(Math.abs(e),t,i,this._hass).full}`,color:e>=0?L:U}]}let R;if(n.isDual)R=[{text:`↓ ${Le(n.inPower||0,t,i,this._hass).full}`,color:F},{text:`↑ ${Le(n.outPower||0,t,i,this._hass).full}`,color:E}];else{const e=S&&z?P:M>=0?F:E;R=[{text:`${M>=0?"↓":"↑"} ${Le(Math.abs(M),t,i,this._hass).full}`,color:e}]}const W=e=>({showLabel:e?.show_label??o.show_labels??!0,labelFontSize:e?.label_font_size??o.font_size_label??10,labelSpacing:e?.label_spacing_below_node??o.spacing_label_below_node??14,labelChipEnabled:e?.label_chip_enabled??o.label_chip_enabled??!1,labelChipOpacity:e?.label_chip_opacity??o.label_chip_opacity??.18,labelBorderRadius:e?.label_border_radius??o.label_border_radius??6,labelBorderWidth:e?.label_border_width??o.label_border_width??1,labelColorMode:e?.label_color_mode??o.label_color_mode??"match_entity"}),B=[{id:"solar",label:this._config.solar?.name||Xe("card.solar",e),icon:this._config.solar?.icon||ke,color:this._config.solar?.color||be,value:Le(r.power,t,i,this._hass).value,unit:Le(r.power,t,i,this._hass).unit,amperage:r.amperage,topInfo:void 0!==r.amperage?`${r.amperage} A`:void 0,isActive:r.power>A,isUnavailable:r.isUnavailable,x:v.solar.x,y:v.solar.y,radius:v.solar.radius,entityId:this._config.solar?.entity,styles:o,effects:a,isSecondary:!1,iconSize:o.icon_size_primary,...W(this._config.solar)},{id:"grid",label:this._config.grid?.name||Xe("card.grid",e),icon:this._config.grid?.icon||Ae,color:this._config.grid?.color||(s.power>=0?ye:xe),value:Le(Math.abs(s.power),t,i,this._hass).value,unit:Le(Math.abs(s.power),t,i,this._hass).unit,extraValues:T,amperage:s.amperage,topInfo:void 0!==s.amperage?`${s.amperage} A`:void 0,isActive:Math.abs(s.power)>A,isUnavailable:s.isUnavailable,x:v.grid.x,y:v.grid.y,radius:v.grid.radius,entityId:this._config.grid?.entity||this._config.grid?.entity_import||this._config.grid?.entity_export,styles:o,effects:a,isSecondary:!1,iconSize:o.icon_size_primary,...W(this._config.grid)},{id:"battery",label:this._config.battery?.name||Xe("card.battery",e),icon:this._config.battery?.icon||Me,color:I,value:Le(Math.abs(n.power),t,i,this._hass).value,unit:Le(Math.abs(n.power),t,i,this._hass).unit,extraValues:R,topInfo:n.soc||(void 0!==n.amperage?`${n.amperage} A`:void 0),socPercent:n.socPercent,amperage:n.amperage,isActive:Math.abs(n.power)>A,isUnavailable:n.isUnavailable,x:v.battery.x,y:v.battery.y,radius:v.battery.radius,entityId:this._config.battery?.entity||this._config.battery?.entity_charge||this._config.battery?.entity_discharge,styles:o,effects:a,isSecondary:!1,iconSize:o.icon_size_primary,...W(this._config.battery)},{id:"home",label:this._config.home?.name||Xe("card.home",e),icon:this._config.home?.icon||Se,color:D,value:Le(h.homeConsumption,t,i,this._hass).value,unit:Le(h.homeConsumption,t,i,this._hass).unit,secondaryText:h.untrackedDevicesPower>A?`${Xe("card.not_tracked",e)}: ${Le(h.untrackedDevicesPower,0,i,this._hass).full}`:void 0,isActive:h.homeConsumption>A,isUnavailable:l.isUnavailable&&!r.isValid&&!s.isValid,x:v.home.x,y:v.home.y,radius:v.home.radius,entityId:this._config.home?.entity,mixSegments:O,styles:o,effects:a,isSecondary:!1,iconSize:o.icon_size_primary,...W(this._config.home)}];return c.forEach(e=>{const r=v[e.id];r&&B.push({id:e.id,label:e.name||e.id,icon:e.icon||Fe,color:e.color||"var(--energy-device-color, #00bcd4)",value:Le(e.power,t,i,this._hass).value,unit:Le(e.power,t,i,this._hass).unit,topInfo:void 0!==e.ampere?`${e.ampere} A`:void 0,isActive:e.power>A,isUnavailable:!1,x:r.x,y:r.y,radius:r.radius,entityId:e.entityId,styles:o,effects:a,isSecondary:!0,iconSize:o.icon_size_secondary,...W(e)})}),q`
  ...
  `}(h.arcs,o)}
            ...
            <!-- Layer 1: Wires -->
            <g class="wires-layer">
              ${(()=>{const e=h.arcs.filter(e=>e.id.startsWith("home-"));return h.arcs.map(t=>{const i=v[t.from],a=v[t.to];if(!i||!a)return G``;const r=t.id.startsWith("home-")?e.findIndex(e=>e.id===t.id):0,s=function(e,t,i,o,a=0,r=1,s){const n=s?.line_routing_mode||"bezier_curved",l=s?.bus_lane_spacing??8,c=s?.bus_corner_radius??20,d=Math.min(12,.4*e.radius),h=Math.min(12,.4*t.radius),p=Math.max(4,e.radius-d),_=Math.max(4,t.radius-h),u=t.x-e.x,m=t.y-e.y,g=Math.atan2(m,u),f=Te({x:e.x,y:e.y},p,g),v=Te({x:t.x,y:t.y},_,g+Math.PI);if("horizontal"===i){if("solar-home"===o){const i=Te({x:e.x,y:e.y},p,.1),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("battery-home"===o){const i=Te({x:e.x,y:e.y},p,-.1),o=Te({x:t.x,y:t.y},_,Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} Q ${t.x.toFixed(1)} ${e.y.toFixed(1)} ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("solar-battery"===o){const i=Te({x:e.x,y:e.y},p,Math.PI/2),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.y<e.y;if("orthogonal_bus"===n){const o=Math.floor(a/2),n=Math.max(0,Math.ceil(r/2)-1),d=((s?.invert_bus_lane_order?n-o:o)+.5)*l,h=i?e.y-d:e.y+d,u=Math.asin(Math.max(-.9,Math.min(.9,(h-e.y)/p))),m=e.x+Math.cos(u)*p,g=t.x,f=i?t.y+_:t.y-_,v=Math.min(c,.45*Math.abs(g-m),.45*Math.abs(f-h)),b=Math.max(6,v);if(i){const e=g-b,t=h-b;return`M ${m.toFixed(1)} ${h.toFixed(1)} L ${e.toFixed(1)} ${h.toFixed(1)} C ${(e+.55*b).toFixed(1)} ${h.toFixed(1)}, ${g.toFixed(1)} ${(h-.45*b).toFixed(1)}, ${g.toFixed(1)} ${t.toFixed(1)} L ${g.toFixed(1)} ${f.toFixed(1)}`}{const e=g-b,t=h+b;return`M ${m.toFixed(1)} ${h.toFixed(1)} L ${e.toFixed(1)} ${h.toFixed(1)} C ${(e+.55*b).toFixed(1)} ${h.toFixed(1)}, ${g.toFixed(1)} ${(h+.45*b).toFixed(1)}, ${g.toFixed(1)} ${t.toFixed(1)} L ${g.toFixed(1)} ${f.toFixed(1)}`}}{const i=Te({x:e.x,y:e.y},p,0),o=Te({x:t.x,y:t.y},_,Math.PI),a=Math.max(40,o.x-i.x),r=i.x+.45*a,s=i.y,n=i.x+.55*a,l=o.y;return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} C ${r.toFixed(1)} ${s.toFixed(1)}, ${n.toFixed(1)} ${l.toFixed(1)}, ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${v.x.toFixed(1)} ${v.y.toFixed(1)}`}if("solar-home"===o){const i=Te({x:e.x,y:e.y},p,Math.PI/2),o=Te({x:t.x,y:t.y},_,-Math.PI/2);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if("grid-battery"===o){const i=Te({x:e.x,y:e.y},p,0),o=Te({x:t.x,y:t.y},_,Math.PI);return`M ${i.x.toFixed(1)} ${i.y.toFixed(1)} L ${o.x.toFixed(1)} ${o.y.toFixed(1)}`}if(o&&o.startsWith("home-")){const i=t.x<e.x;if("orthogonal_bus"===n){const o=Math.floor(a/2),n=Math.max(0,Math.ceil(r/2)-1),d=((s?.invert_bus_lane_order?n-o:o)+.5)*l,h=i?e.x-d:e.x+d,u=Math.max(-.9,Math.min(.9,(h-e.x)/p)),m=Math.PI/2+Math.asin(u),g=e.y+Math.sin(m)*p,f=i?t.x+_:t.x-_,v=t.y,b=Math.min(c,.45*Math.abs(f-h),.45*Math.abs(v-g)),y=Math.max(6,b);if(i){const e=v-y,t=h-y;return`M ${h.toFixed(1)} ${g.toFixed(1)} L ${h.toFixed(1)} ${e.toFixed(1)} C ${h.toFixed(1)} ${(e+.55*y).toFixed(1)}, ${(h-.45*y).toFixed(1)} ${v.toFixed(1)}, ${t.toFixed(1)} ${v.toFixed(1)} L ${f.toFixed(1)} ${v.toFixed(1)}`}{const e=v-y,t=h+y;return`M ${h.toFixed(1)} ${g.toFixed(1)} L ${h.toFixed(1)} ${e.toFixed(1)} C ${h.toFixed(1)} ${(e+.55*y).toFixed(1)}, ${(h+.45*y).toFixed(1)} ${v.toFixed(1)}, ${t.toFixed(1)} ${v.toFixed(1)} L ${f.toFixed(1)} ${v.toFixed(1)}`}}{const o=Te({x:e.x,y:e.y},p,Math.PI/2),a=i?0:Math.PI,r=Te({x:t.x,y:t.y},_,a),s=Math.max(40,r.y-o.y),n=o.x,l=o.y+.45*s,c=r.x+(i?20:-20),d=o.y+.65*s;return`M ${o.x.toFixed(1)} ${o.y.toFixed(1)} C ${n.toFixed(1)} ${l.toFixed(1)}, ${c.toFixed(1)} ${d.toFixed(1)}, ${r.x.toFixed(1)} ${r.y.toFixed(1)}`}}return`M ${f.x.toFixed(1)} ${f.y.toFixed(1)} L ${v.x.toFixed(1)} ${v.y.toFixed(1)}`}(i,a,p,t.id,r,e.length,o);return function(e,t,i){const o=e.isActive?e.color:e.targetColor||e.color,a=e.isActive?1:i?.inactive_wire_opacity??.35,r=!e.isActive&&"solid"!==i?.inactive_wire_style;return G`
    <path id="path-${e.id}"
  ...
  `}(t,s,o)})})()}
      ...
      `})}const d="solar"===e.id||"grid"===e.id||"battery"===e.id||"home"===e.id,h=void 0!==e.isSecondary?e.isSecondary:!d,p=Boolean(e.extraValues&&e.extraValues.length>0),_=Boolean(p&&(e.extraValues?.length||0)>=2),u=Boolean(e.topInfo),m=e.iconSize||(h?a.icon_size_secondary??16:a.icon_size_primary??18),g=a.spacing_text_above_icon??4,f=a.spacing_text_below_icon??4,v=e.x-m/2;let b=e.y-m/2,y=b-g-2,x=b+m+f+9,$=b+m+f+8,w=$+(a.font_size_directional?a.font_size_directional+3:11.5);h?u?(b=e.y-m/2-1,y=b-g-2,x=b+m+f+8):(b=e.y-m-1,x=b+m+f+8):u&&_?(b=e.y-m/2-4,y=b-g-3,$=b+m+f+8,w=$+(a.font_size_directional?a.font_size_directional+3:11.5)):u&&!_?(b=e.y-m/2-3,y=b-g-3,x=b+m+f+9,$=x):!u&&_?(b=e.y-m-4,$=b+m+f+7,w=$+(a.font_size_directional?a.font_size_directional+3:11.5)):(b=e.y-m-2,x=b+m+f+9);const C=!1!==e.showLabel,k=e.labelFontSize??a.font_size_label??10,A=e.labelSpacing??a.spacing_label_below_node??14,M=Boolean(e.labelChipEnabled),S=e.labelChipOpacity??a.label_chip_opacity??.18,F=e.labelBorderRadius??a.label_border_radius??6,E=e.labelBorderWidth??a.label_border_width??1,P=e.labelColorMode??a.label_color_mode??"match_entity",z=e.y+e.radius+A;let I=!1,N=e.label.length,O=G`<tspan x="${e.x}">${e.label}</tspan>`;if(e.label.length>11)if(e.label.includes("/")){const t=e.label.split("/"),i=t[0]+"/",o=t.slice(1).join("/");I=!0,N=Math.max(i.length,o.length),O=G`
        <tspan x="${e.x}" dy="0">${i}</tspan>
        <tspan x="${e.x}" dy="${(1.15*k).toFixed(1)}">${o}</tspan>
      `}else if(e.label.includes(" ")){const t=e.label.split(" "),i=Math.ceil(t.length/2),o=t.slice(0,i).join(" "),a=t.slice(i).join(" ");I=!0,N=Math.max(o.length,a.length),O=G`
        <tspan x="${e.x}" dy="0">${o}</tspan>
        <tspan x="${e.x}" dy="${(1.15*k).toFixed(1)}">${a}</tspan>
      `}const T=.62*k,D=Math.max(7,.7*k),L=Math.max(24,N*T+2*D),U=I?2.2*k+7:1.2*k+7,R=e.x-L/2,W=z-.85*k-3.5,B="match_entity"===P?e.color:"var(--secondary-text-color, #94a3b8)",V=z+(I?2.3*k:1.2*k)+6,q=`\n    --node-hover-color: ${e.color};\n    --node-hover-glow-radius: ${a.hover_glow_radius??10}px;\n    --node-border-width: ${a.node_border_width??2.5}px;\n    --node-shadow-blur: ${a.node_shadow_blur??10}px;\n    --node-shadow-opacity: ${a.node_shadow_opacity??.35};\n    --node-shadow-offset-y: ${a.node_shadow_offset_y??4}px;\n    --font-size-value: ${a.font_size_value??10}px;\n    --font-size-label: ${k}px;\n    --font-size-top-info: ${a.font_size_top_info??8}px;\n    --font-size-directional: ${a.font_size_directional??8.5}px;\n  `;let H="";if(r.living_icons?.enabled&&e.isActive&&("home"===e.id||h)){const e=r.living_icons.load_animation||"rotate";"rotate"===e?H="animate-rotate":"pulse"===e&&(H="animate-pulse")}const j="battery"===e.id,Z=Boolean(j&&r.living_icons?.enabled&&"liquid"===r.living_icons.battery_type),Y=Boolean(j&&r.living_icons?.enabled&&"gradient"===r.living_icons.battery_type),X=Boolean(r.glassmorphism?.enabled),Q=(r.glassmorphism?.intensity??50)/50,J=Boolean(X&&!1!==r.glassmorphism?.neon_core);let K="";if(Z){const t=e.socPercent??50,i=e.y+e.radius-t/100*(2*e.radius);K=`M ${e.x-e.radius} ${i} Q ${e.x-e.radius/2} ${i-3} ${e.x} ${i} T ${e.x+e.radius} ${i} L ${e.x+e.radius} ${e.y+e.radius} L ${e.x-e.radius} ${e.y+e.radius} Z`}return G`
    <g class="node-group"
       tabindex="0"
       role="group"
       style="${q}"
      ...
      <defs>
        ...
        ${X?G`
          <linearGradient id="glass-glare-${e.id}" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stop-color="#ffffff" stop-opacity="${(.28*Q).toFixed(2)}" />
            <stop offset="40%" stop-color="#ffffff" stop-opacity="${(.08*Q).toFixed(2)}" />
            <stop offset="65%" stop-color="#ffffff" stop-opacity="0" />
            <stop offset="100%" stop-color="#000000" stop-opacity="${(.22*Q).toFixed(2)}" />
          </linearGradient>
        `:""}
      </defs>
      ...
      <foreignObject x="${v.toFixed(1)}" y="${b.toFixed(1)}" width="${m.toFixed(1)}" height="${m.toFixed(1)}" style="overflow: visible;">
        <div class="node-icon-foreign ${H}" xmlns="http://www.w3.org/1999/xhtml" style="width: ${m.toFixed(1)}px; height: ${m.toFixed(1)}px; display: flex; align-items: center; justify-content: center;">
      ...
      ${C?G`
        ${M?G`
          <rect class="node-label-chip"
                ...
                ry="${F}"
                fill="${e.color}"
                fill-opacity="${S.toFixed(2)}"
                stroke="${e.color}"
                stroke-opacity="${Math.min(1,2.2*S).toFixed(2)}"
                stroke-width="${E}"
                pointer-events="none" />
        `:""}
      ...
      ${e.secondaryText&&!p&&C?G`
        <text class="node-sub-outside" x="${e.x}" y="${V.toFixed(1)}">
          ${e.secondaryText}
        </text>
      `:""}
    </g>
  `}(e,e=>this._handleNodeClick(e),o,a))}
            </g>
          </svg>
        </div>
      </ha-card>
  ...
  `}setConfig(e){this._config=e}_valueChanged(e,t){if(!this._config||!this.hass)return;const i={...this._config,[e]:t};this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}_styleChanged(e,t){if(!this._config)return;const i={...this._config.styles||ge,[e]:t};this._valueChanged("styles",i)}_effectChanged(e,t,i){if(!this._config)return;const o=this._config.effects||fe,a={...o[e]||fe[e],[t]:i},r={...o,[e]:a};this._valueChanged("effects",r)}_nodeChanged(e,t,i){if(!this._config)return;const o={...this._config[e]||{},[t]:i};this._valueChanged(e,o)}_addDevice(){const e=[...this._config.devices||[]],t={id:`device_${Date.now()}`,name:`Carico ${e.length+1}`,entity:"",icon:"mdi:power-plug",color:"#00bcd4",include_in_home:!0};e.push(t),this._valueChanged("devices",e)}_removeDevice(e){const t=[...this._config.devices||[]];t.splice(e,1),this._valueChanged("devices",t)}_moveDevice(e,t){const i=[...this._config.devices||[]],o="up"===t?e-1:e+1;if(o<0||o>=i.length)return;const a=i[e];i[e]=i[o],i[o]=a,this._valueChanged("devices",i)}_updateDevice(e,t,i){const o=[...this._config.devices||[]];o[e]={...o[e],[t]:i},this._valueChanged("devices",o)}_renderSliderWithNumber(e,t,i,o,a,r,s){return q`
      <div class="form-row">
        <label>${e}</label>
    ...
    `}render(){if(!this._config)return q``;const e=this.hass?.language||"en",t=this._config.styles||ge;return q`
      <div class="card-config">
        ...
        ${"styles"===this._activeTab?q`
          ...
          ${t.label_chip_enabled?q`
            ...
            <div class="form-row">
              <label>Colore Testo Etichetta</label>
              <select .value=${t.label_color_mode||"match_entity"} @change=${e=>this._styleChanged("label_color_mode",e.target.value)}>
