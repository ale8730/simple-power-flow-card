    ...
    `}render(){if(!this._config)return j``;const e=this.hass?.language||"en";return j`
      <div class="card-config">
        ...
        ${"nodes"===this._activeTab?j`
          ...
          <div class="form-row">
            <label>Oppure ${Ge("editor.entity_import",e)} (Prelievo)</label>
            ${this._renderEntityPicker(this._config.grid?.entity_import,e=>this._nodeChanged("grid","entity_import",e))}
          </div>
          <div class="form-row">
            <label>${Ge("editor.entity_export",e)} (Immissione)</label>
